...
$(document).ready(function() {
    ...
    $('#add_row_cust').on( 'click', function () {
        ...
        clone.find('#packagecustomer_0').attr('id', 'packagecustomer_'+add_new_cust);
        $('#custdelete_0').hide();
...
function selectCustomer(sel) {
	...
	$.ajax({
		type: "GET",
		url: "package_ajax_all.php?fill=cust_config&value="+stage,
...
<div class="form-group">
    <div class="col-sm-12">
        ...
        <?php if(!empty($_GET['packageid'])) {
            ...
            ?>
                <div class="form-group clearfix" id="<?php echo 'packagecustomer_'.$id_loop; ?>">
        ...
        <div class="additional_cust clearfix">
            ...
            <div class="form-group clearfix" id="packagecustomer_0">
                <div class="col-sm-2"><label for="company_name" class="col-sm-4 show-on-mob control-label">Customer:</label>
