...
$(document).ready(function() {
    ...
    $('#add_row_s').on( 'click', function () {
        ...
        clone.find('#packageservice_0').attr('id', 'packageservice_'+add_new_s);
        $('#sdelete_0').hide();
...
function selectServiceService(sel) {
	...
	$.ajax({
		type: "GET",
		url: "package_ajax_all.php?fill=s_service_config&value="+stage,
...
function selectServiceCat(sel) {
	...
	$.ajax({
		type: "GET",
		url: "package_ajax_all.php?fill=s_cat_config&value="+stage,
		dataType: "html",   //expect html to be returned
		success: function(response){
...
function selectServiceHeading(sel) {
	...
	$.ajax({
		type: "GET",
		url: "package_ajax_all.php?fill=s_head_config&value="+stage,
		dataType: "html",   //expect html to be returned
		success: function(response){
    ...
    <div class="col-sm-12">
        ...
        <?php if(!empty($_GET['packageid'])) {
            ...
            for($services_loop=0; $services_loop<$total_count; $services_loop++) {
                ...
                if($serviceid != '') {
            ?>
                <div class="form-group clearfix" id="<?php echo 'packageservice_'.$id_loop; ?>">
        ...
        <div class="additional_s clearfix">
            ...
            <div class="form-group clearfix" id="packageservice_0">
                <div class="col-sm-2"><label for="company_name" class="col-sm-4 show-on-mob control-label">Service Type:</label>
