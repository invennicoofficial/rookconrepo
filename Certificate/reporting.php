...
<div class="has-dashboard form-horizontal dashboard-container dashboard-block-container">
        <p>
            <a href="?report=overview&staff_status=1"><button type="button" class="btn brand-btn mobile-block mobile-100 <?= $staff_status ? 'active_tab' : '' ?>">Active Staff</button></a>
            <a href="?report=overview&staff_status=0"><button type="button" class="btn brand-btn mobile-block mobile-100 <?= $staff_status ? '' : 'active_tab' ?>">Suspended Staff</button></a>
        </p>
