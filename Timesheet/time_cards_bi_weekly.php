...
$value = $config['settings']['Choose Fields for Time Cards Dashboard'];
...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <?php echo get_tabs('Time Cards', 'Bi-Weekly', array('db' => $dbc, 'field' => $value['config_field'])); ?>
        <br><br>
         <h2>Coming Soon..</h2>
