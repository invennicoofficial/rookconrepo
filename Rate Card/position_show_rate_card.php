<div class='main_frame' id='no-more-tables'>
	...
	if($id === false || mysqli_num_rows($result) > 0):
		$position_sql = "SELECT `name`, `description`, `position_id` id FROM `positions` ORDER BY `name` WHERE `position_id`='{$row['position_id']}'";
		...
		<div class="panel panel-default">
            ...
            <div id="collapse_abi" class="panel-collapse collapse in">
                <div class="panel-body">
					...
					<div class='col-sm-8'><?php echo $row['item_id'] > 0 ? mysqli_fetch_assoc($positions_results)['name'] : $row['description']; ?></div></div>
