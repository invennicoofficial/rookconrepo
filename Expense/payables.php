...
$query_expenses = "SELECT * FROM expense WHERE LEFT(ex_date,7) = '$search_month' AND (`staff`='$search_staff' OR '$search_staff'='') AND `status`='Approved' AND `deleted`=0 AND `reimburse`=1";
$min_rows = 0;
$min_open = 0;
