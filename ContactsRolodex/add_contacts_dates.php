            <?php if (strpos($value_config, ','."Contact Since".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Contact Since".',') === false ? 'readonly ' : ''); ?>name="contact_since" value="<?php echo $contact_since; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
            ...
            <?php if (strpos($value_config, ','."Date of Last Contact".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Date of Last Contact".',') === false ? 'readonly ' : ''); ?>name="date_of_last_contact" value="<?php echo $date_of_last_contact; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
            ...
            <?php if (strpos($value_config, ','."Start Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Start Date".',') === false ? 'readonly ' : ''); ?>name="start_date" value="<?php echo $start_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Expiry Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Expiry Date".',') === false ? 'readonly ' : ''); ?>name="expiry_date" value="<?php echo $expiry_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Renewal Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Renewal Date".',') === false ? 'readonly ' : ''); ?>name="renewal_date" value="<?php echo $renewal_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Lease Term Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Lease Term Date".',') === false ? 'readonly ' : ''); ?>name="lease_term_date" value="<?php echo $lease_term_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Date Contract Signed".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Date Contract Signed".',') === false ? 'readonly ' : ''); ?>name="date_contract_signed" value="<?php echo $date_contract_signed; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Option to Renew Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Option to Renew Date".',') === false ? 'readonly ' : ''); ?>name="option_to_renew_date" value="<?php echo $option_to_renew_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Rate Increase Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Rate Increase Date".',') === false ? 'readonly ' : ''); ?>name="rate_increase_date" value="<?php echo $rate_increase_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Insurance Expiry Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Insurance Expiry Date".',') === false ? 'readonly ' : ''); ?>name="insurance_expiry_date" value="<?php echo $insurance_expiry_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Account Expiry Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Account Expiry Date".',') === false ? 'readonly ' : ''); ?>name="account_expiry_date" value="<?php echo $account_expiry_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Hire Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Hire Date".',') === false ? 'readonly ' : ''); ?>name="hire_date" value="<?php echo $hire_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Probation End Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Probation End Date".',') === false ? 'readonly ' : ''); ?>name="probation_end_date" value="<?php echo $probation_end_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Probation Expiry Reminder Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Probation Expiry Reminder Date".',') === false ? 'readonly ' : ''); ?>name="probation_expiry_reminder_date" value="<?php echo $probation_expiry_reminder_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Birth Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Birth Date".',') === false ? 'readonly ' : ''); ?>name="birth_date" value="<?php echo $birth_date; ?>" type="text" class="datepicker"></p>
                </div>
				</div>
            <?php } ?>
            ...
            <?php if (strpos($value_config, ','."Company Benefit Start Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Company Benefit Start Date".',') === false ? 'readonly ' : ''); ?>name="company_benefit_start_date" value="<?php echo $company_benefit_start_date; ?>" type="text" class="datepicker"></p>
                </div>
                </div>
            <?php } ?>
            ...
            <?php if (strpos($value_config, ','."Medications Completed Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Medications Completed Date".',') === false ? 'readonly ' : ''); ?>name="medications_completed_date" value="<?php echo $medications_completed_date; ?>" type="text" class="datepicker">
                </div>
                </div>
            <?php } ?>
            ...
            <?php if (strpos($value_config, ','."Medications Management Completed Date".',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','."Medications Management Completed Date".',') === false ? 'readonly ' : ''); ?>name="medications_management_completed_date" value="<?php echo $medications_management_completed_date; ?>" type="text" class="datepicker">
                </div>
                </div>
            <?php } ?>
...
<?php foreach($html as $field => $title) { ?>
            ...
            <?php if (strpos($value_config, ','.$title.',') !== FALSE) { ?>
                ...
                <div class="col-sm-8">
                <input <?php echo (strpos($edit_config, ','.$title.',') === false ? 'readonly ' : ''); ?>name="<?php echo $field; ?>" value="<?php echo $$field; ?>" type="text" class="datepicker">
                </div>
                </div>
            <?php } ?>
