...
<div class="container">
	<div class="row">
		...
		<h1 class="single-pad-bottom">
			...
			if(config_visible_function($dbc, 'contacts_rolodex') == 1) {
		...
		<form name="form_search" method="post" action="" class="form-inline" role="form">
			...
			<div class="tab-container"><?php
                ...
                */
				...
				foreach ($each_tab as $cat_tab) {
					...
					$display = check_subtab_persmission( $dbc, 'contacts_rolodex', $level_url, $subtab );
			...
			if ( vuaed_visible_function ( $dbc, 'contacts_rolodex' ) == 1 ) { ?>
