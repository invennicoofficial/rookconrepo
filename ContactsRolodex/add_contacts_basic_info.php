    ...
    <div class="form-group clearfix completion_date">
        <label for="first_name" class="col-sm-4 control-label text-right"><?php echo (get_software_name() == 'breakthebarrier' ? 'Program/Site' : ($url_category == 'Business' ? 'Corporation' : 'Business')); ?><span class="brand-color">*</span>:</label>
        <div class="col-sm-8">
