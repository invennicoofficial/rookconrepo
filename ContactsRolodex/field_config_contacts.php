...
<div class="panel-group" id="accordion2">
	...
	$accr = $_GET['accr'];
	$type = $_GET['type'];
	$subtab = (!empty($_GET['subtab']) ? $_GET['subtab'] : '');

	$get_field_config = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT contacts FROM field_config_contacts WHERE tile_name = '".FOLDER_NAME."' AND tab='$contype' AND IFNULL(subtab,'')='$subtab' AND accordion='$accr'"));
