    ...
    <div class="col-sm-12">
        ...
        <?php if(!empty($_GET['customid'])) {
            ...
            ?>
                ...
                <div class="col-sm-2">
                    <select onChange='selectClientName(this)' data-placeholder="Choose a Client..." id="<?php echo 'clclientid_'.$id_loop; ?>" name="assign_clients[]" class="chosen-select-deselect form-control equipmentid" width="380">
                        <option value=''></option>
                        <?php
        ...
        <div class="additional_cl clearfix">
            ...
            <div class="form-group clearfix" id="customclient_0">
                <div class="col-sm-2">
                    <select onChange='selectClientName(this)' data-placeholder="Choose a Client..." id="clclientid_0" name="assign_clients[]" class="chosen-select-deselect form-control equipmentid" width="380">
                        <option value=''></option>
                        <?php
                        $query = mysqli_query($dbc,"SELECT contactid, name FROM contacts WHERE category='Client' AND deleted=0 order by name");
                        while($row = mysqli_fetch_array($query)) {
