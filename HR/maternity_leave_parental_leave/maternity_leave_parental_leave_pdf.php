<?php
function maternity_leave_parental_leave_pdf($dbc,$hrid, $fieldlevelriskid) {
    ...
    $html = '<h2>Maternity Leave & Parental Leave</h2>';
    ...
    $html .= '<img src="maternity_leave_parental_leave/download/hr_'.$_SESSION['contactid'].'.png" width="150" height="70" border="0" alt="">';

    $pdf->writeHTML($html, true, false, true, false, '');
    $pdf->Output('maternity_leave_parental_leave/download/hr_'.$fieldlevelriskid.'.pdf', 'F');
    echo '<script type="text/javascript" language="Javascript">window.location.replace("?tile_name='.$tile.'");
    window.open("maternity_leave_parental_leave/download/hr_'.$fieldlevelriskid.'.pdf", "fullscreen=yes");
    </script>';

    unlink("maternity_leave_parental_leave/download/hr_".$_SESSION['contactid'].".png");
    echo '';
}
?>