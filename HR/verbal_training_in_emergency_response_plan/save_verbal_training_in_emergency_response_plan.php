 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_verbal_training_in_emergency_response_plan` (`hrid`, `today_date`, `contactid`) VALUES	('$hrid', '$today_date', '$contactid')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'verbal_training_in_emergency_response_plan/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('verbal_training_in_emergency_response_plan_pdf.php');
        echo verbal_training_in_emergency_response_plan_pdf($dbc,$hrid, $fieldlevelriskid);
