...
<div class="form-group">
    <label for="site_name" class="col-sm-4 control-label">Company Province:</label>
    <div class="col-sm-8">
...
<div class="form-group">
    <label for="site_name" class="col-sm-4 control-label">Company Plan Name:</label>
    <div class="col-sm-8">
        <input name="config_extra_fields[]" value="<?php echo $config_extra_fields[3]; ?>" type="text" class="form-control">
    </div>
</div>

<div class="form-group">
    <label for="site_name" class="col-sm-4 control-label">Description:<br><em>Add Tags like.<br>[Company Name], [Company Address], [Company Province], [Today Date], [Company Plan Name], [Employee Name], [Employee Position], [Employee Salary], [Employee Salary Type], [Employee Vacation]</em></label>
    <div class="col-sm-8">
