 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_police_information_check` (`hrid`, `today_date`, `contactid`, `fields`) VALUES	('$hrid', '$today_date', '$contactid', '$fields')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'police_information_check/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('police_information_check_pdf.php');
        echo police_information_check_pdf($dbc,$hrid, $fieldlevelriskid);
