<?php
function eligibility_for_general_holidays_general_holiday_pay_pdf($dbc,$hrid, $fieldlevelriskid) {
    ...
    $html = '<h2>Eligibility for General Holidays & General Holiday Pay</h2>';
    ...
    $html .= '<img src="eligibility_for_general_holidays_general_holiday_pay/download/hr_'.$_SESSION['contactid'].'.png" width="150" height="70" border="0" alt="">';

    $pdf->writeHTML($html, true, false, true, false, '');
    $pdf->Output('eligibility_for_general_holidays_general_holiday_pay/download/hr_'.$fieldlevelriskid.'.pdf', 'F');
    echo '<script type="text/javascript" language="Javascript">window.location.replace("?tile_name='.$tile.'");
    window.open("eligibility_for_general_holidays_general_holiday_pay/download/hr_'.$fieldlevelriskid.'.pdf", "fullscreen=yes");
    </script>';

    unlink("eligibility_for_general_holidays_general_holiday_pay/download/hr_".$_SESSION['contactid'].".png");
    echo '';
}
?>