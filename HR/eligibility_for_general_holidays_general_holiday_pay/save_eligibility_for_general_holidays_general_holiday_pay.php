 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_eligibility_for_general_holidays_general_holiday_pay` (`hrid`, `today_date`, `contactid`) VALUES	('$hrid', '$today_date', '$contactid')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'eligibility_for_general_holidays_general_holiday_pay/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('eligibility_for_general_holidays_general_holiday_pay_pdf.php');
        echo eligibility_for_general_holidays_general_holiday_pay_pdf($dbc,$hrid, $fieldlevelriskid);
