<?php
function policy_and_procedure_notice_of_understanding_and_intent_pdf($dbc,$hrid, $fieldlevelriskid) {
    ...
    $html = '<div style="text-align:center"><h2>Policy and Procedure Notice of Understanding and Intent</h2></div>';
    ...
    $html .= '<img src="policy_and_procedure_notice_of_understanding_and_intent/download/hr_'.$_SESSION['contactid'].'.png" width="150" height="70" border="0" alt="">';

    $pdf->writeHTML($html, true, false, true, false, '');
    $pdf->Output('policy_and_procedure_notice_of_understanding_and_intent/download/hr_'.$fieldlevelriskid.'.pdf', 'F');
    echo '<script type="text/javascript" language="Javascript">window.location.replace("?tile_name='.$tile.'");
    window.open("policy_and_procedure_notice_of_understanding_and_intent/download/hr_'.$fieldlevelriskid.'.pdf", "fullscreen=yes");
    </script>';

    unlink("policy_and_procedure_notice_of_understanding_and_intent/download/hr_".$_SESSION['contactid'].".png");
    echo '';
}
?>