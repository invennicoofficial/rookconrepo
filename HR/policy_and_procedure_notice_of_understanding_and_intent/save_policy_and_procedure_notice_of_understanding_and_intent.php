 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_policy_and_procedure_notice_of_understanding_and_intent` (`hrid`, `today_date`, `contactid`) VALUES	('$hrid', '$today_date', '$contactid')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'policy_and_procedure_notice_of_understanding_and_intent/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('policy_and_procedure_notice_of_understanding_and_intent_pdf.php');
        echo policy_and_procedure_notice_of_understanding_and_intent_pdf($dbc,$hrid, $fieldlevelriskid);
