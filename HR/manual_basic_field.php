           ...
           <div class="form-group">
            ...
            <div class="col-sm-8">
                <select id="category" name="category" class="chosen-select-deselect form-control" width="380">
                    <option value=''></option>
                    <?php
                    $query = mysqli_query($dbc,"SELECT distinct(category) FROM hr WHERE tab='$tab' order by category");
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
                <select id="heading" name="heading" class="chosen-select-deselect form-control" width="380">
                    <option value=''></option>
                    <?php
                    $query = mysqli_query($dbc,"SELECT distinct(heading) FROM hr WHERE tab='$tab' order by heading");
                    while($row = mysqli_fetch_array($query)) {
            ...
            <div class="col-sm-8">
                <select id="sub_heading_number" name="sub_heading_number" class="chosen-select-deselect form-control" width="380">
					...
					if($heading_number == '') {
						...
						echo "<option></option>";echo "$sub_heading_number - $heading_number.$j";
            ...
            <div class="col-sm-8">
                <select id="third_heading_number" name="third_heading_number" class="chosen-select-deselect form-control" width="380">
					...
					if($sub_heading_number == '') {
						...
						$third_tier_numbers = [];
						$third_tiers = [];
						$third_tier_result = mysqli_query($dbc, "SELECT DISTINCT `third_heading_number`, `third_heading` FROM `hr` WHERE `manual_type`='$type' AND `category`='$category' AND `heading_number`='$heading_number' AND `deleted`=0");
