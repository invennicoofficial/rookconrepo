...
<?php
    ...
    $email_body = str_replace("[Employee Salary]", '<input name="fields_2" type="text" class="form-control">', $email_body);
    $email_body = str_replace("[Employee Salary Type]", '<input name="fields_3" type="text" class="form-control">', $email_body);
    $email_body = str_replace("[Employee Vacation]", '<input name="fields_4" type="text" class="form-control">', $email_body);
    $email_body = str_replace("[Employee Vacation]", '<input name="fields_4" type="text" class="form-control">', $email_body);
    $email_body = str_replace("[Today Date]", '<input name="fields_5" value="'.$today_date.'" type="text" class="datepicker">', $email_body);
    echo $email_body;
?>
