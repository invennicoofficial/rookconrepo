 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_employee_substance_abuse_policy` (`hrid`, `today_date`, `contactid`) VALUES	('$hrid', '$today_date', '$contactid')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'employee_substance_abuse_policy/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('employee_substance_abuse_policy_pdf.php');
        echo employee_substance_abuse_policy_pdf($dbc,$hrid, $fieldlevelriskid);
