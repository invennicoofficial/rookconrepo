<?php
function employee_substance_abuse_policy_pdf($dbc,$hrid, $fieldlevelriskid) {
    ...
    $html = '<h2>Employee Substance Abuse Policy</h2>';
    ...
    $html .= '<img src="employee_substance_abuse_policy/download/hr_'.$_SESSION['contactid'].'.png" width="150" height="70" border="0" alt="">';

    $pdf->writeHTML($html, true, false, true, false, '');
    $pdf->Output('employee_substance_abuse_policy/download/hr_'.$fieldlevelriskid.'.pdf', 'F');
    echo '<script type="text/javascript" language="Javascript">window.location.replace("?tile_name='.$tile.'");
    window.open("employee_substance_abuse_policy/download/hr_'.$fieldlevelriskid.'.pdf", "fullscreen=yes");
    </script>';

    unlink("employee_substance_abuse_policy/download/hr_".$_SESSION['contactid'].".png");
    echo '';
}
?>