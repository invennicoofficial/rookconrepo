 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_driver_consent_form` (`hrid`, `today_date`, `contactid`, `fields`) VALUES	('$hrid', '$today_date', '$contactid', '$fields')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'driver_consent_form/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('driver_consent_form_pdf.php');
        echo driver_consent_form_pdf($dbc,$hrid, $fieldlevelriskid);
