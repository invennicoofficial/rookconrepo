<?php
function employee_shop_yard_office_orientation_pdf($dbc,$hrid, $fieldlevelriskid) {
    ...
    $html = '<h2>Employee Shop, Yard & Office Orientation</h2>';
    ...
    $html .= '<img src="employee_shop_yard_office_orientation/download/hr_'.$_SESSION['contactid'].'.png" width="150" height="70" border="0" alt="">';

    $pdf->writeHTML($html, true, false, true, false, '');
    $pdf->Output('employee_shop_yard_office_orientation/download/hr_'.$fieldlevelriskid.'.pdf', 'F');
    echo '<script type="text/javascript" language="Javascript">window.location.replace("?tile_name='.$tile.'");
    window.open("employee_shop_yard_office_orientation/download/hr_'.$fieldlevelriskid.'.pdf", "fullscreen=yes");
    </script>';

    unlink("employee_shop_yard_office_orientation/download/hr_".$_SESSION['contactid'].".png");
    echo '';
}
?>