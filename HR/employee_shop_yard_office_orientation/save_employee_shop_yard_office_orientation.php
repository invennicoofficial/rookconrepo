 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_employee_shop_yard_office_orientation` (`hrid`, `today_date`, `contactid`) VALUES	('$hrid', '$today_date', '$contactid')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'employee_shop_yard_office_orientation/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('employee_shop_yard_office_orientation_pdf.php');
        echo employee_shop_yard_office_orientation_pdf($dbc,$hrid, $fieldlevelriskid);
