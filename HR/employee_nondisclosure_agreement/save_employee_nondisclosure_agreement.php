 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_employee_nondisclosure_agreement` (`hrid`, `today_date`, `contactid`, `fields`) VALUES	('$hrid', '$today_date', '$contactid', '$fields')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'employee_nondisclosure_agreement/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('employee_nondisclosure_agreement_pdf.php');
        echo employee_nondisclosure_agreement_pdf($dbc,$hrid, $fieldlevelriskid);
