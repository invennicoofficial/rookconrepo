 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_letter_of_offer` (`hrid`, `today_date`, `contactid`, `fields`) VALUES	('$hrid', '$today_date', '$contactid', '$fields')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'letter_of_offer/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('letter_of_offer_pdf.php');
        echo letter_of_offer_pdf($dbc,$hrid, $fieldlevelriskid);
