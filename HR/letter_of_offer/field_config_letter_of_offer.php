...
<div class="form-group">
    <label for="site_name" class="col-sm-4 control-label">Description:<br><em>Add Tags like.<br>[Company Name], [Company Address], [Employee Name], [Employee Position], [Joining Date]</em></label>
    <div class="col-sm-8">
