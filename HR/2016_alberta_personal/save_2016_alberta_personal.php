 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_2016_alberta_personal` (`hrid`, `today_date`, `contactid`, `fields`) VALUES	('$hrid', '$today_date', '$contactid', '$fields')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, '2016_alberta_personal/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('2016_alberta_personal_pdf.php');
        echo alberta_personal_pdf($dbc,$hrid, $fieldlevelriskid);
