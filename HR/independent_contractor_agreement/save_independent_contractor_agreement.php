 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_independent_contractor_agreement` (`hrid`, `today_date`, `contactid`, `fields`) VALUES	('$hrid', '$today_date', '$contactid', '$fields')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'independent_contractor_agreement/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('independent_contractor_agreement_pdf.php');
        echo independent_contractor_agreement_pdf($dbc,$hrid, $fieldlevelriskid);
