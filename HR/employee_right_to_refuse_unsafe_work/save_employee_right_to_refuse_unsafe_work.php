 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_employee_right_to_refuse_unsafe_work` (`hrid`, `today_date`, `contactid`) VALUES	('$hrid', '$today_date', '$contactid')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'employee_right_to_refuse_unsafe_work/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('employee_right_to_refuse_unsafe_work_pdf.php');
        echo employee_right_to_refuse_unsafe_work_pdf($dbc,$hrid, $fieldlevelriskid);
