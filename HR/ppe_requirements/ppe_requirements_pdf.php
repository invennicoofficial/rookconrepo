<?php
function ppe_requirements_pdf($dbc,$hrid, $fieldlevelriskid) {
    ...
    $html .= '<img src="ppe_requirements/download/hr_'.$_SESSION['contactid'].'.png" width="150" height="70" border="0" alt="">';

    $pdf->writeHTML($html, true, false, true, false, '');
    $pdf->Output('ppe_requirements/download/hr_'.$fieldlevelriskid.'.pdf', 'F');
    echo '<script type="text/javascript" language="Javascript">window.location.replace("?tile_name='.$tile.'");
    window.open("ppe_requirements/download/hr_'.$fieldlevelriskid.'.pdf", "fullscreen=yes");
    </script>';

    unlink("ppe_requirements/download/hr_".$_SESSION['contactid'].".png");
    echo '';
}
?>