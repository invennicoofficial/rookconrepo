 <?php
    ...
    $query_insert_site = "INSERT INTO `hr_ppe_requirements` (`hrid`, `today_date`, `contactid`) VALUES	('$hrid', '$today_date', '$contactid')";
    $result_insert_site	= mysqli_query($dbc, $query_insert_site);
    $fieldlevelriskid = mysqli_insert_id($dbc);

    $img = sigJsonToImage($_POST['output']);
    imagepng($img, 'ppe_requirements/download/hr_'.$_SESSION['contactid'].'.png');
    ...
    if($tab == 'Form') {
        ...
        include ('ppe_requirements_pdf.php');
        echo ppe_requirements_pdf($dbc,$hrid, $fieldlevelriskid);
