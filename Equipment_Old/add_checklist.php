...
if (isset($_POST['submit'])) {
	...
	if($error_list != '') {
		...
		echo '<script type="text/javascript"> window.location.replace("equipment_checklist.php"); </script>';
	}
}
?>
...
<div class="container">
	...
	<h1>Add Checklist</h1>
	<div class="gap-top double-gap-bottom"><a href="equipment_checklist.php" class="btn config-btn">Back to Dashboard</a></div>
	...
	<div class="form-group clearfix">
		<div class="col-sm-6">
			...
			<a href="equipment_checklist.php" class="btn brand-btn btn-lg">Back</a>
		</div>
		<div class="col-sm-6">
