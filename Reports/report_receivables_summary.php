...
if (isset($_POST['printpdf'])) {
	...
	class MYPDF extends TCPDF {
		...
		public function Header() {
            ...
            $footer_text = 'View Receivables by Insurer as at '.AS_AT_DATE.' Including Invoices '.(START_DATE > '0000-00-00' ? ' From <b>'.START_DATE.'</b> Until <b>'.END_DATE.'</b>' : 'Until <b>'.END_DATE.'</b>');
            $this->writeHTMLCell(0, 0, 0 , 35, $footer_text, 0, 0, false, "R", true);

            $this->setCellHeightRatio(1.30);
            $this->SetFont('helvetica', '', 10);
            $footer_text = "NOTE : This displays how much has been Invoiced, Paid and is Due from each Insurer and how old it is (Current [under 30 days], 30-59 days, 60-89 days, 90-119 days, 120 + days).";
    ...
    track_download($dbc, 'report_receivables_summary', 0, WEBSITE_URL.'/Reports/Download/ar_aging_summary_'.$today_date.'.pdf', 'View Receivables by Insurer Report');
    ?>
...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <div class="notice double-gap-bottom popover-examples">
            ...
            This displays how much has been Invoiced, Paid and is Due from each Insurer and how old it is (Current [under 30 days], 30-59 days, 60-89 days, 90-119 days, 120 + days) relative to the Report As At date. Clicking the insurer name will redirect you to their Profile dashboard. Clicking the outstanding $ amount will redirect you to their Accounts Receivable dashboard, where payment can be applied to the outstanding invoice.</div>
