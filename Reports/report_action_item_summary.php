...
if (isset($_POST['printpdf'])) {
    ...
    track_download($dbc, 'report_ticket', 0, WEBSITE_URL.'/Reports/Download/ticket_report_'.$today_date.'.pdf', 'Action Item Summary');
    ?>
...
function report_receivables($dbc, $table_style, $table_row_style, $grand_total_style, $starttime, $endtime) {
    ...
    <th width="7%">'.TICKET_NOUN.'#</th>
    <th width="30%">Heading</th>
    <th width="20%">Business</th>
    <th width="20%">Staff</th>
    <th width="10%">Scheduled Date</th>
    <th width="10%">Estimate Dev Time</th>
    <th width="10%">QA Time</th>
    <th width="10%">Actual Time</th>
    <th width="10%">Budget</th>
    </tr>';

echo "SELECT ticketid FROM tickets WHERE ((to_do_date <= '".$starttime."' AND to_do_end_date >= '".$endtime."') OR (internal_qa_date = '".$starttime."') OR (deliverable_date = '".$starttime."'))";
