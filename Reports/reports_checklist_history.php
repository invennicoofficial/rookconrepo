...
if (isset($_POST['printpdf'])) {
	...
	//$pdf->writeHTML($html, true, false, true, false, '');
	$pdf->Output('Download/checklist_history_'.$today_date.'.pdf', 'F');
    track_download($dbc, 'history_checklist_history', 0, WEBSITE_URL.'/Reports/Download/checklist_history_'.$today_date.'.pdf', 'Checklist History Report');

    ?>

	<script type="text/javascript" language="Javascript">
	window.open('Download/checklist_history_<?php echo $today_date;?>.pdf', 'fullscreen=yes');
	</script>
    <?php
