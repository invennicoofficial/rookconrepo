...
if (isset($_POST['printpdf'])) {
	...
	class MYPDF extends TCPDF {
		...
		public function Header() {
            ...
            $footer_text = 'View Receivables till <b>'.START_DATE.'</b>';
...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <a href='1report_receivables_patient_paid_summary.php?type=Daily'><button type="button" class="btn brand-btn mobile-block active_tab" >Patient Paid Summary</button></a>&nbsp;&nbsp;
