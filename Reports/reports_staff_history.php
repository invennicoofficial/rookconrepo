...
if (isset($_POST['printpdf'])) {
	...
	//$pdf->writeHTML($html, true, false, true, false, '');
	$pdf->Output('Download/staff_history_'.$today_date.'.pdf', 'F');
    track_download($dbc, 'history_staff_history', 0, WEBSITE_URL.'/Reports/Download/staff_history_'.$today_date.'.pdf', 'Staff History Report');

    ?>

	<script type="text/javascript" language="Javascript">
	window.open('Download/staff_history_<?php echo $today_date;?>.pdf', 'fullscreen=yes');
	</script>
    <?php
