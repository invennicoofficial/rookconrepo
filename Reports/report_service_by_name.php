...
if (isset($_POST['printpdf'])) {
    ...
    class MYPDF extends TCPDF {
		...
		public function Header() {
            ...
            $footer_text = 'Services by Name From <b>'.START_DATE.'</b> To <b>'.END_DATE.'</b>';
            $this->writeHTMLCell(0, 0, 0 , 35, $footer_text, 0, 0, false, "R", true);

            $this->setCellHeightRatio(1.30);
            $this->SetFont('helvetica', '', 10);
            $footer_text = "NOTE : Display total # of Appointments and Total Sales by each service heading/name.";
...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <br>
        <a href='report_service_by_category.php?type=Daily'><button type="button" class="btn brand-btn mobile-block" >By Category</button></a>&nbsp;&nbsp;
        <a href='report_service_by_name.php?type=Daily'><button type="button" class="btn brand-btn mobile-block active_tab" >By Name</button></a>&nbsp;&nbsp;

        <div class="notice double-gap-bottom popover-examples">
            <div class="col-sm-1 notice-icon"><img src="<?= WEBSITE_URL; ?>/img/info.png" class="wiggle-me" width="25"></div>
            <div class="col-sm-11"><span class="notice-name">NOTE:</span>
            Display total # of Appointments and Total Sales by each service heading/name.</div>
