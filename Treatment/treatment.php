...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <h1 class="double-pad-bottom">Treatment Dashboard
        <?php
		...
		<div class="mobile-100-container">
			...
			<span class="nav-subtab">
				<?php if (strpos($value_config, ','."Treatment".',') !== FALSE) { ?>
					...
					<a href='treatment.php'><button type="button" class="btn brand-btn mobile-block mobile-100 active_tab">Treatment</button></a>
				<?php } ?>
			</span>
			<span class="nav-subtab">
        ...
        <form name="form_patients" method="post" action="" class="form-inline" role="form">
            ...
            <?php
			echo '<a href="add_treatment.php" class="btn brand-btn pull-right">Add Treatment</a>';
            ...
            $query_check_credentials = "SELECT * FROM treatment WHERE deleted=0 ORDER BY treatmentid DESC LIMIT $offset, $rowsPerPage";
            $query = "SELECT count(*) as numrows FROM treatment WHERE deleted=0 ORDER BY treatmentid DESC";
            ...
            while($row = mysqli_fetch_array( $result ))
            {
				...
				echo '<td><a href=\'add_treatment.php?treatmentid='.$row['treatmentid'].'\'>Edit</a></td>';
				echo "</tr>";
            }
