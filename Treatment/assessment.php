...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <h1 class="double-pad-bottom">My Assessment Dashboard
        <?php
            echo '<a href="config_treatment.php" class="mobile-block pull-right"><img title="Check In Tile Setting" src="../img/icons/settings-4.png" class="settings-classic wiggle-me" width="50px"></a><br><br>';
        ?>
        </h1>
		...
		<div class="mobile-100-container">
			...
			<span class="nav-subtab">
				<?php if (strpos($value_config, ','."Assessment".',') !== FALSE) { ?>
					...
					<a href='assessment.php'><button type="button" class="btn brand-btn mobile-block mobile-100 active_tab">My Assessment</button></a>
				<?php } ?>
			</span>
			<span class="nav-subtab">
        ...
        <form name="form_patients" method="post" action="" class="form-inline" role="form">
			...
			echo '<a href="assessments/body_targeted_assessment.php" class="btn brand-btn pull-right">Body Targeted Assessment</a>';
            ...
            $query_check_credentials = "SELECT * FROM assessment WHERE deleted=0 ORDER BY assessmentid DESC LIMIT $offset, $rowsPerPage";
            $query = "SELECT count(*) as numrows FROM assessment WHERE deleted=0 ORDER BY assessmentid DESC";
