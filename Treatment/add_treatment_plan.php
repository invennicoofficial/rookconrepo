...
if (isset($_POST['submit'])) {
    ...
    echo '<script type="text/javascript"> window.location.replace("treatment_plan.php"); </script>';
...
<div class="container">
  <div class="row">
        ...
        <h1 class="triple-pad-bottom">Treatment Plan</h1>
        ...
        <div class="form-group">
            <div class="col-sm-4 clearfix">
                <a href="treatment_plan.php" class="btn brand-btn pull-right">Back</a>
            </div>
            <div class="col-sm-8">
