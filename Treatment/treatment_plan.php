...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <h1 class="double-pad-bottom">Treatment Plan Dashboard
        <?php
            echo '<a href="config_treatment.php" class="btn brand-btn mobile-block pull-right config-btn"><img style="width:50px;" title="Tile Settings" src="../img/icons/settings-4.png" class="settings-classic wiggle-me"></a><br><br>';
        ?>
        </h1>
		...
		<div class="mobile-100-container">
			...
			<span class="nav-subtab">
				<?php if (strpos($value_config, ','."Treatment Plan".',') !== FALSE) { ?>
					...
					<a href='treatment_plan.php'><button type="button" class="btn brand-btn mobile-block mobile-100 active_tab">Treatment Plan</button></a>
				<?php } ?>
			</span>
			<span class="nav-subtab">
        ...
        <form name="form_patients" method="post" action="" class="form-inline" role="form">
            ...
            <?php
			echo '<a href="add_treatment_plan.php" class="btn brand-btn pull-right">Add Treatment Plan</a>';
            ...
            $query_check_credentials = "SELECT * FROM treatment_plan WHERE deleted=0 ORDER BY treatmentplanid DESC LIMIT $offset, $rowsPerPage";
            $query = "SELECT count(*) as numrows FROM treatment_plan WHERE deleted=0 ORDER BY treatmentplanid DESC";
            ...
            while($row = mysqli_fetch_array( $result ))
            {
				...
				echo '<td><a href=\'add_treatment_plan.php?treatmentplanid='.$row['treatmentplanid'].'\'>Edit</a></td>';
				echo "</tr>";
            }
