...
<div class="container">
  <div class="row">
    ...
    <h1>Custom</h1>
	<div class="gap-top double-gap-bottom"><a href="custom.php" class="btn config-btn">Back to Dashboard</a></div>
    ...
    <?php
        ...
        if(!empty($_GET['customid'])) {
            ...
            $get_contact = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM custom WHERE customid='$customid'"));
        ...
        ?>
        <input type="hidden" id="customid" name="customid" value="<?php echo $customid ?>" />
        <?php   }      ?>
        ...
        <div class="panel-group" id="accordion2">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select id="service_type" name="service_type" class="chosen-select-deselect form-control" width="380">
                                <option value=''></option>
                                <?php
                                $query = mysqli_query($dbc,"SELECT distinct(service_type) FROM custom");
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select id="category" name="category" class="chosen-select-deselect form-control" width="380">
                                <option value=''></option>
                                <?php
                                $query = mysqli_query($dbc,"SELECT distinct(category) FROM custom");
                                while($row = mysqli_fetch_array($query)) {
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_services" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        include ('add_custom_services.php');
                        ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_client" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_custom_clients.php');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_customer" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_custom_customer.php');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_inv" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_custom_inventory.php');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_equipment" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        include ('add_custom_equipment.php');
                        ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_eq_cat" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        include ('add_custom_equipment_category.php');
                        ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_staff_pos" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        include ('add_custom_staff_position.php');
                        ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_cont" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_custom_contractor.php');
                        ?>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="col-sm-6">
                <a href="custom.php" class="btn brand-btn btn-lg">Back</a>
				<!--<a href="#" class="btn brand-btn pull-right" onclick="history.go(-1);return false;">Back</a>-->
            </div>
          <div class="col-sm-6">
            <button type="submit" name="add_custom" value="Submit" class="btn brand-btn btn-lg pull-right">Submit</button>
		  </div>
        </div>
