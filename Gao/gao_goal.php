...
<?php
    ...
    foreach ($each_tab as $cat_tab) {
        ...
        echo "<a href='gao.php?maintype=my&status=".$cat_tab."'><button type='button' class='btn brand-btn mobile-block  mobile-100 ".$active_to_be."'>".$cat_tab."</button></a>&nbsp;&nbsp";
        $totalCount++;
...
<div class="mobile-100-container">
	<div class="col-sm-12 col-xs-12 col-lg-12 pad-top offset-xs-top-20">
		<div class="pull-right">
			...
			<a href="add_gao.php?type=self" class="btn brand-btn mobile-block gap-bottom">Add Goal</a>
		</div>
	</div>
	<?php
	if($num_rows > 0) {
