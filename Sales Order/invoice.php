...
// create new PDF document
    ...
    $html .= '<table>
				...
				<tr><td>'.$customer['first_name'].' '.$customer['last_name'].'</td><td style="text-align: right;"style="text-align: right;">'.$customer['first_name'].' '.$customer['last_name'].'</td></tr>
    ...
    window.location.replace('purchase_orders.php');
			...
			<div id="tab3" class="tab-pane triple-gap-top">
                ...
                <?php if (strpos($value_config, ','."Customer".',') !== FALSE) { ?>
                  <div class="form-group" id="customerg">
                    ...
                    <div class="col-sm-8">
                      <select id="customer" onchange="changeClient(this)" name="contactid" data-placeholder="Choose Customer..." class="chosen-select-deselect form-control" width="380">
                  ...
                  <div class="additional_position">
                    ...
                    <div class="form-group clearfix" width="100%">
                        ...
                        <div class="col-sm-1"  style="width:15%; display:inline-block; position:relative;" id="part_0">
                         <select data-placeholder="Choose a Part#..." onchange="selectPart(this)"  id="part_dd_0" name="part_no[]" class="chosen-select-deselect form-control part">
                             <?php
