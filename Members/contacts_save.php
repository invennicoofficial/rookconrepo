...
if (empty($_POST['submit_type'])) {
    include('../Contacts/contacts_save_main.php');
}
include('../ClientInfo/contacts_save_clientinfo.php');
// Main Table
...
// Medical Table
include('../Contacts/contacts_save_medical.php');
// Medical Table

// Cost Table
include('../Contacts/contacts_save_cost.php');
// Cost Table

// Cost Table
include('../Contacts/contacts_save_dates.php');
// Cost Table

// Description Table
include('../Contacts/contacts_save_desc.php');
// Description Table

// Upload Table
include('../Contacts/contacts_save_upload.php');
// Upload Table

// Record the history of the change
include('../Contacts/contacts_save_history.php');
// Record the history of the change
