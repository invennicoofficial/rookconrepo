...
$config['settings']['Choose Fields for Key Methodologies']['data'] = array(
	...
	'One to One' => array(
			array('Do you require one to one care', 'dropdown', 'one_to_one'),
		),
	'At My Best' => array(
			array('Likes', 'textarea', 'best_likes'),
			array('Wants', 'textarea', 'best_wants'),
	...
	'Toileting' => array(
			array('Do you require extra support going to the bathroom', 'textarea', 'toileting'),
		),
	'Goals' => array(
			array('Display Goals', 'textarea', 'goal_display'),
			array('Recommend Future Goal', 'textarea', 'goal_future'),
	...
	'Transitions' => array(
			array('Transition Details', 'textarea', 'transitions'),
		),
	'Status' => array(
			array('Status', 'dropdown', 'status'),
		)
