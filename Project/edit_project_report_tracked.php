...
echo '<h3>&nbsp;'.($time_cards_edit ? '<button class="btn brand-btn pull-right cursor-hand" onclick="overlayIFrameSlider(\'../Timesheet/add_time_cards.php?projectid='.$projectid.'\',\'auto\',true); return false;">Add Time</button>' : '').'</h3>';
