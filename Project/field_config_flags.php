...
<div class="form-group">
	...
	<div class="col-sm-8">
		...
		<label class="form-checkbox"><input type="checkbox" name="quick_action_icons[]" <?= in_array('flag',$quick_action_icons) ? 'checked' : '' ?> value="flag"> <img class="inline-img" src="../img/icons/ROOK-flag-icon.png"> Flag</label>
		...
		<label class="form-checkbox"><input type="checkbox" name="quick_action_icons[]" <?= in_array('timer',$quick_action_icons) ? 'checked' : '' ?> value="timer"> <img class="inline-img" src="../img/icons/ROOK-timer-icon.png"> Track Time</label>
