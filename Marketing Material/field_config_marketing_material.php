...
if (isset($_POST['submit'])) {
    ...
    echo '<script type="text/javascript"> window.location.replace("field_config_marketing_material.php"); </script>';
...
<div class="gap-top double-gap-bottom"><a href="marketing_material.php" class="btn config-btn">Back to Dashboard</a></div>
...
<div class="panel-group" id="accordion2">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to add or remove the fields that will be visible only when you add Marketing Material."><img src="<?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
				<a data-toggle="collapse" data-parent="#accordion2" href="#collapse_field" >
                    Choose Fields for Marketing Material<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to add or remove the fields that will be visible on the Marketing Material Dashboard."><img src="<?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_dashboard" >
                    Choose Fields for Marketing Material Dashboard<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
...
<div class="form-group">
    <div class="col-sm-6">
        <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Clicking this will discard your Marketing Material settings."><img src="<?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
		<a href="marketing_material.php" class="btn config-btn btn-lg">Back</a>
	...
	<div class="col-sm-6">
		...
		<span class="popover-examples list-inline pull-right" style="margin:15px 3px 0 0;"><a data-toggle="tooltip" data-placement="top" title="Click this to finalize your Marketing Material settings."><img src="<?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
    </div>
