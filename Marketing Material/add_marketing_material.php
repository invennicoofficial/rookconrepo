...
if(!empty($_GET['certuploadid'])) {
    ...
    echo '<script type="text/javascript"> window.location.replace("add_marketing_material.php?marketing_materialid='.$marketing_materialid.'"); </script>';
}
                                        ...
                                        if(!empty($_GET['marketing_materialid'])) {
                                            ...
                                            if($num_rows > 0) {
                                                while($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo '<ul>';
                                                    echo '<li><a href="download/'.$row['document_link'].'" target="_blank">'.$row['document_link'].'</a> - <a href="add_marketing_material.php?certuploadid='.$certuploadid.'&marketing_materialid='.$marketing_materialid.'"> Delete</a></li>';
                                                    echo '</ul>';
                                                }
                                            }
                                        }
