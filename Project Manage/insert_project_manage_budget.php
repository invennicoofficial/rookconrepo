...
foreach ($_POST['clientid'] as $clientid_all) {
    if($clientid_all != '') {
        ...
        $review_profit_loss .= '<tr><td>Clients</td><td>'.$query['name'].'-'.$query['first_name'].' '.$query['last_name'].'</td> <td>$'.$query['cost'].'</td><td>$'.$_POST['clprojectprice'][$j].'</td><td '.$color_off.'>$'.$plus_minus.'</td></tr>';
...
foreach ($_POST['customerid'] as $customerid_all) {
    if($customerid_all != '') {
        ...
        $review_profit_loss .= '<tr><td>Customer</td><td>'.$query['name'].'-'.$query['first_name'].' '.$query['last_name'].'</td> <td>$'.$query['cost'].'</td><td>$'.$_POST['custprojectprice'][$j].'</td><td '.$color_off.'>$'.$plus_minus.'</td></tr>';
...
$html .= '<tr nobr="true">
        <td>'.$_SESSION['first_name'].' '.$_SESSION['last_name'].'</td><td>'.$project_name.'</td><td>'.get_config($dbc, 'quote_payment_term').'</td><td>'.get_config($dbc, 'quote_due_period').'</td></tr>';
$html .= '</table><br><br><br>';
