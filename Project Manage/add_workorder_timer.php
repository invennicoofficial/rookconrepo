<div class="form-group">
    <label for="fax_number"	class="col-sm-4	control-label"><button type="submit" name="start_timer_btn" value="Submit" class="btn btn-success wo-start-timer-btn brand-btn mobile-block btn-lg start_timer_btn">Start</button></label>
    <div class="col-sm-8">
...
<div class="form-group">
    <label for="fax_number"	class="col-sm-4	control-label">
        <button type="submit" name="break_timer_btn" value="Submit" class="btn btn-success wo-start-timer-btn brand-btn mobile-block btn-lg break_timer_btn">Break</label>
    <div class="col-sm-8">
...
<div class="form-group">
    <label for="fax_number"	class="col-sm-4	control-label">
        <button type="submit" name="end_break_timer_btn" value="Submit" class="btn btn-success wo-start-timer-btn brand-btn mobile-block btn-lg end_break_timer_btn">End Break</label>
    <div class="col-sm-8">
    </div>
</div>
...
<div class="form-group">
    <label for="fax_number"	class="col-sm-4	control-label">
        <button type="submit" name="end_day_timer_btn" value="Submit" class="btn btn-success wo-start-timer-btn brand-btn mobile-block btn-lg end_day_timer_btn">End Day</label>
    <div class="col-sm-8">
    </div>
</div>
...
<div class="col-md-12">
    <div class="form-group pull-right1">
        ...
        <div class="col-sm-8">
            <button class='btn btn-success wo-start-timer-btn brand-btn mobile-block' style="
	...
	<script>
        $(document).ready(function () {
            ...
            if(start_time != 0 && start_time != undefined) {
                ...
                $('.wo-start-timer-btn').addClass('hidden');
                $('.timer_submit').show();
            }
            */
        });
	    ...
	    (function(){
			...
			$('.start_timer_btn').on('click', function() {
                ...
                $.ajax({    //create an ajax request to load_page.php
                    type: "GET",
                    url: "project_manage_ajax_all.php?fill=startworkordertimer&projectmanageid="+projectmanageid+"&timer_task="+timer_task,
			...
			$('.break_timer_btn').on('click', function() {
                ...
                $.ajax({    //create an ajax request to load_page.php
                    type: "GET",
                    url: "project_manage_ajax_all.php?fill=pauseworkordertimer&projectmanageid="+projectmanageid+"&timer_value="+timer_value+"&timer_task="+timer_task,
                    dataType: "html",   //expect html to be returned
                    success: function(response) {
                        //window.location.replace("../Punch Card/punch_card.php");
                        //hasTimer = false;
			...
			$('.end_break_timer_btn').on('click', function() {
                ...
                $.ajax({    //create an ajax request to load_page.php
                    type: "GET",
                    url: "project_manage_ajax_all.php?fill=endworkordertimer&projectmanageid="+projectmanageid+"&timer_value="+timer_value+"&timer_task="+timer_task,
                    dataType: "html",   //expect html to be returned
                    success: function(response) {
                        //window.location.replace("../Punch Card/punch_card.php");
                        //hasTimer = false;
			...
			$('.end_day_timer_btn').on('click', function() {
                ...
                $.ajax({    //create an ajax request to load_page.php
                    type: "GET",
                    url: "project_manage_ajax_all.php?fill=enddayworkordertimer&projectmanageid="+projectmanageid+"&timer_value="+timer_value+"&timer_task="+timer_task,
                    dataType: "html",   //expect html to be returned
                    success: function(response) {
                        //window.location.replace("../Punch Card/punch_card.php");
                        //hasTimer = false;
			...
			/*
            $('.wo-start-timer-btn').on('click', function() {
                $('.timer_submit').show();
				hasTimer = true;
				$('.timer').timer({
					editable: true
                ...
                $.ajax({    //create an ajax request to load_page.php
                    type: "GET",
                    url: "project_manage_ajax_all.php?fill=startworkordertimer&projectmanageid="+projectmanageid+"&timer_contactid="+timer_contactid+"&timer_task="+timer_task,
                    dataType: "html",   //expect html to be returned
                    success: function(response) {
                    }
                });
            ...
            */
            ...
            $('.resume-timer-btn').on('click', function() {
                ...
                $.ajax({    //create an ajax request to load_page.php
                    type: "GET",
                    url: "project_manage_ajax_all.php?fill=resumeworkordertimer&projectmanageid="+projectmanageid+"&timer_value="+timer_value+"&timer_contactid="+timer_contactid+"&timer_task="+timer_task,
                    dataType: "html",   //expect html to be returned
                    success: function(response) {
                        hasTimer = false;
                        $('.timer').timer('remove');
            ...
            */
			...
			/*$('.pause-timer-btn').on('click', function() {
                ...
                $.ajax({    //create an ajax request to load_page.php
                    type: "GET",
                    url: "project_manage_ajax_all.php?fill=pauseworkordertimer&projectmanageid="+projectmanageid+"&timer_value="+timer_value+"&timer_contactid="+timer_contactid+"&timer_task="+timer_task,
                    dataType: "html",   //expect html to be returned
                    success: function(response) {
                        hasTimer = false;
                        $('.timer').timer('remove');
