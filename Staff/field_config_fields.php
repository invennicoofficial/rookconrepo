...
<div id="field_accordions" class="standard-body-content panel-group col-xs-12">
	<?php if(strpos($staff_field_subtabs, ',Staff Information,') !== false) { ?>
		<h3>Staff Information<button class="btn brand-btn small pull-right" onclick="addSection('staff_information');">Add Section</button></h3>
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='staff_information' ORDER BY `order` ASC");
		$i = 0;
	...
	<?php if(strpos($staff_field_subtabs, ',Staff Address,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='staff_address' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Position,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='position' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Employee Information,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='employee_information' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Driver Information,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='driver_information' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Direct Deposit Information,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='direct_deposit_information' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='software_id' ORDER BY `order` ASC");
	while($accordion = mysqli_fetch_assoc($accordions)) { ?>
		<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
		<div class="panel panel-default">
			<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Social Media,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='social_media' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Emergency,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='emergency' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Health,') !== false) { ?>
		<h3>Health & Safety<button class="btn brand-btn small pull-right" onclick="addSection('health');">Add Section</button></h3>
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='health' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Schedule,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='schedule' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',HR,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='hr' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Staff Documents,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='staff_docs' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
	...
	<?php if(strpos($staff_field_subtabs, ',Incident Reports,') !== false) { ?>
		...
		<?php $accordions = mysqli_query($dbc, "SELECT `configcontactid`, `accordion`, `contacts` FROM `field_config_contacts` WHERE `tab`='Staff' AND `subtab`='incident_reports' ORDER BY `order` ASC");
		while($accordion = mysqli_fetch_assoc($accordions)) { ?>
			<input type="hidden" name="configcontactid_order[]" value="<?= $accordion['configcontactid'] ?>">
			<div class="panel panel-default">
				<div class="panel-heading">
