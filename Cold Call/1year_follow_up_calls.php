...
<div class="container">
	<div class="row">
        ...
        <h1 class="double-pad-bottom">1 Year Follow Up From Last Appointment Date</h1>
        ...
        <a href='follow_up_calls.php'><button type="button" class="btn brand-btn mobile-block" >3 Months</button>
        <a href='6month_follow_up_calls.php'><button type="button" class="btn brand-btn mobile-block" >6 Months</button></a>
        <button type="button" class="btn brand-btn mobile-block active_tab" >1 Year</button>
        <br><br>

        <?php
        $follow_up_query = "SELECT * FROM follow_up_calls WHERE follow_up_date = CURDATE() - INTERVAL 1 YEAR";
