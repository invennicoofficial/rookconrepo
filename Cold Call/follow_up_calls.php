...
/*function followupDate(sel) {
	...
	$.ajax({    //create an ajax request to load_page.php
		type: "GET",
		url: "<?php echo WEBSITE_URL;?>/ajax_all.php?fill=client_booking_followup&id="+arr[1]+'&name='+action,
...
<div class="container">
	<div class="row">
        ...
        <h1 class="double-pad-bottom">3 Months Follow Up From Last Appointment Date</h1>
        ...
        <button type="button" class="btn brand-btn mobile-block active_tab" >3 Months</button>
        ...
        <?php
        $follow_up_query = "SELECT * FROM follow_up_calls WHERE follow_up_date = CURDATE() - INTERVAL 3 MONTH";
