...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <h1 class="">Staff Goals Dashboard
        <?php
            $role = $_SESSION['role'];
		...
		<div class="tab-container">
            ...
            if ( check_subtab_persmission( $dbc, 'goals_compensation', ROLE, 'staff_goals' ) === true ) { ?>
                <a href='goals.php'><button type="button" class="btn brand-btn mobile-block mobile-100 active_tab">Staff Goals</button></a><?php
            } else { ?>
        ...
        <form name="form_sites" method="post" action="" class="form-inline" role="form">
            ...
            Set and keep track of the goals set for each staff. This tile is used only by Super Administrators.</div>
                ...
                if(vuaed_visible_function($dbc, 'goals_compensation') == 1) {
                    echo '
						<span class="pull-right">
							<span class="popover-examples list-inline" style="margin:0 0 0 0;"><a data-toggle="tooltip" data-placement="top" title="Add a new staff member to goal reporting by selecting Add Goal and filling out the required fields."><img src="'. WEBSITE_URL .'/img/info.png" width="20"></a></span>
							<a href="add_goal.php" class="btn brand-btn mobile-block">Add Goal</a>
						</span>';
                }
                ?>
            </div>
            ...
            if($num_rows > 0) {
				...
				while($row = mysqli_fetch_array( $result ))
				{
					...
					echo '<a href=\'add_goal.php?goalid='.$row['goalid'].'\'>Edit</a>';

					//echo '<a href=\''.WEBSITE_URL.'/delete_restore.php?action=delete&goalid='.$row['goalid'].'\' onclick="return confirm(\'Are you sure?\')">Delete</a>';
					echo '</td>';
