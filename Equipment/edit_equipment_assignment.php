...
<div class="tile-sidebar sidebar hide-titles-mob standard-collapsible">
	<ul>
		...
		<a href="" onclick="return false;"><li class="active blue">Equipment Assignment Details</li></a>
	</ul>
</div>
...
<div class="scale-to-fill has-main-screen" style="overflow: hidden;">
	<div class="main-screen standard-body form-horizontal">
		<div class="standard-body-title">
 			<h3>Equipment Unit #<?= $unit_number ?>: Equipment Assignment</h3>
		</div>
				...
				<div id="no-more-tables">
					<?php if(vuaed_visible_function($dbc, 'equipment') == 1) { ?>
						<div class="pull-right gap-bottom">
							<a href="" onclick="overlayIFrameSlider('<?= WEBSITE_URL ?>/Calendar/equip_assign.php?equipmentid=<?= $_GET['edit'] ?>&start_date=<?= date('Y-m-d') ?>&end_date=<?= date('Y-m-d') ?>'); return false;" class="btn brand-btn">Add Equipment Assignment</a>
						</div>
					<?php } ?>
