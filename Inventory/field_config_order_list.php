...
<div class="gap-top">
    <?php if(isset($_GET['order_id'])) { ?>
        <a href='field_config.php?type=order_list'><span class='btn brand-btn mobile-block ' ><-- Back</span></a>
    <?php } else { ?>
    ...
    <div class='create_list_form' style='<?php if(isset($_GET['order_id'])) { } else { ?>display:none;<?php } ?> border: 10px outset darkgrey; background-color:lightgrey;border-radius:10px; padding: 10px; margin:15px;'>
        ...
        <div class="col-sm-8 pull-right">
            ...
            while($row = mysqli_fetch_array( $result ))
            {
                ...
                echo '<a href=\'field_config.php?type=order_list&order_id='.$row['order_id'].'\'>Edit</a> | ';
                echo '<a href=\'field_config.php?type=order_list&deleteid='.$row['order_id'].'\' onclick="return confirm(\'Are you sure?\')">Delete</a>';
