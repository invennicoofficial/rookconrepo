            ...
            <div class="tile-container" style="height: 100%;">
                ...
                <div class="scale-to-fill has-main-screen tile-content hide-titles-mob">
                    <div class="main-screen standard-body">
                        <div class="standard-body-title"><h3>Order Checklists</h3></div>
                        <div class="standard-body-content pad-left pad-right">
                            ...
                            <div class="notice gap-bottom gap-top popover-examples">
                                ...
                                This tab is designed to help you keep track of which inventory needs to be ordered next.</div>
                                <div class="clearfix"></div>
                            </div>
    						<div class="col-sm-12 checklist_div double-gap-top">
    							<?php include('order_checklist_display.php'); ?>
    						</div>
                        </div>
					</div>
				</div>
