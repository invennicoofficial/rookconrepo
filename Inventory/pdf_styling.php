            	...
            	<div class="collapsible tile-sidebar set-section-height">
					<ul class='sidebar'>
						<h4 style="padding-left: 0.5em;">Design Style</h4>
							<a href="?type=pdfstyling&style_settings=design_styleA"><li class="<?= empty($_GET['style_settings']) || $_GET['style_settings'] == 'design_styleA' ? 'active' : '' ?>">Design Style A</li></a>
							<a href="?type=pdfstyling&style_settings=design_styleB"><li class="<?= $_GET['style_settings'] == 'design_styleB' ? 'active' : '' ?>">Design Style B</li></a>
							<a href="?type=pdfstyling&style_settings=design_styleC"><li class="<?= $_GET['style_settings'] == 'design_styleC' ? 'active' : '' ?>">Design Style C</li></a>
						<?php if(!isset($_GET['preview'])): ?>
							<h4 style="padding-left: 0.5em;">Design Settings</h4>
								<a href="?type=pdfstyling&settings=pdf_setting&style_settings=<?php echo $_GET['style_settings']; ?>"><li class="<?= $_GET['settings'] == 'pdf_setting' ? 'active' : '' ?>">PDF Settings</li></a>
								<a href="?type=pdfstyling&settings=pdf_header_setting&style_settings=<?php echo $_GET['style_settings']; ?>"><li class="<?= $_GET['settings'] == 'pdf_header_setting' ? 'active' : '' ?>">Header</li></a>
								<a href="?type=pdfstyling&settings=pdf_main_setting&style_settings=<?php echo $_GET['style_settings']; ?>"><li class="<?= $_GET['settings'] == 'pdf_main_setting' ? 'active' : '' ?>">Main Content</li></a>
								<a href="?type=pdfstyling&settings=pdf_footer_setting&style_settings=<?php echo $_GET['style_settings']; ?>"><li class="<?= $_GET['settings'] == 'pdf_footer_setting' ? 'active' : '' ?>">Footer</li></a>
						<?php endif; ?>
					</ul>
				</div>
			</div>

        	<div class="scale-to-fill tile-content set-section-height" style="margin-top: 1em;">
        		<div class="main-screen-details" style="height:calc(100vh - 20em); overflow-y: auto;">
