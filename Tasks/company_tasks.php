...
<div class="container">
    ...
    <h1 class="single-pad-bottom pull-left">Company Task Boards</h1>
    <?php
    ...
    echo '<br><br><div class="pull-right mobile-100-pull-right"><a href="add_task_board.php?security=Company"><button type="button" class="btn brand-btn mobile-block">Add Task Board</button></a>
	...
	echo '<div class="pull-left tab"><span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Unassigned tasks appear in this task board."><img class="" src="'.WEBSITE_URL.'/img/alert-yellow.png" border="0" alt="">&nbsp;&nbsp;<img src="' . WEBSITE_URL . '/img/info.png" width="20"></a></span>
	<span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="The task has not been assigned a to do date or the date has past."><img src="'.WEBSITE_URL.'/img/icons/thumb_down.png" border="0" alt="">&nbsp;&nbsp;<img src="' . WEBSITE_URL . '/img/info.png" width="20"></a></span>
	<span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="The task has been assigned a to do date."><img src="'.WEBSITE_URL.'/img/icons/thumb_up.png" border="0" alt="">&nbsp;&nbsp;<img src="' . WEBSITE_URL . '/img/info.png" width="20"></a></span>
	</div>';
	...
	<div class="clearfix"></div>
        ...
        while($row = mysqli_fetch_array($result)) {
            ...
            if($get_config['total_unread'] > 0) {
                $alert = '<img class="pull-righ1t" src="'.WEBSITE_URL.'/img/alert-yellow.png" border="0" alt="">&nbsp;&nbsp;';
            }

            echo "<a href='company_tasks.php?category=".$row['taskboardid']."'><button type='button' class='mobile-100 btn brand-btn mobile-block ".$active_daily."' >".$alert.$row['board_name']."</button></a>&nbsp;&nbsp;";
        }
        ...
        if($_GET['category'] != 'All') {
            ...
            foreach ($each_tab as $cat_tab) {
                ...
                echo '<li class="new_task_box"><input onChange="changeEndAme(this)" name="add_task" id="add_new_task '.$status.' '.$task_path.' '.$taskboardid.'" type="text" class="form-control" /></li></a>';

	            echo '<li class=""><a href="add_tasklist.php?task_milestone_timeline='.$status.'&task_path='.$task_path.'&task_board='.$taskboardid.'&from='.urlencode(WEBSITE_URL.$_SERVER['REQUEST_URI']).'" class="btn brand-btn pull-right">Add Task</a></li>';
