...
<div class="container">
    ...
    echo '<br><br><div class="mobile-100-container"><a href="add_tasklist.php?from='.urlencode(WEBSITE_URL.$_SERVER['REQUEST_URI']).'" class="adder btn brand-btn pull-right mobile-100-pull-right">Add Task</a></div>';
