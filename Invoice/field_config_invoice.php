                ...
                <div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<label class="form-checkbox"><input style="height: 30px; width: 30px;" class="tax_exemption" <?php if ($invoice_design == 'cnt1') { echo 'checked'; } ?> type="radio" name="invoice_design" value="cnt2">
