...
<div class="container triple-pad-bottom">
	...
	<div class="row hide_on_iframe">
        ...
        <?php
            echo '<a href="field_config_invoice.php" class="btn mobile-block pull-right"><img style="width:30px;" title="Tile Settings" src="../img/icons/settings-4.png" class="settings-classic wiggle-me"></a>';
        ?>
