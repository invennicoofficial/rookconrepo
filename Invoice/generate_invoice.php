        ...
        <form name="invoice" method="post" action="" class="form-inline" role="form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                  ...
                  <option value=""></option>
                  <?php
                    $query = mysqli_query($dbc,"SELECT distinct(patientid) FROM invoice WHERE deleted = 0 AND final_price IS NULL");
            ...
            if($search_user != '') {
                $query_check_credentials = "SELECT * FROM invoice WHERE deleted = 0 AND final_price IS NULL AND patientid='$search_user' ORDER BY invoice_date LIMIT $offset, $rowsPerPage";
                $query = "SELECT count(*) as numrows FROM invoice WHERE deleted = 0 AND final_price IS NULL AND patientid='$search_user' ORDER BY invoice_date";
            } else {
                $query_check_credentials = "SELECT * FROM invoice WHERE deleted = 0 AND final_price IS NULL ORDER BY invoice_date LIMIT $offset, $rowsPerPage";
                $query = "SELECT count(*) as numrows FROM invoice WHERE deleted = 0 AND final_price IS NULL ORDER BY invoice_date";
            }
