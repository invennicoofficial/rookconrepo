...
<div class="container triple-pad-bottom">
	...
	<div class="row hide_on_iframe">
        ...
        <a href='invoice.php'><button type="button" class="btn brand-btn mobile-block active_tab" >Paid Invoice</button></a>
        ...
        <form name="invoice" method="post" action="" class="form-inline" role="form">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                  ...
                  <option value=""></option>
                  <?php
                    $query = mysqli_query($dbc,"SELECT distinct(patientid) FROM invoice WHERE deleted = 0 AND paid = 'Yes' AND patientid != 0");
            ...
            if(!empty($_GET['patientid'])) {
                ...
                if($search_user != '') {
                    $query_check_credentials = "SELECT * FROM invoice WHERE deleted = 0 AND paid = 'Yes' AND patientid='$search_user' ORDER BY invoiceid DESC, paid ASC,payment_type ASC,final_price DESC LIMIT $offset, $rowsPerPage";
                    $query = "SELECT count(*) as numrows FROM invoice WHERE deleted = 0 AND paid = 'Yes' AND patientid='$search_user' ORDER BY invoiceid DESC, paid ASC,payment_type ASC,final_price DESC";
                } else {
                    $query_check_credentials = "SELECT * FROM invoice WHERE deleted = 0 AND paid = 'Yes' ORDER BY invoiceid DESC, paid ASC,payment_type ASC,final_price DESC LIMIT $offset, $rowsPerPage";
                    $query = "SELECT count(*) as numrows FROM invoice WHERE deleted = 0 AND paid = 'Yes' ORDER BY invoiceid DESC, paid ASC,payment_type ASC,final_price DESC";
                }
            }
