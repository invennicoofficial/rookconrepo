...
function selectPromotionService(sel) {
	...
	$.ajax({
		type: "GET",
		url: "project_manage_ajax_all.php?fill=promotion_service_config&value="+stage,
...
function selectPromotionCat(sel) {
	...
	$.ajax({
		type: "GET",
		url: "project_manage_ajax_all.php?fill=promotion_cat_config&value="+stage,
		dataType: "html",   //expect html to be returned
		success: function(response){
...
function selectPromotionHeading(sel) {
	...
	$.ajax({
		type: "GET",
		url: "project_manage_ajax_all.php?fill=promotion_head_config&value="+stage+"&ratecardid="+ratecardid,
		dataType: "html",   //expect html to be returned
		success: function(response){
...
<div class="form-group">
    <div class="col-sm-12">
        ...
        <?php if((!empty($_GET['promoid'])) || (!empty($_GET['projectmanageid']))) {
            $promoid = '';
            $promoval = '';
