...
$(document).ready(function() {
    ...
    $('#add_row_s').on( 'click', function () {
		...
		clone.find('#sprojectunit_0').attr('id', 'sprojectunit_'+add_new_s);
       ...
       <?php
            ...
            <div class="form-group clearfix" id="<?php echo 'services_'.$id_loop; ?>" >
               ...
               <?php if (strpos($field_config_service, ','."Minimum Billable".',') !== FALSE) { ?>
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Unit Of Measure:</label>
                    <input name="sprojectunit[]" id="<?php echo 'sprojectunit_'.$id_loop; ?>" value="<?php echo $unit; ?>" type="text" class="form-control" />
                </div>
        ...
        <div class="additional_s clearfix">
            ...
            <div class="form-group clearfix" id="services_0">
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Unit of Measure:</label>
                    <input name="sprojectunit[]" id='sprojectunit_0' type="text" class="form-control" />
                </div>
				<div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Total:</label>
