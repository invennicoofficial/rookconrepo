...
$(document).ready(function() {
    ...
    $('#add_row_in').on( 'click', function () {
		...
		clone.find('#inprojectunit_0').attr('id', 'inprojectunit_'+add_new_s);
    ...
    <div class="col-sm-12">
        ...
        if(!empty($_GET['projectmanageid'])) {
            ...
            foreach($each_data as $id_all) {
                if($id_all != '') {
                    ...
                    $get_inventory .= '**'.$data_all[0].'#'.$data_all[2].'#'.$data_all[1].'#'.$data_all[3];
                }
            }
        }
        ...
        <?php if(!empty($get_inventory)) {
            ...
            <div class="form-group clearfix" id="<?php echo 'inventory_'.$id_loop; ?>" >
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Unit Of Measure:</label>
                    <input name="inprojectunit[]" id="<?php echo 'inprojectunit_'.$id_loop; ?>" value="<?php echo $unit; ?>" type="text" class="form-control" />
                </div>
        ...
        <div class="additional_in clearfix">
            ...
            <div class="form-group clearfix" id="inventory_0">
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Unit of Measure:</label>
                    <input name="inprojectunit[]" id='inprojectunit_0' type="text" class="form-control" />
                </div>
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Total:</label>
