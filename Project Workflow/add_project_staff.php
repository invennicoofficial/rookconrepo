...
$(document).ready(function() {
    ...
    $('#add_row_st').on( 'click', function () {
		...
		clone.find('#stprojectunit_0').attr('id', 'stprojectunit_'+add_new_s);
       ...
       <?php
        ...
        <?php if(!empty($get_staff)) {
            ...
            <div class="form-group clearfix" id="<?php echo 'staff_'.$id_loop; ?>" >
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Unit Of Measure:</label>
                    <input name="stprojectunit[]" id="<?php echo 'stprojectunit_'.$id_loop; ?>" value="<?php echo $unit; ?>" type="text" class="form-control" />
                </div>
        ...
        <div class="additional_st clearfix">
            ...
            <div class="form-group clearfix" id="staff_0">
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Unit of Measure:</label>
                    <input name="stprojectunit[]" id='stprojectunit_0' type="text" class="form-control" />
                </div>
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Total:</label>
