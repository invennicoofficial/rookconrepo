...
$(document).ready(function() {
    ...
    $('#add_row_cnt').on( 'click', function () {
		...
		clone.find('#cntprojectunit_0').attr('id', 'cntprojectunit_'+add_new_s);
...
function selectContractor(sel) {
	...
	$.ajax({
		type: "GET",
		url: "project_manage_ajax_all.php?fill=cnt_config&value="+stage+"&ratecardid="+ratecardid,
       ...
       <?php
        ...
        <?php if(!empty($get_contractor)) {
            ...
            <div class="form-group clearfix" id="<?php echo 'contractor_'.$id_loop; ?>" >
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Unit Of Measure:</label>
                    <input name="cntprojectunit[]" id="<?php echo 'cntprojectunit_'.$id_loop; ?>" value="<?php echo $unit; ?>" type="text" class="form-control" />
                </div>
        ...
        <div class="additional_cnt clearfix">
            ...
            <div class="form-group clearfix" id="contractor_0">
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Unit of Measure:</label>
                    <input name="cntprojectunit[]" id='cntprojectunit_0' type="text" class="form-control" />
                </div>
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label">Total:</label>
