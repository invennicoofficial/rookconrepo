...
function selectPackageService(sel) {
	...
	$.ajax({
		type: "GET",
		url: "project_manage_ajax_all.php?fill=package_service_config&value="+stage,
...
function selectPackageCat(sel) {
	...
	$.ajax({
		type: "GET",
		url: "project_manage_ajax_all.php?fill=package_cat_config&value="+stage,
		dataType: "html",   //expect html to be returned
		success: function(response){
...
function selectPackageHeading(sel) {
	...
	$.ajax({
		type: "GET",
		url: "project_manage_ajax_all.php?fill=package_head_config&value="+stage+"&ratecardid="+ratecardid,
		dataType: "html",   //expect html to be returned
		success: function(response){
...
<div class="form-group">
    <div class="col-sm-12">
        ...
        <?php if((!empty($_GET['pid'])) || (!empty($_GET['projectmanageid']))) {
            $pid = '';
            $pval = '';
            if(!empty($_GET['pid'])) {
                $pid = $_GET['pid'];
