	...
	<div class="double-gap-top">
		...
		if ( $pay_type == 'cash' ) { ?>
			...
			<div class="col-sm-12 gap-top">
				...
				<div class="col-sm-3"><input type="text" name="amount_tentered" class="form-control" id="amount_tentered" /></div>
			...
			<div class="col-sm-12">
				...
				<div class="col-sm-6 triple-gap-top">
					...
					<div class="col-sm-2"><button class="btn brand-btn btn-lg numpad-1x" onclick="$('#amount_tentered').val('10.00')">$10</button></div>
					...
					<div class="col-sm-2"><button class="btn brand-btn btn-lg numpad-1x" onclick="$('#amount_tentered').val('20.00')">$20</button></div>
					<div class="clearfix gap-bottom"></div>
					...
					<div class="col-sm-2"><button class="btn brand-btn btn-lg numpad-1x" onclick="$('#amount_tentered').val('50.00')">$50</button></div>
					<div class="clearfix gap-bottom"></div>
					<div class="col-sm-2"><button class="btn brand-btn btn-lg numpad" onclick="$('#amount_tentered').val('')">C</button></div>
