...
if (isset($_POST['printpdf'])) {
	...
	class MYPDF extends TCPDF {
		...
		public function Header() {
            ...
            $footer_text = 'Patient History <b>'.PATIENT.'</b>';
...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        Displays a full appointment history by patient.</div>
        ...
        <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                <label for="site_name" class="col-sm-4 control-label">Patient Search:</label>
                <div class="col-sm-8" style="width:auto">
                    <select data-placeholder="Select a Patient..." name="patient" class="chosen-select-deselect form-control">
                        <option value=""></option>
                        <?php
