...
$day_period = get_config($dbc, 'shift_increments');
$current_row = strtotime($day_start);
$calendar_table[0][0]['title'] = "Time";
if(get_config($dbc, 'shift_calendar_notes') == '1') { $calendar_table[0][0]['notes'] = "Notes"; }
if(get_config($dbc, 'shift_reminders') == '1') { $calendar_table[0][0]['reminders'] = "Reminders"; }
