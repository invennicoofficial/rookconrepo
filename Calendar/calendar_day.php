...
<div class="container">
	...
	<div class="row hide_on_iframe">
        ...
        <a href='calendar_day.php'><button type="button" class="btn brand-btn mobile-block active_tab" >Day</button></a>
...
function draw_calendar($dbc, $month,$year,$search_user,$search_client,$search_ticket,$search_status,$status_array){
	...
	/* keep going with days.... */
        ...
        $calendar.= '<div class="btn brand-btn pull-right today-btn">'.date('d').'</div>';
