...
<div class="hide_on_iframe ticket-calendar" style="padding: 1em;">
	...
	<a href='?type=ticket&view=custom'><button type="button" class="btn brand-btn mobile-block active_tab" >Custom</button></a>
	...
	<div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
	  ...
	  <div class="col-lg-4 col-md-3 col-sm-8 col-xs-8">
		<select data-placeholder="Select Staff" name="search_user" class="chosen-select-deselect form-control" width="380">
			<option value=""></option>
			<?php $query = sort_contacts_array(mysqli_fetch_all(mysqli_query($dbc,"SELECT contactid, first_name, last_name FROM contacts WHERE deleted=0 AND status = 1 AND category IN (".STAFF_CATS.")"),MYSQLI_ASSOC));
			foreach($query as $id) { ?>
