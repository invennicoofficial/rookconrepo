...
$day_end = get_config($dbc, 'ticket_day_end');
...
if(get_config($dbc, 'ticket_calendar_notes') == '1') { $calendar_table[0][0]['notes'] = "Notes"; }
if(get_config($dbc, 'ticket_reminders') == '1') { $calendar_table[0][0]['reminders'] = "Reminders"; }
