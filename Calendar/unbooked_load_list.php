...
if($_GET['wait_list'] == 'ticket' || $_GET['wait_list'] == 'ticket_multi') {
	...
	while($ticket = mysqli_fetch_array($ticket_list)) {
		...
		foreach(explode(',',$ticket['clientid']) as $single_client) {
			$filter_count['client_filters'][$single_client]++;
		}
