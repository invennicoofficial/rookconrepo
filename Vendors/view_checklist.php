<?php
if(isset($_GET['category']) && isset($_GET['contactid'])) {
    $url = WEBSITE_URL.'/Members/add_contacts.php?category='.$_GET['category'].'&contactid='.$_GET['contactid'];
}
?>
...
if(!in_array($_GET['contactid'],explode(',',$checklist['assign_staff']))) {
...
<h2><img src="<?= WEBSITE_URL ?>/img/<?= (in_array($checklist['checklistid'],explode(',',$user_settings['checklist_fav'])) ? 'filled' : 'blank') ?>_star.png" onclick="mark_favourite(this);" data-id="<?= $checklist['checklistid'] ?>"> <?= $checklist['checklist_name'] ?>
...
<span class="pull-right" style="cursor: pointer;" data-checklist="BOARD<?php echo $checklistid; ?>">
	...
	<span style="padding: 0.25em 0.5em;" title="Download Checklist" onclick="export_pdf(this); return false;"><img src="<?php echo WEBSITE_URL; ?>/img/icons/ROOK-download-icon.png" style="height:2.5em;"></span>
	...
	<?php if(trim($checklist['assign_staff'],',') == $_GET['contactid']) { ?>
		<span class="block-label">Private</span>
	<?php } ?>
	<a style="padding: 0.25em 0.5em;" title="Edit Checklist" href="?edit=<?= $_GET['view'] ?>"><img src="<?php echo WEBSITE_URL; ?>/img/icons/ROOK-edit-icon.png" style="height:2.5em;"></a>
...
while($row = mysqli_fetch_array( $result )) {
	...
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Edit" onclick="edit_item(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-edit-icon.png" style="height:1.5em;" onclick="return false;"></span>';
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Flag This!" onclick="flag_item(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-flag-icon.png" style="height:1.5em;" onclick="return false;"></span>';
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Reply" onclick="send_reply(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-reply-icon.png" style="height:1.5em;" onclick="return false;"></span>';
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Attach File" onclick="attach_file(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-attachment-icon.png" style="height:1.5em;" onclick="return false;"></span>';
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Send Alert" onclick="send_alert(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-alert-icon.png" style="height:1.5em;" onclick="return false;"></span>';
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Send Email" onclick="send_email(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-email-icon.png" style="height:1.5em;" onclick="return false;"></span>';
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Schedule Reminder" onclick="send_reminder(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-reminder-icon.png" style="height:1.5em;" onclick="return false;"></span>';
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Add Time" onclick="add_time(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-timer-icon.png" style="height:1.5em;" onclick="return false;"></span>';
	echo '<span style="display:inline-block; text-align:center; width:11.1%;" title="Archive Item" onclick="archive(this); return false;"><img src="'.WEBSITE_URL.'/img/icons/ROOK-trash-icon.png" style="height:1.5em;" onclick="return false;"></span>';
...
<div class="form-group clearfix">
    <div class="col-sm-6">
		...
		<a href="<?= $url ?>" class="btn brand-btn btn-lg">Back</a>
	</div>
</div>
