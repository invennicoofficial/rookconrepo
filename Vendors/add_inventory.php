...
<div class="container">
  <div class="row">
		<h1><?php echo ( isset($_GET['inventoryid']) && !empty($_GET['inventoryid']) ) ? 'Edit' : 'Add New'; ?> Product</h1>

		<form id="form1" name="form1" method="post"	action="add_inventory.php" enctype="multipart/form-data" class="form-horizontal" role="form"><?php
            $code = '';
            $sub_category = '';
            $part_no = '';
            $description =	'';
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="category" name="category" class="chosen-select-deselect form-control" width="380">
                                                ...
                                                */
                                                $result1 = mysqli_query($dbc, "SELECT DISTINCT(`category`) FROM `vendor_price_list`");
                                                while($row1 = mysqli_fetch_assoc($result1)) {
                                                    $selected = ($category == $row1['category']) ? 'selected="selected"' : '';
                                                    echo "<option ".$selected." value = '".$row1['category']."'>".$row1['category']."</option>";
                                                } ?>
                                            </select>
                                        </div>
                                    </div><?php
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select id="sub_category" name="sub_category" class="chosen-select-deselect form-control" width="380">
                                                <option value=""></option><?php
                                                $result1 = mysqli_query($dbc, "SELECT DISTINCT(`sub_category`) FROM `vendor_price_list`");
                                                while($row1 = mysqli_fetch_assoc($result1)) {
                                                    $selected = ($sub_category == $row1['sub_category']) ? 'selected="selected"' : '';
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-sm-6">
                    ...
                    <a href="add_contacts.php?category=<?= $category; ?>&contactid=<?= $vendorid; ?>&subtab=Price Lists" class="btn brand-btn btn-lg">Back</a>
