...
td.writable .clone a.unconfirmed {
    background: url(../images/unconfirmed.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}

td.writable .clone a.confirmed {
    background: url(../images/confirmed.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
td.writable .clone a.arrived {
    background: url(../images/check.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
td.writable .clone a.completed {
    background: url(../images/check.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
td.writable .clone a.rescheduled {
    background: url(../images/rescheduled.png) 0 0 no-repeat;
    background-position: right;
    background-size: 30px;
}
td.writable .clone a.walkout_NoShow {
    background: url(../images/delete.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
td.writable .clone a.cancelled {
    background: url(../images/delete.png) 0 0 no-repeat;
    background-position: right;
    background-size: 30px;
}