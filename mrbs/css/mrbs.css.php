...
body {
  ...
  background: fixed 50% 50% no-repeat url(../../img/software-bg.jpg);
...
tr.odd_row td.new {background-color: #e2f9bf;}
...
div.date_nav    {float: left;  width: 100%; margin-top: 1.5em; margin-bottom: 1.5em; font-weight: bold}
...
.dwm_main th a:link    {color: #fff;    text-decoration: none; font-weight: normal}
.dwm_main th a:visited {color: #fff; text-decoration: none; font-weight: normal}
...
.dwm_main td.row_labels     {background-color: <?php echo $main_table_labels_back_color ?>; white-space: nowrap;     border-radius: 5px 0 0 5px; padding: 5px;}    /* used for the row labels column */
...
?>
.dwm_main td:hover.new, .dwm_main td.new_hover {background-color: #3b93c5;}
...
?>
div.celldiv {max-width: 100%; overflow: hidden; margin: 0; padding: 0; border-radius: 5px;}
...
.form_general fieldset {width: auto; border: 0; padding-top: 2.0em; position:relative; float:left; padding: 10px 15px;}
...
.form_general select {float: left;    padding: 5px 0;
    margin: 5px 0;
    border-radius: 5px;}
...
.form_general input.submit {display: block; width: auto; float: left; clear: left; margin-top: 1.0em; padding: 5px 15px;}
...
fieldset#rep_info {padding-top: 0.7em}
...
#banner td {text-align: center; vertical-align: middle;
    background: #b8bac6;
    background: -moz-linear-gradient(top, #b8bac6 0%, #b8bac6 0%, #dbdce2 21%, #f5f6f6 46%, #dddfe3 80%, #b8bac6 100%);
    background: -webkit-linear-gradient(top, #b8bac6 0%,#b8bac6 0%,#dbdce2 21%,#f5f6f6 46%,#dddfe3 80%,#b8bac6 100%);
    background: linear-gradient(to bottom, #b8bac6 0%,#b8bac6 0%,#dbdce2 21%,#f5f6f6 46%,#dddfe3 80%,#b8bac6 100%);
...
#banner a:link    {color: #3b93c5;    text-decoration: none; font-weight: normal}
#banner a:visited {color: #3b93c5; text-decoration: none; font-weight: normal}
#banner a:hover   {color: #40ad45;   text-decoration:underline; font-weight: normal}
...
#colour_key td {width: 13.0em; padding: 2px; font-weight: bold;
    color: black;
...
table.calendar {border-spacing: 0; border-collapse: collapse; background-color: #e2f9bf; border-radius: 5px;
...
.unconfirmed {
    background: url(../images/status_icon/unconfirmed.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
.confirmed {
    background: url(../images/status_icon/confirmed.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
.arrived {
    background: url(../images/status_icon/arrived.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
.invoiced {
    background: url(../images/status_icon/invoiced.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
.paid {
    background: url(../images/status_icon/paid.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
.rescheduled {
    background: url(../images/status_icon/rescheduled.png) 0 0 no-repeat;
    background-position: right;
    background-size: 30px;
}
.late_noshow {
    background: url(../images/status_icon/noshow.png) 0 0 no-repeat;
    background-position: right;
    background-size: 20px;
}
.cancelled {
    background: url(../images/status_icon/cancel.png) 0 0 no-repeat;
    background-position: right;
    background-size: 30px;
}

/* Hide Fields */
div#div_description, div#div_areas, div#div_confirmation_status {
