<div class="col-md-12">
   <?php
    if(!empty($_GET['projectid'])) {
        $query_check_credentials = "SELECT * FROM client_project_comment WHERE projectid='$projectid' AND type='note' ORDER BY projectcommid DESC";
    ...
    ?>
      ...
      <div class="form-group">
		...
		$subject = 'Note Added on Client Project for you to review.';
		$body = 'Note : [NOTE]<br><br>
            Please click below Project link to view all information.<br>
            Client Project : <a target="_blank" href="'.$_SERVER['SERVER_NAME'].'/Client Project/add_project.php?projectid=[PROJECTID]&note=add_view">Click Here</a><br>';
		?>
		<script>
