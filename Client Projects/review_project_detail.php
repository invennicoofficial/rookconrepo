...
if (isset($_POST['printtherapistpdf'])) {
    ...
    $html .= review_client_project_detail($dbc, $projectid);
...
?>
    ...
    <?php
    echo review_client_project_detail($dbc, $projectid);
    ?>

<?php
function review_client_project_detail($dbc, $projectid) {
    $review = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM client_project_detail WHERE projectid='$projectid'"));
    $review_project = '';
