        ...
        <?php if(!empty($get_products)) {
            ...
            <div class="form-group clearfix" id="<?php echo 'products_'.$id_loop; ?>" >
               ...
               <?php if (strpos($field_config_product, ','."Minimum Billable".',') !== FALSE) { ?>
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label"><?php echo get_config($dbc, 'client_project_product_qty_cost'); ?>:</label>
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label"><?php echo get_config($dbc, 'client_project_product_price_or_hours'); ?>:</label>
