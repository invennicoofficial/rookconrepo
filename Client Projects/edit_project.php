...
if (isset($_POST['submit'])) {
    ...
    $query_update_report = "UPDATE `client_project` SET `project_data` = '$project_data' WHERE `projectid` = '$projectid'";
...
<div class="container">
	<div class="row">
        ...
        <a href='edit_project.php?projectid=<?php echo $projectid;?>&type=budget'><button type="button" class="btn brand-btn mobile-block <?php echo $budget; ?>" >By Service</button></a>&nbsp;&nbsp;
            ...
            <?php
			$project_all = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT *  FROM client_project WHERE projectid='$projectid'"));
            ?>
            <input type="hidden" name="projectid" id="projectid" value="<?php echo $projectid; ?>">

            <?php if($type == 'summary') { ?>
            <div class="form-group">
                <label for="additional_note" class="col-sm-4 control-label">Client Project:</label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                <div class="col-sm-4 clearfix">
                    <a href="project.php?tab=active" class="btn brand-btn pull-right">Back</a>
            ...
            <?php if($type == 'profit_loss') {
               ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                    <td data-title='Type'>Total Project Price</td>
              ...
              <?php
               ...
               ?><div id='no-more-tables'>
                <table class="table table-bordered">
                    ...
                    <td data-title='Project Price'>$<?php echo $project_all['total_price']; ?></td>
                    </tr>
                </table></div>
                <a href="project.php?tab=active" class="btn brand-btn pull-right">Back</a>
				<!--<a href="#" class="btn brand-btn" onclick="history.go(-1);return false;">Back</a>-->
