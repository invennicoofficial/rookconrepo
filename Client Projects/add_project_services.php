...
<div class="form-group">
    <div class="col-sm-12">
        <div class="form-group clearfix hide-titles-mob">
            ...
            <label class="col-sm-1 text-center"><?php echo get_config($dbc, 'client_project_service_qty_cost'); ?></label>
            <label class="col-sm-1 text-center"><?php echo get_config($dbc, 'client_project_service_price_or_hours'); ?></label>
        ...
        <?php if(!empty($get_services)) {
            ...
            <div class="form-group clearfix" id="<?php echo 'services_'.$id_loop; ?>" >
               ...
               <?php if (strpos($field_config_service, ','."Minimum Billable".',') !== FALSE) { ?>
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label"><?php echo get_config($dbc, 'client_project_service_qty_cost'); ?>:</label>
                ...
                <div class="col-sm-1" ><label for="company_name" class="col-sm-4 show-on-mob control-label"><?php echo get_config($dbc, 'client_project_service_price_or_hours'); ?>:</label>
