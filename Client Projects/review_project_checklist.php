...
$(document).ready(function() {
    ...
    <form name="form_sites" method="post" action="" class="form-inline" role="form">
        ...
        $result = mysqli_query($dbc, "SELECT * FROM checklist WHERE security = 'My Checklist' AND checklist_type='$category' AND client_projectid='$projectid'");
			...
			echo '<div class="tab-container">';
				...
				echo '
					<div class="pull-right tab">
						...
						<a href=\'../delete_restore.php?action=delete&remove_client_project_checklist=all&checklistid='.$checklistid.'&projectid='.$projectid.'\' onclick="return confirm(\'Are you sure?\')" class="btn brand-btn mobile-block mobile-100 gap-bottom pull-right">Delete</a>
					</div>';
