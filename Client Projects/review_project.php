...
<div class="container">
	...
	<div class="row hide_on_iframe">
        ...
        <?php
            ...
            $b_name = get_contact($dbc, $clientid);
			$current_tab = '';
            $pp = '';
            $ec = '';
            $detail = '';
			...
			if(empty($_GET['from_url'])) {
				$_GET['from_url'] = WEBSITE_URL."/Client Projects/project.php?type=".get_client_project($dbc,$projectid,'projecttype');
			}
        ?>
		...
		<script>
		$(document).ready(function() {
			document.title = "Project #<?php echo $projectid; ?>";
		});
		</script>
