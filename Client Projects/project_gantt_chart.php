...
<div class="container">
	<div class="row hide_on_iframe">
        ...
        //} else {
            $query_check_credentials = "SELECT * FROM client_project WHERE projecttype = '$type'";
        //}
        ...
        while($row = mysqli_fetch_array( $result )) {
            ...
            $data[] = array(
              'label' => '<a class="" href="#"  onclick="window.open(\''.WEBSITE_URL.'/Client Project/add_project.php?projectid='.$projectid.'&type='.$type.'\', \'newwindow\', \'width=1000, height=900\'); return false;">'.$project_name.'</a>',
