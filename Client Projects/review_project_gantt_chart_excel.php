...
<table>
	...
	<tr>
		<td colspan="<?php echo $d+2; ?>" rowspan="2">
			<?php echo '<h3 style="color:33B0B0;">'.get_client_project($dbc, $projectid, 'project_name').'</h3>'; ?>
		</td>
	</tr>
	<tr></tr>
	<tr>
        ...
        <?php
        $result_ticket = mysqli_query($dbc, "SELECT distinct(to_do_date) FROM tickets WHERE client_projectid = '$projectid' order by to_do_date");
        $dayscount = array();
