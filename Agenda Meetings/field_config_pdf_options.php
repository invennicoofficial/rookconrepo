...
<div class="form-horizontal">
	<div class="form-group">
		<label class="col-sm-4">PDF Notes:<br><em>(e.g. - details about quote, etc., displayed immediately after the quote)</em></label>
		<div class="col-sm-8">
			<textarea name="quote_sign_notes" data-table="general_configuration"><?= get_config($dbc, "quote_sign_notes") ?></textarea>
		</div>
	</div>
	<div class="form-group">
		<label class="col-sm-4">PDF Terms:<br><em>Will be displayed in a smaller font at the bottom of the quote.</em></label>
		<div class="col-sm-8">
