...
if (isset($_POST['add_marketing_material'])) {
    ...
    while($row = mysqli_fetch_array( $result )) {
        if($row['document_link'] != '') {
            ...
            $meeting_attachment .= $download_link.'*#FFM#*';
        }
    }
                    ...
                    if(!empty($_GET['marketing_materialid'])) {
                        ...
                        if($num_rows > 0) {
                            while($row = mysqli_fetch_array($result)) {
                                ...
                                echo '<li><a href="'.$download_link.'" target="_blank">'.$row['document_link'].'</a></li>';
                                echo '</ul>';
                            }
                        }
                    }
                    ...
                    if(!empty($_GET['marketing_materialid'])) {
                        ...
                        if($num_rows > 0) {
                            ...
                            while($row = mysqli_fetch_array($result)) {
                                $certuploadid = $row['certuploadid'];
                                echo '<ul>';
                                echo '<li><a target="_blank" href=\''.$row['document_link'].'\'">Link '.$link_no.'</a> - <a href="?tab='.$_GET['tab'].'&certuploadid='.$certuploadid.'&edit='.$marketing_materialid.'"> Delete</a></li>';
                                echo '</ul>';
                                $link_no++;
                            }
                        }
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-6">
                        ...
                        <a href="?tab=<?= $_GET['tab'] ?>" class="btn brand-btn btn-lg">Back</a>
