<?php if($field_option == 'Contact Image') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['contactimage'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="contactimage">Delete</a></span>';
		} ?>
	...
	<div class="col-sm-8">
		...
		while($document = mysqli_fetch_array($documents)) {
			...
			<li><a href="<?= $target ?>" target="_blank"><?= $document['label'] == '' ? $target : $document['label'] ?></a>
				...
				- <a href="" onclick="saveField(this); $(this).closest('li').remove(); return false;" data-table="<?= $document['table_name'] ?>" data-field="deleted" data-row-field="uploadid" data-row-id="<?= $document['uploadid'] ?>" data-value="1">Delete</a>
...
<?php } else if($field_option == 'Application') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['application'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="application">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload License Plate') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_license_plate'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_license_plate">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Property Information') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_property_information'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_property_information">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Inspection') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_inspection'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_inspection">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Letter of Intent') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_letter_of_intent'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_letter_of_intent">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Vendor Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_vendor_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_vendor_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Marketing Material') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_marketing_material'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_marketing_material">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Purchase Contract') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_purchase_contract'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_purchase_contract">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Support Contract') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_support_contract'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_support_contract">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Support Terms') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_support_terms'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_support_terms">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Rental Contract') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_rental_contract'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_rental_contract">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Management Contract') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_management_contract'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_management_contract">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Articles of Incorporation') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_articles_of_incorporation'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_articles_of_incorporation">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Commercial Insurance') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_commercial_insurance'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_commercial_insurance">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload Residential Insurance') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_residential_insurance'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_residential_insurance">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Upload WCB') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_wcb'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_wcb">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Client Support Documents' || $field_option == 'Profile Client Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['client_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="client_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Member Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['member_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="member_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Transportation Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['transportation_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="transportation_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Transportation Upload License') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_drivers_license'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_drivers_license">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Void Cheque') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['upload_blank_cheque'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="upload_blank_cheque">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Insurance Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['insurance_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="insurance_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Guardians Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['guardians_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="guardians_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Emergency Contact Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['emergency_contact_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="emergency_contact_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Trustee Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['trustee_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="trustee_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Family Doctor Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['family_doctor_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="family_doctor_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Dentist Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['dentist_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="dentist_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Specialists Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['specialists_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="specialists_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Diagnosis Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['diagnosis_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="diagnosis_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Allergies Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['allergies_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="allergies_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Equipment Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['equipment_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="equipment_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Goal Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['goal_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="goal_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Medical Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['medical_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="medical_support_documents">Delete</a></span>';
		} ?>
	...
	<div class="clone_exception_block">
        ...
        <div class="col-sm-8">
            <?php if(!empty($_GET['edit']) && $contact['funding_support_documents'] != '') {
                ...
                <a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="funding_support_documents">Delete</a></span>';
            } ?>
...
<?php } else if($field_option == 'Medical Details First Aid/CPR') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['medical_details_first_aid_cpr'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="medical_details_first_aid_cpr">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Medical Details Support Documents') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['medical_details_support_documents'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="medical_details_support_documents">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Seizure Protocol Upload') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['seizure_protocol_upload'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="seizure_protocol_upload">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Slip Fall Protocol Upload') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['slip_fall_protocol_upload'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="slip_fall_protocol_upload">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Transfer Protocol Upload') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['transfer_protocol_upload'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="transfer_protocol_upload">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Toileting Protocol Upload') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['toileting_protocol_upload'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="toileting_protocol_upload">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Bathing Protocol Upload') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['bathing_protocol_upload'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="bathing_protocol_upload">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'G-Tube Protocol Upload') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['gtube_protocol_upload'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="gtube_protocol_upload">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Oxygen Protocol Upload') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['oxygen_protocol_upload'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="oxygen_protocol_upload">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'SRC Upload') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['src_upload'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="src_upload">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Worker Sheet') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['contract_contacts'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="contract_contacts">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Worker List') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['contract_worker_list'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="contract_worker_list">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Worker Abstract') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['contract_abstract'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="contract_abstract">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Worker Licences') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['contractor_licence'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="contractor_licence">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Worker Criminal Record') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['criminal_records'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="criminal_records">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Worker Criminal Record Auth') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['criminal_check_auth'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="criminal_check_auth">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Worker Bank Info') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['bank_info'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="bank_info">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Worker Business Registration') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['proof_of_registration'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="proof_of_registration">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Policies Agreement') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['contractor_agreement'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="contractor_agreement">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Policies Non Compete') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['non_compete'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="non_compete">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Policies Non Solicitation') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['non_solicitation'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="non_solicitation">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Policies Confidentiality') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['confidentiality'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="confidentiality">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Policies Uniforms') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['uniform_policy'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="uniform_policy">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Policies Leasing') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['lease_agreement'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="lease_agreement">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Policies Fuel Card') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['fuel_card_agreement'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="fuel_card_agreement">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract WCB Clearance') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['wcb_clearance'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="wcb_clearance">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract WCB Insurance') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['contract_insurance'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="contract_insurance">Delete</a></span>';
		} ?>
...
<?php } else if($field_option == 'Contract Rates Signed') { ?>
	...
	<div class="col-sm-8">
		<?php if(!empty($_GET['edit']) && $contact['rate_sheet'] != '') {
			...
			<a href="" onclick="saveField(this); return false;" data-table="contacts_upload" data-field="rate_sheet">Delete</a></span>';
		} ?>
