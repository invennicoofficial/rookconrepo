...
$config_mc['tile_name'] = 'Medical Charts';

$config_mc['tabs'] = array (
...
/* Bowel Movement */
$config_mc['settings']['Choose Fields for Bowel Movement']['config_field'] = 'bowel_movement';
$config_mc['settings']['Choose Fields for Bowel Movement']['data'] = array(
...
$config_mc['settings']['Choose Fields for Bowel Movement Dashboard']['config_field'] = 'bowel_movement_dashboard';
$config_mc['settings']['Choose Fields for Bowel Movement Dashboard']['data'] = array(
	'General' => array(
...
/* Seizure Record */
$config_mc['settings']['Choose Fields for Seizure Record']['config_field'] = 'seizure_record';
$config_mc['settings']['Choose Fields for Seizure Record']['data'] = array(
...
$config_mc['settings']['Choose Fields for Seizure Record Dashboard']['config_field'] = 'seizure_record_dashboard';
$config_mc['settings']['Choose Fields for Seizure Record Dashboard']['data'] = array(
	'General' => array(
			array('Client', 'dropdown', 'client'),
...
/* Daily Water Temp */
$config_mc['settings']['Choose Fields for Daily Water Temp']['config_field'] = 'daily_water_temp';
$config_mc['settings']['Choose Fields for Daily Water Temp']['data'] = array(
...
$config_mc['settings']['Choose Fields for Daily Water Temp Dashboard']['config_field'] = 'daily_water_temp_dashboard';
$config_mc['settings']['Choose Fields for Daily Water Temp Dashboard']['data'] = array(
	'General' => array(
			array('Client', 'dropdown', 'client'),
			array('Date', 'date', 'date'),
			array('Time', 'text', 'time'),
...
/* Blood Glucose */
$config_mc['settings']['Choose Fields for Blood Glucose']['config_field'] = 'blood_glucose';
$config_mc['settings']['Choose Fields for Blood Glucose']['data'] = array(
	'Blood Glucose' => array(
...
$config_mc['settings']['Choose Fields for Blood Glucose Dashboard']['config_field'] = 'blood_glucose_dashboard';
$config_mc['settings']['Choose Fields for Blood Glucose Dashboard']['data'] = array(
	'General' => array(
			array('Client', 'dropdown', 'client'),
			array('Date', 'date', 'date'),
			array('Time', 'text', 'time'),
