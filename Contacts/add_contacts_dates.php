            ...
            <?php if (strpos($value_config, ','."Start Date".',') !== FALSE) { ?>
                ...
                <label for="first_name" class="col-sm-4 control-label text-right">
                    <span class="popover-examples"><a data-toggle="tooltip" data-placement="top" title="Select start date from the calendar."><img src="../img/info.png" width="20"></a></span>
                    Start Date:
                </label>
                <div class="col-sm-8">
            ...
            <?php if (strpos($value_config, ','."Remax Start Date".',') !== FALSE) { ?>
				<div class="form-group clearfix completion_date">
                    <label for="first_name" class="col-sm-4 control-label text-right">RE/MAX Start Date:</label>
                    <div class="col-sm-8">
                        <input <?php echo (strpos($edit_config, ','."Remax Start Date".',') === false ? 'readonly class="form-control"' : 'class="form-control datepicker"'); ?> name="remax_start_date" value="<?php echo $remax_start_date; ?>" type="text"></p>
                    </div>
				</div>
            <?php } ?>
			...
			<?php if (strpos($value_config, ','."Birth Date".',') !== FALSE) { ?>
				<div class="form-group clearfix completion_date">
                <label for="first_name" class="col-sm-4 control-label text-right">
                    <span class="popover-examples"><a data-toggle="tooltip" data-placement="top" title="Select birth date from the calendar."><img src="../img/info.png" width="20"></a></span>
                    Birth Date:
                </label>
                <div class="col-sm-8">
            ...
            <?php if (strpos($value_config, ','."Company Benefit Start Date".',') !== FALSE) { ?>
                <div class="form-group clearfix completion_date">
                <label for="company_benefit_start_date" class="col-sm-4 control-label text-right">
                    <span class="popover-examples"><a data-toggle="tooltip" data-placement="top" title="Select staff company benefit start date from the calendar."><img src="../img/info.png" width="20"></a></span>
                    Company Benefit Start Date:
                </label>
                <div class="col-sm-8">
