                                        ...
                                        case 'acc_address': ?>
                                            <div class="form-group sort_group_blocks">
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <div class="block-group sortable_group" style="display:none;">
                                                        <?php foreach(array_unique(array_merge($field_config,['Address Sync To Site','Synced Site Hide Address','Address Create Site','Full Address','Address','City Quadrant','City','County','Province','Country','Postal Code','Google Maps Address','Key Number','Door Code Number','Alarm Code Number'])) as $field_option) {
                                                            switch($field_option) {
