                    ...
                    case 'acc_address': ?>
                        <div class="form-group sort_group_blocks">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="block-group sortable_group" style="display:none;">
                                    <?php foreach(array_unique(array_merge($field_config,['Address Sync To Site','Address Create Site','Full Address','Address','City Quadrant','City','County','Province','Country','Postal Code','Google Maps Address','Key Number','Door Code Number','Alarm Code Number'])) as $field_option) {
                                        switch($field_option) {
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="block-group sortable_group" style="display:none;">
                                    <?php foreach(array_unique(array_merge($field_config,['Estimates','Deposit','Damage Deposit','Quote Description'])) as $field_option) {
                                        switch($field_option) {
                                            case 'Estimates': ?><label class="form-checkbox"><input type="checkbox" <?= in_array('Estimates', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Estimates" onchange="save_options();">Estimates</label><?php break;
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="block-group sortable_group" style="display:none;">
                                    <?php foreach(array_unique(array_merge($field_config,['VPL Import/Export','VPL Description','Color','Category','Description','Product Name','Subcategory','Type','VPL Unique Identifier','Code','ID #','Item SKU','Part #','VPL Product Cost','Average Cost','CDN Cost Per Unit','COGS','Cost','USD Cost Per Unit','USD Invoice','VPL Purchase Info','Date Of Purchase','Purchase Cost','Vendor','VPL Shipping Receiving','Exchange $','Exchange Rate','Freight Charge','Shipping Cash','Shipping Rate','VPL Pricing','Admin Price','Client Price','Commercial Price','Commission Price','Final Retail Price','MSRP','Preferred Price','Purchase Order Price','Rush Price','Sales Order Price','Sell Price','Suggested Retail Price','Unit Cost','Unit Price','Web Price','Wholesale Price','VPL Markup','Markup By $','Markup By %','VPL Stock','Buying Units','Current Stock','Variance','Quantity','Selling Units','Stocking Units','Write-offs','VPL Location','Location','LSD','VPL Dimensions','Size','Weight','VPL Alerts','Min Bin','Min Max','VPL Time Allocation','Actual Hours','Estimated Hours','VPL Admin Fees','GL Assets','GL Revenue','Minimum Billable','VPL Quote','Quote Description','VPL Status','Status','VPL Display On Website','Display On Website','VPL General','Comments','Notes','VPL Rental','Reminder/Alert','Rent Price','Rental Days','Rental Weeks','Rental Months','Rental Years','VPL Day/Week/Month/Year','#Of Hours','#Of Days','Daily','Weekly','Monthly','Annually','VPL Vehicle','#Of Kilometers','VPL Inclusion','Include in P.O.S.','Include in Purchase Orders','Include in Sales Orders','VPL Amount','Min Amount','Max Amount'])) as $field_option) {
                                        switch($field_option) {
                                            case 'VPL Import/Export': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Import/Export', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Import/Export" onchange="save_options();">Import/Export</label><?php break;
                                            case 'VPL Description': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Description', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Description" onchange="save_options();">Description
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Color', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Color" onchange="save_options();">Color</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Category', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Category" onchange="save_options();">Category</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Description', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Description" onchange="save_options();">Description</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Product Name', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Product Name" onchange="save_options();">Product Name</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Subcategory', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Subcategory" onchange="save_options();">Subcategory</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Type', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Type" onchange="save_options();">Type</label>
                                                </div></label><?php break;
                                            case 'VPL Unique Identifier': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Unique Identifier', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Unique Identifier" onchange="save_options();">Unique Identifier
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Code', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Code" onchange="save_options();">Code</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('ID #', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="ID #" onchange="save_options();">ID #</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Item SKU', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Item SKU" onchange="save_options();">Item SKU</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Part #', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Part #" onchange="save_options();">Part #</label>
                                                </div></label><?php break;
                                            case 'VPL Product Cost': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Product Cost', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Product Cost" onchange="save_options();">Product Cost
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Average Cost', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Average Cost" onchange="save_options();">Average Cost</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('CDN Cost Per Unit', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="CDN Cost Per Unit" onchange="save_options();">CDN Cost Per Unit</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('COGS', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="COGS" onchange="save_options();">COGS GL Code</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Cost', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Cost" onchange="save_options();">Cost</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('USD Cost Per Unit', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="USD Cost Per Unit" onchange="save_options();">USD Cost Per Unit</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('USD Invoice', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="USD Invoice" onchange="save_options();">USD Invoice</label>
                                                </div></label><?php break;
                                            case 'VPL Purchase Info': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Purchase Info', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Purchase Info" onchange="save_options();">Purchase Info
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Date Of Purchase', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Date Of Purchase" onchange="save_options();">Date Of Purchase</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Purchase Cost', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Purchase Cost" onchange="save_options();">Purchase Cost</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Vendor', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Vendor" onchange="save_options();">Vendor</label>
                                                </div></label><?php break;
                                            case 'VPL Shipping Receiving': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Shipping Receiving', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Shipping Receiving" onchange="save_options();">Shipping &amp; Receiving
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Exchange $', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Exchange $" onchange="save_options();">Exchange $</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Exchange Rate', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Exchange Rate" onchange="save_options();">Exchange Rate</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Freight Charge', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Freight Charge" onchange="save_options();">Freight Charge</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Shipping Cash', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Shipping Cash" onchange="save_options();">Shipping Cash</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Shipping Rate', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Shipping Rate" onchange="save_options();">Shipping Rate</label>
                                                </div></label><?php break;
                                            case 'VPL Pricing': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Pricing', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Pricing" onchange="save_options();">Pricing
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Admin Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Admin Price" onchange="save_options();">Admin Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Client Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Client Price" onchange="save_options();">Client Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Commercial Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Commercial Price" onchange="save_options();">Commercial Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Commission Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Commission Price" onchange="save_options();">Commission Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Final Retail Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Final Retail Price" onchange="save_options();">Final Retail Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('MSRP', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="MSRP" onchange="save_options();">MSRP</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Preferred Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Preferred Price" onchange="save_options();">Preferred Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Purchase Order Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Purchase Order Price" onchange="save_options();">Purchase Order Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Rush Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Rush Price" onchange="save_options();">Rush Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Sales Order Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Sales Order Price" onchange="save_options();">Sales Order Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Sell Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Sell Price" onchange="save_options();">Sell Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Suggested Retail Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Suggested Retail Price" onchange="save_options();">Suggested Retail Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Unit Cost', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Unit Cost" onchange="save_options();">Unit Cost</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Unit Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Unit Price" onchange="save_options();">Unit Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Web Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Web Price" onchange="save_options();">Web Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Wholesale Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Wholesale Price" onchange="save_options();">Wholesale Price</label>
                                                </div></label><?php break;
                                            case 'VPL Markup': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Markup', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Markup" onchange="save_options();">Markup
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Markup By $', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Markup By $" onchange="save_options();">Markup By $</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Markup By %', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Markup By %" onchange="save_options();">Markup By %</label>
                                                </div></label><?php break;
                                            case 'VPL Stock': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Stock', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Stock" onchange="save_options();">Stock
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Buying Units', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Buying Units" onchange="save_options();">Buying Units</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Current Stock', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Current Stock" onchange="save_options();">Current Stock</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Variance', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Variance" onchange="save_options();">GL Code</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Quantity', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Quantity" onchange="save_options();">Quantity</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Selling Units', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Selling Units" onchange="save_options();">Selling Units</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Stocking Units', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Stocking Units" onchange="save_options();">Stocking Units</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Write-offs', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Write-offs" onchange="save_options();">Write-offs</label>
                                                </div></label><?php break;
                                            case 'VPL Location': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Location', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Location" onchange="save_options();">Location
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Location', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Location" onchange="save_options();">Location</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('LSD', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="LSD" onchange="save_options();">LSD</label>
                                                </div></label><?php break;
                                            case 'VPL Dimensions': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Dimensions', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Dimensions" onchange="save_options();">Dimensions
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Size', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Size" onchange="save_options();">Size</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Weight', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Weight" onchange="save_options();">Weight</label>
                                                </div></label><?php break;
                                            case 'VPL Alerts': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Alerts', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Alerts" onchange="save_options();">Alerts
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Min Bin', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Min Bin" onchange="save_options();">Min Bin</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Min Max', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Min Max" onchange="save_options();">Min Max</label>
                                                </div></label><?php break;
                                            case 'VPL Time Allocation': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Time Allocation', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Time Allocation" onchange="save_options();">Time Allocation
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Actual Hours', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Actual Hours" onchange="save_options();">Actual Hours</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Estimated Hours', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Estimated Hours" onchange="save_options();">Estimated Hours</label>
                                                </div></label><?php break;
                                            case 'VPL Admin Fees': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Admin Fees', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Admin Fees" onchange="save_options();">Admin Fees
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('GL Assets', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="GL Assets" onchange="save_options();">GL Assets</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('GL Revenue', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="GL Revenue" onchange="save_options();">GL Revenue</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Minimum Billable', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Minimum Billable" onchange="save_options();">Minimum Billable</label>
                                                </div></label><?php break;
                                            case 'VPL Quote': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Quote', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Quote" onchange="save_options();">Quote
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Quote Description', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Quote Description" onchange="save_options();">Quote Description</label>
                                                </div></label><?php break;
                                            case 'VPL Status': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Status', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Status" onchange="save_options();">Status
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Status', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Status" onchange="save_options();">Status</label>
                                                </div></label><?php break;
                                            case 'VPL Display On Website': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Display On Website', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Display On Website" onchange="save_options();">Display On Website
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Display On Website', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Display On Website" onchange="save_options();">Display On Website</label>
                                                </div></label><?php break;
                                            case 'VPL General': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL General', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL General" onchange="save_options();">General
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Comments', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Comments" onchange="save_options();">Comments</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Notes', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Notes" onchange="save_options();">Notes</label>
                                                </div></label><?php break;
                                            case 'VPL Rental': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Rental', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Rental" onchange="save_options();">Rental
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Reminder/Alert', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Reminder/Alert" onchange="save_options();">Reminder/Alert</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Rent Price', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Rent Price" onchange="save_options();">Rent Price</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Rental Days', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Rental Days" onchange="save_options();">Rental Days</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Rental Weeks', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Rental Weeks" onchange="save_options();">Rental Weeks</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Rental Months', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Rental Months" onchange="save_options();">Rental Months</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Rental Years', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Rental Years" onchange="save_options();">Rental Years</label>
                                                </div></label><?php break;
                                            case 'VPL Day/Week/Month/Year': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Day/Week/Month/Year', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Day/Week/Month/Year" onchange="save_options();">Day/Week/Month/Year
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('#Of Hours', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="#Of Hours" onchange="save_options();"># Of Hours</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('#Of Days', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="#Of Days" onchange="save_options();"># Of Days</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Daily', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Daily" onchange="save_options();">Daily</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Weekly', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Weekly" onchange="save_options();">Weekly</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Monthly', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Monthly" onchange="save_options();">Monthly</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Annually', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Annually" onchange="save_options();">Annually</label>
                                                </div></label><?php break;
                                            case 'VPL Vehicle': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Vehicle', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Vehicle" onchange="save_options();">Vehicle
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('#Of Kilometers', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="#Of Kilometers" onchange="save_options();"># Of Kilometers</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('#Of Miles', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="#Of Miles" onchange="save_options();"># Of Miles</label>
                                                </div></label><?php break;
                                            case 'VPL Inclusion': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Inclusion', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Inclusion" onchange="save_options();">Inclusion
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Include in P.O.S.', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Include in P.O.S." onchange="save_options();">Include in Point of Sale.</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Include in Purchase Orders', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Include in Purchase Orders" onchange="save_options();">Include in Purchase Orders</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Include in Sales Orders', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Include in Sales Orders" onchange="save_options();">Include in Sales Orders</label>
                                                </div></label><?php break;
                                            case 'VPL Amount': ?><label class="form-checkbox-any"><input type="checkbox" <?= in_array('VPL Amount', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="VPL Amount" onchange="save_options();">Amount
                                                <div class="block-group">
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Min Amount', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Min Amount" onchange="save_options();">Min Amount</label>
                                                    <label class="form-checkbox no-sort"><input type="checkbox" <?= in_array('Max Amount', $field_config) ? 'checked' : '' ?> name="contact_field[]" value="Max Amount" onchange="save_options();">Max Amount</label>
                                                </div></label><?php break;
                                        }
                                    } ?>
                                </div>
