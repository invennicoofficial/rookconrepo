...
$medical_details_goals_of_care_documents = htmlspecialchars($_FILES["medical_details_goals_of_care_documents"]["name"], ENT_QUOTES);
...
if($get_upload['contactuploadid'] > 0) {
	...
	if($medical_details_goals_of_care_documents == '') {
		$medical_details_goals_of_care_documents = $_POST['medical_details_goals_of_care_documents_hidden'];
	}
	...
	move_uploaded_file($_FILES["medical_details_goals_of_care_documents"]["tmp_name"], "download/". $medical_details_goals_of_care_documents);
	...
	move_uploaded_file($_FILES["medical_details_goals_of_care_documents"]["tmp_name"], "download/".$_FILES["medical_details_goals_of_care_documents"]["name"]);
	...
	$query_insert_doc = "INSERT INTO `contacts_upload` (`contactid`, `application`, `contactimage`, `upload_license_plate`, `upload_property_information`, `upload_inspection`, `upload_letter_of_intent`, `upload_vendor_documents`, `upload_marketing_material`, `upload_purchase_contract`, `upload_support_contract`, `upload_support_terms`, `upload_rental_contract`, `upload_management_contract`, `upload_articles_of_incorporation`, `upload_commercial_insurance`, `upload_residential_insurance`, `upload_wcb`, `upload_drivers_license`, `upload_blank_cheque`, `client_support_documents`, `transportation_support_documents`, `insurance_support_documents`, `guardians_support_documents`, `trustee_support_documents`, `family_doctor_support_documents`, `dentist_support_documents`, `specialists_support_documents`, `diagnosis_support_documents`, `allergies_support_documents`, `equipment_support_documents`, `medical_details_first_aid_cpr`, `medical_details_goals_of_care`, `medical_details_support_documents`,
    `seizure_protocol_upload`, `slip_fall_protocol_upload`, `transfer_protocol_upload`, `toileting_protocol_upload`, `bathing_protocol_upload`, `gtube_protocol_upload`, `oxygen_protocol_upload`, `funding_support_documents`) VALUES ('$contactid', '$application', '$contactimage', '$upload_license_plate', '$upload_property_information', '$upload_inspection', '$upload_letter_of_intent', '$upload_vendor_documents', '$upload_marketing_material', '$upload_purchase_contract', '$upload_support_contract', '$upload_support_terms', '$upload_rental_contract', '$upload_management_contract', '$upload_articles_of_incorporation', '$upload_commercial_insurance', '$upload_residential_insurance', '$upload_wcb', '$upload_drivers_license', '$upload_blank_cheque', '$client_support_documents', '$transportation_support_documents', '$insurance_support_documents', '$guardians_support_documents', '$trustee_support_documents', '$family_doctor_support_documents', '$dentist_support_documents', '$specialists_support_documents', '$diagnosis_support_documents', '$allergies_support_documents', '$equipment_support_documents', '$medical_details_first_aid_cpr_documents', '$medical_details_goals_of_care_documents', '$medical_details_support_documents', '$seizure_protocol_upload', '$slip_fall_protocol_upload', '$transfer_protocol_upload', '$toileting_protocol_upload', '$bathing_protocol_upload', '$gtube_protocol_upload', '$oxygen_protocol_upload', '$funding_support_documents')";
