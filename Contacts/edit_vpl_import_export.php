<?php
/*
 * Vendor Price List Import/Export
 * Included in:
    ...
    <div class="container"><?php
        ...
        if(isset($_GET['type'])) {
            ...
            if($type_get == 'add' || $type_get == '') {
                ...
                $active_add = '';
                $title = 'Export Vendor Price List';
        ...
        <h3 class="inline pad-left"><?= $title; ?></h3>
            ...
            <div class="row add">
                <form name="import" method="post" enctype="multipart/form-data">
                    <div class="notice">Steps to Upload Multiple Items into the Vendor Price List (VPL) tile:<br /><br />
                        ...
                        <span><img src='../img/warning.png' style='width:25px;'> NOTE</span>: Do not change/move/delete any of the column titles in the first row.<br /><span><b>Hint</b>:</span> press CTRL+F on your keyboard to find the fields you would like to populate; this will help you locate them faster. <br /><br />
                    ...
                    <div class="form-group pull-right gap-right">
                        <a href="" class="btn brand-btn">Cnacel</a>
                        <input class="btn brand-btn pull-right" type="submit" name="submitty" value="Submit" />
                        <div class="clearfix"></div>
                    </div>
                </form>
            </div>
        ...
        <?php } else if ($type_get == 'edit') { ?>
            <div class="row edit">
                <form name="import" method="post" enctype="multipart/form-data">
                    ...
                    <span><b>Hint:</b></span> if you would like to edit items from a specific category, export the Excel (CSV) file from this page: <a href='add_inventory_multiple.php?type=export' target="_BLANK" style='color:white; text-decoration:underline;'>Export Specific VPL items</a>.<br /><br />
                    <b>2.</b> Make your desired changes inside of the Excel file.<br />
                    <span><img src='../img/warning.png' style='width:25px;'> NOTE</span>: Do not change/move/delete any of the column titles in the first row. Also, do not change the data in the first column (<em>inventoryid</em>), or else the edits may not go through properly. <br /><span><b>Hint:</b></span> press CTRL+F on your keyboard to find the fields you would like to populate; this will help you locate them faster.<br /><br />
            ...
            <div class="row export">
                <form name="import" method="post" enctype="multipart/form-data">
                    <div class="notice">
                        ...
                        <div class="col-sm-4"><button class="btn brand-btn" type="submit" name="exporter" value="Export" />Export VPL</button></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="form-group pull-right gap-right">
                        <a href="" class="btn brand-btn">Cancel</a>
        ...
        <?php } else if ($type_get == 'log') {
            ...
            if($num_rows > 0) {
                echo "<div class='gap-top gap-left gap-bottom'>Currently displaying the last $num_rows rows (out of a total of $num_rowst rows).</div>";
            ...
            <div class="form-group pull-right gap-right"><a href="" class="btn brand-btn">Cancel</a></div>
        <?php } ?>
    </div><!-- .container -->
