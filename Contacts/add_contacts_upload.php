<?php if (strpos($value_config, ','."Application".',') !== FALSE && (strpos($edit_config,',Application,') !== FALSE || $_SESSION['contactid'] == $contactid)) { ?>
  ...
  <?php if (strpos($value_config, ','."Contact Image".',') !== FALSE) { ?>
    ...
    <label for="file" class="col-sm-4 control-label">
        <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Upload an image that will be displayed on the user's profile."><img src="../img/info.png" width="20"></a></span>
        Contact Image:
    </label>
    <div class="col-sm-8">
    <?php if((!empty($_GET['contactid'])) && ($contactimage != '') ) {
    if(FOLDER_NAME == 'staff') {
        if(file_exists('../Staff/download/'.$contactimage)) {
          $contact_url = '../Staff/';
        } else {
          $contact_url = '../Profile/';
        }
    ...
    echo '<a href="'.$contact_url.'download/'.$contactimage.'" target="_blank">View</a>';
  ...
  <?php if (strpos($value_config, ','."Upload License Plate".',') !== FALSE && (strpos($edit_config,',Upload License Plate,') !== FALSE || $_SESSION['contactid'] == $contactid)) { ?>
    <div class="form-group">
  ...
  <?php if (strpos($value_config, ','."Upload WCB".',') !== FALSE && (strpos($edit_config,',Upload WCB,') !== FALSE || $_SESSION['contactid'] == $contactid)) { ?>
    <div class="form-group">
  ...
  <?php if (strpos($value_config, ','."Transportation Support Documents".',') !== FALSE && (strpos($edit_config,',Transportation Support Documents,') !== FALSE || $_SESSION['contactid'] == $contactid)) { ?>
    <div class="form-group">
  ...
  <?php if (strpos($value_config, ','."Transportation Upload License".',') !== FALSE && (strpos($edit_config,',Transportation Upload License,') !== FALSE || $_SESSION['contactid'] == $contactid)) { ?>
    <div class="form-group">
    <label for="file" class="col-sm-4 control-label">
        <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Upload an image of your drivers licence."><img src="../img/info.png" width="20"></a></span>
  ...
  <?php if (strpos($value_config, ','."Void Cheque".',') !== FALSE) { ?>
    <div class="form-group">
    <label for="file" class="col-sm-4 control-label">
        <span class="popover-examples"><a data-toggle="tooltip" data-placement="top" title="Upload an image of a void cheque."><img src="../img/info.png" width="20"></a></span>
        Upload Void Cheque:
    </label>
    <div class="col-sm-8">
    <?php if((!empty($_GET['contactid'])) && ($upload_blank_cheque != '') && (strpos($edit_config,',Void Cheque,') !== FALSE || $_SESSION['contactid'] == $contactid)) {
    echo '<a href="download/'.$upload_blank_cheque.'" target="_blank">View</a>';
	if(strpos($edit_config, ','."Void Cheque".',') !== false) {
		echo ' - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
		<input type="hidden" name="upload_blank_cheque_hidden" value="<?php echo $upload_blank_cheque; ?>" />
  ...
  <?php if (strpos($value_config, ','."Medical Details Goals of Care".',') !== FALSE) { ?>
    <div class="form-group">
    <label for="file" class="col-sm-4 control-label">Support Documents:
    <span class="popover-examples list-inline">&nbsp;
    <a  data-toggle="tooltip" data-placement="top" title="File name cannot contain commas or apostrophes"><img src="<?php echo WEBSITE_URL; ?>/img/info.png" width="20"></a>
    ...
    <div class="col-sm-8">
    <?php if((!empty($_GET['contactid'])) && ($medical_details_goals_of_care_documents != '') ) {
    echo '<a href="download/'.$medical_details_goals_of_care_documents.'" target="_blank">View</a>';
  if(strpos($edit_config, ','."Medical Details Goals of Care".',') !== false) {
    echo ' - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
    <input type="hidden" name="medical_details_goals_of_care_documents_hidden" value="<?php echo $medical_details_goals_of_care_documents; ?>" />
    <input <?php echo (strpos($edit_config, ','."Medical Details Goals of Care".',') === false ? 'readonly' : ''); ?> name="medical_details_goals_of_care_documents" type="file" data-filename-placement="inside" class="form-control" />
    <?php }
  } else if(strpos($edit_config, ','."Medical Details Goals of Care".',') !== false) { ?>
    <input <?php echo (strpos($edit_config, ','."Medical Details Goals of Care".',') === false ? 'readonly' : ''); ?> name="medical_details_goals_of_care_documents" type="file" data-filename-placement="inside" class="form-control" />
          <?php } ?>
      </div>
 </div>
...
<?php if (strpos($value_config, ','.$title.',') !== FALSE && (strpos($edit_config,','.$title.',') !== FALSE || $_SESSION['contactid'] == $contactid)) { ?>
    <div class="form-group">
    <label for="file" class="col-sm-4 control-label">Support Documents:
    <span class="popover-examples list-inline">&nbsp;
    <a  data-toggle="tooltip" data-placement="top" title="File name cannot contain commas or apostrophes"><img src="<?php echo WEBSITE_URL; ?>/img/info.png" width="20"></a>
