<div class="panel panel-default">
	...
	<div id="collapse_1" class="panel-collapse collapse">
		<div class="panel-body">
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Employee ID".',') !== FALSE) { echo " checked"; } ?> value="Employee ID" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Employee ID
			...
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Contact Prefix".',') !== FALSE) { echo " checked"; } ?> value="Contact Prefix" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Prefix
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Contact Filters".',') !== FALSE) { echo " checked"; } ?> value="Contact Filters" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Filters
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Preferred Pronoun".',') !== FALSE) { echo " checked"; } ?> value="Preferred Pronoun" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Preferred Pronoun
			...
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Staff Category".',') !== FALSE) { echo " checked"; } ?> value="Staff Category" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Staff Category
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Date of Birth".',') !== FALSE) { echo " checked"; } ?> value="Date of Birth" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Date of Birth
            <input type="checkbox" <?php if (strpos($contacts_config, ','."School".',') !== FALSE) { echo " checked"; } ?> value="School" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;School
            <input type="checkbox" <?php if (strpos($contacts_config, ','."FSCD Number".',') !== FALSE) { echo " checked"; } ?> value="FSCD Number" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;FSCD Number
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Hear About".',') !== FALSE) { echo " checked"; } ?> value="Hear About" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;How did you hear about us?
...
<div class="panel panel-default">
	...
	<div id="collapse_sm" class="panel-collapse collapse">
		<div class="panel-body">
			...
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Instagram".',') !== FALSE) { echo " checked"; } ?> value="Instagram" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Instagram
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Pinterest".',') !== FALSE) { echo " checked"; } ?> value="Pinterest" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Pinterest
...
<div class="panel panel-default">
	...
	<div id="collapse_emergency" class="panel-collapse collapse">
		<div class="panel-body">
			...
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Emergency Contact First Name".',') !== FALSE) { echo " checked"; } ?> value="Emergency Contact First Name" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Emergency Contact First Name
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Emergency Contact Last Name".',') !== FALSE) { echo " checked"; } ?> value="Emergency Contact Last Name" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Emergency Contact Last Name
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Emergency Contact Contact Number".',') !== FALSE) { echo " checked"; } ?> value="Emergency Contact Contact Number" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Emergency Contact Contact Number
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Emergency Contact Relationship".',') !== FALSE) { echo " checked"; } ?> value="Emergency Contact Relationship" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Emergency Contact Relationship
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Emergency Contact Multiple".',') !== FALSE) { echo " checked"; } ?> value="Emergency Contact Multiple" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Multiple Emergency Contacts
	...
	<div id="collapse_22" class="panel-collapse collapse">
		<div class="panel-body">
		   <input type="checkbox" <?php if (strpos($contacts_config, ','."Guardians Family Guardian".',') !== FALSE) { echo " checked"; } ?> value="Guardians Family Guardian" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Family Guardian
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Guardians Office of the Public Guardian".',') !== FALSE) { echo " checked"; } ?> value="Guardians Office of the Public Guardian" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Office of the Public Guardian (OPG)
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Guardians Personal Directive".',') !== FALSE) { echo " checked"; } ?> value="Guardians Personal Directive" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Personal Directive
			...
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Guardians Relationship".',') !== FALSE) { echo " checked"; } ?> value="Guardians Relationship" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Relationship
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Guardians Multiple".',') !== FALSE) { echo " checked"; } ?> value="Guardians Multiple" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Multiple Guardians
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Guardians Siblings".',') !== FALSE) { echo " checked"; } ?> value="Guardians Siblings" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Siblings
	...
	<div id="collapse_23" class="panel-collapse collapse">
		<div class="panel-body">
		   <input type="checkbox" <?php if (strpos($contacts_config, ','."Trustee Family Trustee".',') !== FALSE) { echo " checked"; } ?> value="Trustee Family Trustee" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Family Trustee
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Trustee Office of the Public Guardian".',') !== FALSE) { echo " checked"; } ?> value="Trustee Office of the Public Guardian" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Office of the Public Guardian (OPG)
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Trustee Personal Directive".',') !== FALSE) { echo " checked"; } ?> value="Trustee Personal Directive" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Personal Directive
...
<div class="panel panel-default">
	...
	<div id="collapse_24" class="panel-collapse collapse">
		<div class="panel-body">
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Family Doctor Multiple".',') !== FALSE) { echo " checked"; } ?> value="Family Doctor Multiple" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Multiple Family Doctors
...
<div class="panel panel-default">
	...
	<div id="collapse_26" class="panel-collapse collapse">
		<div class="panel-body">
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Specialists Multiple".',') !== FALSE) { echo " checked"; } ?> value="Specialists Multiple" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Multiple Specialists
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose the First Aid/CPR."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
            <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_goalsofcare" >
               Goals of Care<span class="glyphicon glyphicon-plus"></span>
            </a>
        </h4>
    </div>

    <div id="collapse_goalsofcare" class="panel-collapse collapse">
        <div class="panel-body">
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Medical Details Goals of Care".',') !== FALSE) { echo " checked"; } ?> value="Medical Details Goals of Care" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Goals of Care
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Goals of Care Support Documents".',') !== FALSE) { echo " checked"; } ?> value="Goals of Care Support Documents" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Support Documents
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose the First Aid/CPR."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
            <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_seizure" >
               Seizure<span class="glyphicon glyphicon-plus"></span>
            </a>
        </h4>
    </div>

    <div id="collapse_seizure" class="panel-collapse collapse">
        <div class="panel-body">
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Medical Details Seizure".',') !== FALSE) { echo " checked"; } ?> value="Medical Details Seizure" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Seizure
...
<div class="panel panel-default">
	...
	<div id="collapse_32" class="panel-collapse collapse">
		<div class="panel-body">
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Medical Details Medications".',') !== FALSE) { echo " checked"; } ?> value="Medical Details Medications" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Medical Details Medications
...
<div class="panel panel-default">
	...
	<div id="collapse_social" class="panel-collapse collapse">
		<div class="panel-body">
			...
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Client Support Model Social Story".',') !== FALSE) { echo " checked"; } ?> value="Client Support Model Social Story" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Support Model
...
<div class="panel panel-default">
	...
	<div id="collapse_prof_docs" class="panel-collapse collapse">
		<div class="panel-body">
			...
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Profile Documents".',') !== FALSE) { echo " checked"; } ?> value="Profile Documents" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Profile Documents

			<br><br>
			<div class="form-group">
				<div class="col-sm-6 clearfix">
					<a href="contacts.php?category=Patient&filter=Top" class="btn config-btn btn-lg">Back</a>
					<!--<a href="#" class="btn config-btn pull-right" onclick="history.go(-1);return false;">Back</a>-->
				</div>
				<div class="col-sm-6">
					<button	type="submit" name="inv_field" value="inv_field" class="btn config-btn btn-lg pull-right">Submit</button>
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose Membership."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
			<a data-toggle="collapse" data-parent="#accordion2" href="#collapse_membership" >
			   Membership<span class="glyphicon glyphicon-plus"></span>
			</a>
		</h4>
	</div>

	<div id="collapse_membership" class="panel-collapse collapse">
		<div class="panel-body">

			<input type="checkbox" <?php if (strpos($contacts_config, ','."Membership Status".',') !== FALSE) { echo " checked"; } ?> value="Membership Status" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Membership Status
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Membership Level".',') !== FALSE) { echo " checked"; } ?> value="Membership Level" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Membership Level
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Membership Since".',') !== FALSE) { echo " checked"; } ?> value="Membership Since" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Membership Since
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Membership Renewal Date".',') !== FALSE) { echo " checked"; } ?> value="Membership Renewal Date" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Membership Renewal Date
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose Membership."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
			<a data-toggle="collapse" data-parent="#accordion2" href="#collapse_programs" >
			   Programs<span class="glyphicon glyphicon-plus"></span>
			</a>
		</h4>
	</div>

	<div id="collapse_programs" class="panel-collapse collapse">
		<div class="panel-body">

			<input type="checkbox" <?php if (strpos($contacts_config, ','."Programs Female Only Programs".',') !== FALSE) { echo " checked"; } ?> value="Programs Female Only Programs" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Female Only Programs
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Programs Male Only Programs".',') !== FALSE) { echo " checked"; } ?> value="Programs Male Only Programs" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Male Only Programs
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Programs LAAFS Program".',') !== FALSE) { echo " checked"; } ?> value="Programs LAAFS Program" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;LAAFS Program
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Programs AAFS Program".',') !== FALSE) { echo " checked"; } ?> value="Programs AAFS Program" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;AAFS Program
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Programs Over 16 Program".',') !== FALSE) { echo " checked"; } ?> value="Programs Over 16 Program" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Over 16 Program
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Programs Over 18 Program".',') !== FALSE) { echo " checked"; } ?> value="Programs Over 18 Program" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Adults/Over 18 Program
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Programs LAAFS".',') !== FALSE) { echo " checked"; } ?> value="Programs LAAFS" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;LAAFS
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Programs AAFS Youth".',') !== FALSE) { echo " checked"; } ?> value="Programs AAFS Youth" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;AAFS Youth
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Programs Fellowship 16".',') !== FALSE) { echo " checked"; } ?> value="Programs Fellowship 16" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Fellowship 16
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Programs Fellowship 18".',') !== FALSE) { echo " checked"; } ?> value="Programs Fellowship 18" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Fellowship 18
...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title">
			<span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose Membership."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
			<a data-toggle="collapse" data-parent="#accordion2" href="#collapse_funding" >
			   Funding<span class="glyphicon glyphicon-plus"></span>
			</a>
		</h4>
	</div>

	<div id="collapse_funding" class="panel-collapse collapse">
		<div class="panel-body">

			<input type="checkbox" <?php if (strpos($contacts_config, ','."Funding FSCD".',') !== FALSE) { echo " checked"; } ?> value="Funding FSCD" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Family Support for Children with Disabilities (FSCD)
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Funding FSCD Worker Name".',') !== FALSE) { echo " checked"; } ?> value="Funding FSCD Worker Name" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;FSCD Worker Name
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Funding FSCD File ID".',') !== FALSE) { echo " checked"; } ?> value="Funding FSCD File ID" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;FSCD File ID
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Funding FSCD Renewal Date".',') !== FALSE) { echo " checked"; } ?> value="Funding FSCD Renewal Date" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;FSCD Renewal Date
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Funding PDD".',') !== FALSE) { echo " checked"; } ?> value="Funding PDD" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Persons with Development Disabilties (PDD)
			<input type="checkbox" <?php if (strpos($contacts_config, ','."Funding Support Documents".',') !== FALSE) { echo " checked"; } ?> value="Funding Support Documents" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Support Documents
...
<div class="panel panel-default">
    ...
    <div id="collapse_checklist" class="panel-collapse collapse">
        <div class="panel-body">
            ...
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Checklist".',') !== FALSE) { echo " checked"; } ?> value="Checklist" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Checklist
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose Membership."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
            <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_incidentreports" >
               Incident Reports<span class="glyphicon glyphicon-plus"></span>
            </a>
        </h4>
    </div>

    <div id="collapse_incidentreports" class="panel-collapse collapse">
        <div class="panel-body">

            <input type="checkbox" <?php if (strpos($contacts_config, ','."Incident Reports".',') !== FALSE) { echo " checked"; } ?> value="Incident Reports" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Incident Reports
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose Membership."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
            <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_strategies" >
               Strategies<span class="glyphicon glyphicon-plus"></span>
            </a>    
        </h4>
    </div>

    <div id="collapse_strategies" class="panel-collapse collapse">
        <div class="panel-body">

            <input type="checkbox" <?php if (strpos($contacts_config, ','."Strategies Levels of Communication".',') !== FALSE) { echo " checked"; } ?> value="Strategies Levels of Communication" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Levels of Communication
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Strategies Types of Supports".',') !== FALSE) { echo " checked"; } ?> value="Strategies Types of Supports" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Types of Supports
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Strategies Likes".',') !== FALSE) { echo " checked"; } ?> value="Strategies Likes" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Likes
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Strategies Dislikes".',') !== FALSE) { echo " checked"; } ?> value="Strategies Dislikes" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Dislikes
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose HR Record."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
            <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_hr_record" >
               HR Record<span class="glyphicon glyphicon-plus"></span>
            </a>    
        </h4>
    </div>

    <div id="collapse_hr_record" class="panel-collapse collapse">
        <div class="panel-body">

            <input type="checkbox" <?php if (strpos($contacts_config, ','."Forms".',') !== FALSE) { echo " checked"; } ?> value="Forms" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Forms
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Manuals".',') !== FALSE) { echo " checked"; } ?> value="Manuals" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Manuals
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h4 class="panel-title">
            <span class="popover-examples list-inline"><a data-toggle="tooltip" data-placement="top" title="Click here to choose HR Record."><img src=" <?= WEBSITE_URL; ?>/img/info.png" width="20"></a></span>
            <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_treatmentcharts" >
               Treatment Charts<span class="glyphicon glyphicon-plus"></span>
            </a>    
        </h4>
    </div>

    <div id="collapse_treatmentcharts" class="panel-collapse collapse">
        <div class="panel-body">

            <input type="checkbox" <?php if (strpos($contacts_config, ','."Treatment Charts".',') !== FALSE) { echo " checked"; } ?> value="Treatment Charts" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Treatment Charts
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Treatment Charts Injury".',') !== FALSE) { echo " checked"; } ?> value="Treatment Charts Injury" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Injury
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Treatment Charts Staff".',') !== FALSE) { echo " checked"; } ?> value="Treatment Charts Staff" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Filled by Staff
            <input type="checkbox" <?php if (strpos($contacts_config, ','."Treatment Charts Date".',') !== FALSE) { echo " checked"; } ?> value="Treatment Charts Date" style="height: 20px; width: 20px;" name="contacts[]">&nbsp;&nbsp;Date
