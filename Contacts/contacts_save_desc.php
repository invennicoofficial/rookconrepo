...
$medical_details_goals_of_care = filter_var(htmlentities($_POST['medical_details_goals_of_care']),FILTER_SANITIZE_STRING);
...
$day_program_name = filter_var(htmlentities($_POST['day_program_name']),FILTER_SANITIZE_STRING);
$day_program_address = filter_var(htmlentities($_POST['day_program_address']),FILTER_SANITIZE_STRING);
$day_program_phone = filter_var(htmlentities($_POST['day_program_phone']),FILTER_SANITIZE_STRING);
$day_program_key_worker = filter_var(htmlentities($_POST['day_program_key_worker']),FILTER_SANITIZE_STRING);
