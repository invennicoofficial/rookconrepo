			...
			<tr>
				...
				<?php if ($type != 'templates') { ?>
					<td data-title="Assigned Tiles">
						<?php $tile_list = ['contracts' => 'Contracts', 'hr' => 'HR', 'infogathering' => 'Information Gathering', 'safety'=> 'Safety', 'treatment' => 'Treatment Charts', 'intake' => 'Intake Forms', 'performance_review' => 'Performance Reviews', 'project' => 'Projects'];
