	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			while($row = mysqli_fetch_array($receivables)) {
				...
				echo "<tr>\n<td style='padding-left: 1em;' data-title='Receivable Item'>".$row['heading']."</td>\n";
				for($month = 0; $month < 12; $month++) {
					$dateObj = DateTime::createFromFormat('!m', $month+1);
			...
			<tr style="font-size: 1.5em; font-weight: bold;">
				<td colspan="10" style="border-right: none;">Total Receivables for <?php echo $year == $startyear ? $search_start : $year.'-01-01'; ?> to <?php echo $year == $endyear ? $search_end : $year.'-12-31'; ?></td>
