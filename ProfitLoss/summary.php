...
$staff_sql = mysqli_query($dbc, "SELECT `contactid`, `category`, `name`, `last_name`, `first_name` FROM `contacts` WHERE `category` IN (".STAFF_CATS.") AND ".STAFF_CATS_HIDE_QUERY." AND `status` > 0 AND `deleted`=0");
...
<table class="table table-bordered">
	...
	<tbody>
		<tr>
			<td data-title="">Total Revenue:</td>
			<td data-title="Total Revenue" style="text-align: right;">$<?php echo number_format($total_revenue, 2, '.', ','); ?></td>
		</tr>
		<tr>
			<td data-title="">Total Receivables:</td>
			<td data-title="Total Receivables" style="text-align: right;">$<?php echo number_format($total_receivable, 2, '.', ','); ?></td>
		</tr>
		<tr>
			<td data-title="">Total Compensation:</td>
			<td data-title="Total Compensation" style="text-align: right;">$<?php echo number_format($total_compensation, 2, '.', ','); ?></td>
		</tr>
		<tr>
			<td data-title="">Total Expenses:</td>
			<td data-title="Total Expenses" style="text-align: right;">$<?php echo number_format($total_expense, 2, '.', ','); ?></td>
		</tr>
		<tr>
			<td data-title="">Total Costs:</td>
			<td data-title="Total Costs" style="text-align: right;">$<?php echo number_format($total_costs, 2, '.', ','); ?></td>
		</tr>
		<tr style="font-size: 1.5em; font-weight: bold;">
			<td>Summary Profit / Loss for <?php echo $starttime_summary.' to '.$endtime_summary; ?></td>
			<td data-title="Summary Profit / Loss" style="text-align: right;">$<?php echo number_format($total, 2, '.', ','); ?></td>
		</tr>
	</tbody>
</table>