    ...
    <div class="col-sm-12">
        ...
        <div class="additional_cl clearfix">
            ...
            <div class="form-group clearfix" id="clients_0">
                ...
                <div class="col-sm-2">
                    <select data-placeholder="Choose a Client..." id="clclientperson_0" name="clientperson[]" class="chosen-select-deselect form-control equipmentid" width="380">
                        <option value=''></option>
						<?php
...
<?php
if(!empty($_GET['estimateid'])) {
    $query_rc = mysqli_query($dbc,"SELECT * FROM company_rate_card WHERE (rate_card_name='$company_rate_card_name' AND IFNULL(`rate_categories`,'')='$company_rate_categories') AND tile_name='Clients'");
