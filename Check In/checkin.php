...
<div class="container">
	<div class="row">
        ...
        <?php
            echo '<a href="config_checkin.php?id='.$_GET['contactid'].'" class="mobile-block pull-right"><img title="Check In Tile Setting" src="../img/icons/settings-4.png" class="settings-classic wiggle-me" width="50px"></a>';
        ?>
        </h1>
