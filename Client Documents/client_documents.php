	            ...
	            <div class="tile-container">
	            	...
	            	<div class="fill-to-gap tile-content set-section-height" style="padding: 0;">
	            		<div class="main-screen-details">
							...
							if($search_vendor != '') {
								$query_search .= " AND (client_documents_code LIKE '%" . $search_vendor . "%' OR client_documents_type LIKE '%" . $search_vendor . "%' OR category LIKE '%" . $search_vendor . "%' OR heading LIKE '%" . $search_vendor . "%' OR name LIKE '%" . $search_vendor . "%' OR title LIKE '%" . $search_vendor . "%' OR fee LIKE '%" . $search_vendor . "%')";
							}
							...
							while($row = mysqli_fetch_array( $result ))
							{
								...
								echo '<a href=\'add_client_documents.php?client_documentsid='.$client_documentsid.'\'>Edit</a> | ';
