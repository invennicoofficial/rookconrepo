...
if(!empty($settings)) {
	...
	$pdf_logo_width = empty($settings['pdf_logo_width']) ? '' : $settings['pdf_logo_width'];
	$footer_logo = empty($settings['footer_logo']) ? '' : $settings['footer_logo'];
	$footer_logo_width = empty($settings['footer_logo_width']) ? '' : $settings['footer_logo_width'];
...
$cover_page = '<table style="height:90%; width:100%;">
	<tr>
		...
		'.($page_numbers == 'top_cover' ? '<td style="text-align: right; width: 10px;">1</td>' : '').'
	</tr>
	<tr>
...
$header_html = '<table style="height:10%;width:100%;">
	<tr>
		...
		'.($page_numbers == 'top_cover' || $page_numbers == 'top_main' ? '<td style="text-align: right; width: 10px;">[PAGE #]</td>' : '').'
	</tr>
</table>';
$html = '<div style="height:80%;"><table cellspacing="'.$left_margin.'px" style="border:5px solid '.$pdf_color.';" width="100%">
	<tr>
		<td style="padding:'.$top_margin.'px '.$right_margin.'px '.$bottom_margin.'px '.$left_margin.'px;color:'.$heading_color.';font-size:'.$font_size.'px;'.($font_type == 'bold' || $font_type == 'bold_italic' ? 'font-weight:900;' : '').($font_type == 'italic' || $font_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font.';width:20%;vertical-align:top;">Customer:</td>
		<td rowspan="2" style="padding:'.$top_margin.'px '.$right_margin.'px '.$bottom_margin.'px '.$left_margin.'px;color:'.$pdf_body_color.';font-size:'.$font_body_size.'px;'.($font_body_type == 'bold' || $font_body_type == 'bold_italic' ? 'font-weight:900;' : '').($font_body_type == 'italic' || $font_body_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font_body.';width:30%;vertical-align:top;">
		...
		<td style="padding:'.$top_margin.'px '.$right_margin.'px '.$bottom_margin.'px '.$left_margin.'px;color:'.$heading_color.';font-size:'.$font_size.'px;'.($font_type == 'bold' || $font_type == 'bold_italic' ? 'font-weight:900;' : '').($font_type == 'italic' || $font_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font.';width:20%;vertical-align:top;">Sales Person:</td>
...
$html .= '</td>
	...
	<tr>
		<td style="padding:'.$top_margin.'px '.$right_margin.'px '.$bottom_margin.'px '.$left_margin.'px;color:'.$heading_color.';font-size:'.$font_size.'px;'.($font_type == 'bold' || $font_type == 'bold_italic' ? 'font-weight:900;' : '').($font_type == 'italic' || $font_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font.';vertical-align:top;">Date:</td>
		<td style="padding:'.$top_margin.'px '.$right_margin.'px '.$bottom_margin.'px '.$left_margin.'px;color:'.$pdf_body_color.';font-size:'.$font_body_size.'px;'.($font_body_type == 'bold' || $font_body_type == 'bold_italic' ? 'font-weight:900;' : '').($font_body_type == 'italic' || $font_body_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font_body.';vertical-align:top;">'.$estimate['created_date'].'</td>
		<td style="padding:'.$top_margin.'px '.$right_margin.'px '.$bottom_margin.'px '.$left_margin.'px;color:'.$heading_color.';font-size:'.$font_size.'px;'.($font_type == 'bold' || $font_type == 'bold_italic' ? 'font-weight:900;' : '').($font_type == 'italic' || $font_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font.';vertical-align:top;">'.PROJECT_NOUN.'/AFE#:</td>
	...
	<tr>
		<td style="padding:'.$top_margin.'px '.$right_margin.'px '.$bottom_margin.'px '.$left_margin.'px;color:'.$heading_color.';font-size:'.$font_size.'px;'.($font_type == 'bold' || $font_type == 'bold_italic' ? 'font-weight:900;' : '').($font_type == 'italic' || $font_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font.';vertical-align:top;">Expiration Date:</td>
		<td style="padding:'.$top_margin.'px '.$right_margin.'px '.$bottom_margin.'px '.$left_margin.'px;color:'.$pdf_body_color.';font-size:'.$font_body_size.'px;'.($font_body_type == 'bold' || $font_body_type == 'bold_italic' ? 'font-weight:900;' : '').($font_body_type == 'italic' || $font_body_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font_body.';vertical-align:top;">'.$estimate['expiry_date'].'</td>
...
<table cellpadding="'.$left_margin.'px" style="border:5px solid '.$pdf_color.';width:100%;text-align:center;">
	<tr style="color:'.$pdf_sub_text_color.';background-color:'.$pdf_color.';font-size:'.$font_size.'px;'.($font_type == 'bold' || $font_type == 'bold_italic' ? 'font-weight:900;' : '').($font_type == 'italic' || $font_type == 'bold_italic' ? 'font-style:italic;' : '').'font-family:'.$font.';">';
		foreach($heading_order as $order_info) {
			$order_info = explode('***',$order_info);
			// Count each column in use, and count description as three times wider
			switch($order_info[0]) {
...
$footer_html = '<table style="height:10%;border-collapse: separate; border-spacing:'.$top_margin.'px '.$left_margin.'px;width:100%;">
	<tr>
		...
		'.($page_numbers == 'bottom_cover' || $page_numbers == 'bottom_main' ? '<td style="text-align: right; width: 10px;">[PAGE #]</td>' : '').'
	</tr>
</table>';
