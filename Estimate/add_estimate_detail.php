...
if(!empty($_GET['estimateid'])) {
    ...
    $get_detail = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM estimate_detail WHERE estimateid='$estimateid'"));
...
<div class="form-group">
    <label for="fax_number"	class="col-sm-4	control-label">Note to be Displayed on Quote PDF:</label>
    <div class="col-sm-8">
