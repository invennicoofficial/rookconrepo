...
if (isset($_POST['submit'])) {
    ...
    $purchase_order_logo = $_FILES["purchase_order_logo"]["name"];
            ...
            <div class="panel-body" id="no-more-tables">
                ...
                <table border='2' cellpadding='10' class='table'>
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" <?php if (strpos($value_config, ','."Project".',') !== FALSE) { echo " checked"; } ?> value="Project" style="height: 20px; width: 20px;" name="purchase_order[]">&nbsp;&nbsp;Project
                        </td>
                        <td>
                            <input type="checkbox" <?php if (strpos($value_config, ','."Ticket".',') !== FALSE) { echo " checked"; } ?> value="Ticket" style="height: 20px; width: 20px;" name="purchase_order[]">&nbsp;&nbsp;Ticket
                        </td>
                        <td>
