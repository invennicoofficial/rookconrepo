...
<div class="container">
	...
	<div class="gap-left tab-container mobile-100-container">
		<?php if ( check_subtab_persmission($dbc, 'email_communication', ROLE, 'internal') === TRUE ) { ?>
			<a href="email_communication.php?type=Internal"><button type="button" class="btn mobile-100 brand-btn mobile-block">Internal</button></a>&nbsp;&nbsp;
		<?php } else { ?>
		...
		<?php if ( check_subtab_persmission($dbc, 'email_communication', ROLE, 'external') === TRUE ) { ?>
			<a href="email_communication.php?type=External"><button type="button" class="btn mobile-100 brand-btn mobile-block">External</button></a>&nbsp;&nbsp;
		<?php } else { ?>
		...
		<?php if ( check_subtab_persmission($dbc, 'email_communication', ROLE, 'log') === TRUE ) { ?>
			<a href="log_email_communication.php"><button type="button" class="btn brand-btn mobile-100 mobile-block active_tab">Log</button></a>&nbsp;&nbsp;
		<?php } else { ?>
