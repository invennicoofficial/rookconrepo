...
<?php elseif($request_tab == 'closed'): ?>
	...
	$support_list = mysqli_query($dbc_support, "SELECT * FROM `support` WHERE `businessid`='$user' AND `support_type`='Critical Incident' AND `deleted`=1 AND `archived_date` > '$date'");
