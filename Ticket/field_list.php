...
$accordion_list = [
	...
	'Delivery' => ['Assigned Equipment','Delivery Stops','Delivery Stops Order','Delivery Stops Volume','Delivery Pickup Equipment Category','Delivery Pickup Equipment Make','Delivery Pickup Equipment Model','Delivery Pickup Equipment','Delivery Pickup','Delivery Pickup Address','Delivery Pickup Coordinates','Delivery Pickup Client','Delivery Pickup Customer','Delivery Pickup Phone','Delivery Pickup Type','Delivery Pickup Volume','Delivery Pickup Cube','Delivery Pickup ETA','Delivery Pickup Customer Est Time','Delivery Pickup Date','Delivery Pickup Order','Delivery Pickup Timeframe','Delivery Pickup Arrival','Delivery Pickup Departure','Delivery Pickup Description','Delivery Pickup Service List','Delivery Pickup Default Services','Delivery Pickup Warehouse Only','Delivery Pickup Populate Warehouse Address','Delivery Pickup Status','Delivery Pickup Populate Google Link','Delivery Pickup Notes','Delivery Pickup Dropoff Map','Delivery Calendar History'],
