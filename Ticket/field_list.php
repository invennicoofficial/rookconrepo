...
$accordion_list = [
	...
	'Materials' => ['Material Category','Material Type','Material Manual','Material Quantity','Material Volume','Material Rate','Auto Check In Materials','Auto Check Out Materials'],
	...
	'Delivery' => ['Assigned Equipment','Delivery Stops','Delivery Stops Order','Delivery Stops Volume','Delivery Pickup Equipment Category','Delivery Pickup Equipment Make','Delivery Pickup Equipment Model','Delivery Pickup Equipment','Delivery Pickup','Delivery Pickup Address','Delivery Pickup Coordinates','Delivery Pickup Client','Delivery Pickup Customer','Delivery Pickup Phone','Delivery Pickup Type','Delivery Pickup Volume','Delivery Pickup Cube','Delivery Pickup ETA','Delivery Pickup Customer Est Time','Delivery Pickup Date','Delivery Pickup Order','Delivery Pickup Timeframe','Delivery Pickup Arrival','Delivery Pickup Departure','Delivery Pickup Description','Delivery Pickup Service List','Delivery Pickup Default Services','Delivery Pickup Warehouse Only','Delivery Pickup Status','Delivery Pickup Populate Google Link','Delivery Pickup Notes','Delivery Pickup Dropoff Map','Delivery Calendar History'],
	...
	'Customer Notes' => ['Customer Stop Status','Customer Property Damage','Customer Product Damage','Customer Rate','Customer Delivery Rate','Customer Recommend','Customer Recommend Likely','Customer Sign','Customer Complete','Customer Slider','Customer Sign Off Complete Status','Customer Complete Exits Ticket'],
	'Custom Notes' => [],
	'Notes' => [],
