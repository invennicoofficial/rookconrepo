...
$accordion_list = [
	'Customer History' => ['Customer History Business Ticket Type','Customer History Business Project Type','Customer History Business Ticket Project Type','Customer History Customer Ticket Type','Customer History Customer Project Type','Customer History Customer Ticket Project Type'],
	'Information' => ['PI Business','PI Name','PI AFE','PI Project','PI Pieces','PI Sites','PI Rate Card','PI Customer Order','PI Sales Order','PI Invoice','PI Order','PI Purchase Order','PI WTS Order','PI Cross Ref','PI Invoiced Out','PI Work Order','PI Date of Entry','PI Time of Entry','PI Agent','PI Status','PI Ban','PI Vendor','PI Operator','PI Waste Manifest','PI Reference Ticket','PI TDG Doc Num','PI VTI Num','PI TEXT FIELD'],
	...
	'Contact Notes' => ['Attached Business Notes','Attached Contact Notes','Attached Contact Notes Add Note'],
	'Individuals' => [],
	'Path & Milestone' => [],
	'Fees' => [],
	'Location' => ['Location Site','Location Site Info','Location Notes','Emergency'],
	...
	'Mileage' => [],
	'Staff' => ['Staff Position','Staff Rate Positions','Staff Rate','Staff Start','Staff Set Hours','Staff Hours','Staff Estimate','Staff Overtime','Staff Travel','Staff Subsistence','Staff Subsistence Options','Staff Check In','Staff Set Hours Time Sheet','Staff Billing'],
	'Staff Tasks' => [],
	...
	'Medication' => [],
	'Ticket Details' => ['Help Desk','Service Category','Service Type','Service Heading','Service Quantity','Service # of Rooms','Service Rate Card','Service Estimated Hours','Service Fuel Charge','Service Preferred Staff','Service Total Price','Service Total Estimated Hours','Details Heading','Service Description','Details Where','Details Who','Details Why','Details What','Details Position','Details Checklist'],
	'Service Staff Checklist' => ['Service Staff Checklist Group Cat Type','Service Staff Checklist Another Room','Service Staff Checklist Another Room Copy Values','Service Staff Checklist Extra Billing','Service Staff Checklist Scroll To Accordion','Service Staff Checklist History','Service Staff Checklist One Service Template Only','Service Staff Checklist Checked In Staff'],
	'Service Extra Billing' => ['Service Extra Billing Display Only If Exists','Service Extra Billing Add Option'],
	'Equipment' => ['Equipment Category','Equipment Make','Equipment Model','Equipment Unit','Equipment Residue','Equipment Hours','Equipment Volume','Equipment Rate','Equipment Cost','Equipment Status'],
	'Checklist' => [],
	'Checklist Items' => [],
	'Charts' => [],
	'Safety' => [],
	...
	'Materials' => ['Material Category','Material Type','Material Quantity','Material Volume','Material Rate','Auto Check In Materials','Auto Check Out Materials'],
	...
	'Inventory General' => ['Inventory General Piece Count Type','Inventory General All Copy','Inventory General Piece Copy','Inventory General Piece','Inventory General Piece Type','Inventory General PO Item','Inventory General PO Line Item','Inventory General PO Line Read','Inventory General PO Line Sort','Inventory General Piece Dim Weight','Inventory General Weight','Inventory General Units','Inventory General Dimensions','Inventory General Dimension Units','Inventory General Shipment Count Weight','Inventory General Site','Inventory General Complete','Inventory General Total Count Weight','Inventory General Detail','Inventory General Detail by Pallet','Inventory General Total Summary','Inventory General Manual Add Pieces','Inventory General Pallet Default Locked'],
	...
	'Delivery' => ['Assigned Equipment','Delivery Stops','Delivery Stops Order','Delivery Stops Volume','Delivery Pickup Equipment Category','Delivery Pickup Equipment Make','Delivery Pickup Equipment Model','Delivery Pickup Equipment','Delivery Pickup','Delivery Pickup Address','Delivery Pickup Coordinates','Delivery Pickup Client','Delivery Pickup Customer','Delivery Pickup Phone','Delivery Pickup Type','Delivery Pickup Volume','Delivery Pickup Cube','Delivery Pickup ETA','Delivery Pickup Customer Est Time','Delivery Pickup Date','Delivery Pickup Order','Delivery Pickup Timeframe','Delivery Pickup Arrival','Delivery Pickup Departure','Delivery Pickup Description','Delivery Pickup Service List','Delivery Pickup Default Services','Delivery Pickup Warehouse Only','Delivery Pickup Status','Delivery Pickup Populate Google Link','Delivery Pickup Dropoff Map'],
	...
	'Documents' => ['Documents Docs','Documents Links'],
	...
	'Customer Notes' => ['Customer Property Damage','Customer Product Damage','Customer Rate','Customer Delivery Rate','Customer Recommend','Customer Recommend Likely','Customer Sign','Customer Complete','Customer Slider','Customer Sign Off Complete Status'],
	'Custom Notes' => [],
	'Notes' => [],
	...
	'Notifications' => ['Notify Business','Notify Client','Notify Staff','Notify List','Notify PDF'],
