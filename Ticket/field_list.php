...
$accordion_list = [
	...
	'Details' => ['Detail Business','Detail Project','Detail Contact','Detail Contact Phone','Detail Rate Card','Detail Heading','Detail Start Date Time','Detail End Date Time','Detail Date','Detail Staff','Detail Staff Times','Detail Member Times','Detail Times','Detail Duration','Detail Notes','Detail Image','Detail Max Capacity','Detail Staff Capacity','Detail Status','Detail Total Budget Time'],
	...
	'Mileage' => [],
	'Staff' => ['Staff Position','Staff Rate Positions','Staff Rate','Staff Start','Staff Set Hours','Staff Hours','Staff Estimate','Staff Overtime','Staff Travel','Staff Subsistence','Staff Subsistence Options','Staff Check In','Staff Set Hours Time Sheet','Staff Billing','Staff Anyone Can Add','Staff Multiple Times','Staff Multiple Times Date','Staff Multiple Times Start Time','Staff Multiple Times End Time','Staff Multiple Times Type','Staff Multiple Times Set Hours'],
	'Staff Tasks' => [],
	...
	'Medication' => [],
	'Ticket Details' => ['Help Desk','Service Category','Service Type','Service Heading','Service Quantity','Service Total Time','Service # of Rooms','Service Rate Card','Service Estimated Hours','Service Fuel Charge','Service Preferred Staff','Service Total Price','Service Total Estimated Hours','Details Heading','Service Description','Details Where','Details Tile','Details Tab','Details Who','Details Why','Details What','Details Position','Details Checklist'],
	...
	'Customer Notes' => ['Customer Stop Status','Customer Property Damage','Customer Product Damage','Customer Product Damage Package','Customer Rate','Customer Delivery Rate','Customer Recommend','Customer Recommend Likely','Customer Add Details','Customer Sign','Customer Complete','Customer Slider','Customer Sign Off Complete Status','Customer Complete Exits Ticket'],
	'Custom Notes' => [],
	'Internal Communication' => [],
	'External Communication' => ['External Response','External Response Thread','External Response Status','External Response Documents'],
	'Notes' => [],
