...
$accordion_list = [
	...
	'Materials' => ['Material Category','Material Subcategory','Material Type','Material Manual','Material Quantity','Material Volume','Material Rate','Auto Check In Materials','Auto Check Out Materials'],
