<?php
$projectid = get_tickets($dbc, $ticketid, 'projectid');
$client_projectid = get_tickets($dbc, $ticketid, 'client_projectid');
...
if(empty($projectid)) {
	...
	$detail_issue = get_client_project_detail($dbc, $client_projectid, 'detail_issue');
	$detail_problem = get_client_project_detail($dbc, $client_projectid, 'detail_problem');
	$detail_technical_uncertainty = get_client_project_detail($dbc, $client_projectid, 'detail_technical_uncertainty');
	$detail_base_knowledge = get_client_project_detail($dbc, $client_projectid, 'detail_base_knowledge');
	$detail_objectives = get_client_project_detail($dbc, $client_projectid, 'detail_objectives');
	$detail_already_known = get_client_project_detail($dbc, $client_projectid, 'detail_already_known');
	$detail_sources = get_client_project_detail($dbc, $client_projectid, 'detail_sources');
	$detail_current_designs = get_client_project_detail($dbc, $client_projectid, 'detail_current_designs');
	$detail_known_techniques = get_client_project_detail($dbc, $client_projectid, 'detail_known_techniques');
	$detail_review_needed = get_client_project_detail($dbc, $client_projectid, 'detail_review_needed');
	$detail_looking_to_achieve = get_client_project_detail($dbc, $client_projectid, 'detail_looking_to_achieve');
	$detail_plan = get_client_project_detail($dbc, $client_projectid, 'detail_plan');
	$detail_next_steps = get_client_project_detail($dbc, $client_projectid, 'detail_next_steps');
	$detail_learnt = get_client_project_detail($dbc, $client_projectid, 'detail_learnt');
	$detail_discovered = get_client_project_detail($dbc, $client_projectid, 'detail_discovered');
	$detail_tech_advancements = get_client_project_detail($dbc, $client_projectid, 'detail_tech_advancements');
	$detail_work = get_client_project_detail($dbc, $client_projectid, 'detail_work');
	$detail_adjustments_needed = get_client_project_detail($dbc, $client_projectid, 'detail_adjustments_needed');
	$detail_future_designs = get_client_project_detail($dbc, $client_projectid, 'detail_future_designs');	
}
