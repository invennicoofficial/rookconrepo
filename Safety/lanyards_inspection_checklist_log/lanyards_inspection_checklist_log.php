...
if(!empty($_GET['formid'])) {
	...
	$get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM safety_lanyards_inspection_checklist_log WHERE fieldlevelriskid='$formid'"));
        ...
        <div id="collapse_info" class="panel-collapse collapse">
            <div class="panel-body">
				...
				<?php if (strpos($form_config, ','."fields2".',') !== FALSE) { ?>
					<div class="form-group">
                    <label for="business_street" class="col-sm-4 control-label">Lanyard Model</label>
                    <div class="col-sm-8">
	...
	<div class="panel panel-default">
        ...
        <div id="collapse_hard" class="panel-collapse collapse">
            <div class="panel-body">
				...
				<div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">Hardware: (includes snap hooks,carabiners, adjusters, keepers,thimbles, and Drings).Inspect fordamage, distortion, sharp edges, burrs,cracks, corrosion and proper operation.</label>
                <div class="col-sm-8">
	...
	<div class="panel panel-default">
        ...
        <div id="collapse_web" class="panel-collapse collapse">
            <div class="panel-body">
				...
				<div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">Webbing: Inspect for cuts, burns,tears, frays, excessive soiling, and discoloration.</label>
                <div class="col-sm-8">
	...
	<div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_sy" >
                    Synthetic Rope<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
        ...
        <div id="collapse_sy" class="panel-collapse collapse">
            <div class="panel-body">
				...
				<div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">Synthetic Rope: Inspect for pulled or cut yarns, burns, abrasion, knots, excessive soiling and discoloration.</label>
                <div class="col-sm-8">
	...
	<div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_wire" >
                    Wire Rope<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
        ...
        <div id="collapse_wire" class="panel-collapse collapse">
            <div class="panel-body">
				...
				<div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">Wire Rope: Inspect for broken wires, corrosion, kinks, and separation of strands.</label>
                <div class="col-sm-8">
	...
	<div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_energy" >
                    Energy Absorbing Component<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
        ...
        <div id="collapse_energy" class="panel-collapse collapse">
            <div class="panel-body">
				...
				<div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">Energy Absorbing Component:Inspect for elongation, tears, and excessive soiling.</label>
                <div class="col-sm-8">
