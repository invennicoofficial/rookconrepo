<?php
function monthly_site_safety_inspection_pdf($dbc,$safetyid, $fieldlevelriskid) {
    $form_by = $_SESSION['contactid'];

	$get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM safety_monthly_site_safety_inspection WHERE fieldlevelriskid='$fieldlevelriskid'"));
	...
	$result_update_employee = mysqli_query($dbc, "UPDATE `safety_monthly_site_safety_inspection` SET `status` = 'Done' WHERE fieldlevelriskid='$fieldlevelriskid'");
    ...
    $html_weekly .= '<tr nobr="true" style="background-color:lightgrey; color:black;">
        <th style="width:26%;">Items to watch for</th>
    ...
    if (strpos($form_config, ','."fields4".',') !== FALSE) {
        ...
        $html_weekly .= '<td data-title="Email">Equipment Inspections</td>';
        $html_weekly .= '<td data-title="Email">';
        if (strpos(','.$fields.',', ',field4_acceptable,') !== FALSE) {
            $html_weekly .= '<img src="../img/checkmark.png" width="10" height="10" border="0" alt="">';
        }
        $html_weekly .= '</td>';
        $html_weekly .= '<td data-title="Email">';
        if (strpos(','.$fields.',', ',field4_unacceptable,') !== FALSE) {
            $html_weekly .= '<img src="../img/checkmark.png" width="10" height="10" border="0" alt="">';
        }
        $html_weekly .= '</td>';
    ...
    if (strpos($form_config, ','."fields5".',') !== FALSE) {
        $html_weekly .= '<tr nobr="true">';
        $html_weekly .= '<td data-title="Email">Operator Authorization</td>';
        $html_weekly .= '<td data-title="Email">';
        if (strpos(','.$fields.',', ',field5_acceptable,') !== FALSE) {
            $html_weekly .= '<img src="../img/checkmark.png" width="10" height="10" border="0" alt="">';
        }
        $html_weekly .= '</td>';
        $html_weekly .= '<td data-title="Email">';
        if (strpos(','.$fields.',', ',field5_unacceptable,') !== FALSE) {
            $html_weekly .= '<img src="../img/checkmark.png" width="10" height="10" border="0" alt="">';
        }
        $html_weekly .= '</td>';
    ...
    if (strpos($form_config, ','."fields11".',') !== FALSE) {
        $html_weekly .= '<tr nobr="true">';
        $html_weekly .= '<td data-title="Email">Fire Protection Equipment</td>';
        $html_weekly .= '<td data-title="Email">';
    ...
    if (strpos($form_config, ','."fields12".',') !== FALSE) {
        $html_weekly .= '<tr nobr="true">';
        $html_weekly .= '<td data-title="Email">First Aid contents</td>';
        $html_weekly .= '<td data-title="Email">';
    ...
    if (strpos($form_config, ','."fields14".',') !== FALSE) {
        $html_weekly .= '<tr nobr="true">';
        $html_weekly .= '<td data-title="Email">Aisle, Work Surfaces</td>';
        $html_weekly .= '<td data-title="Email">';
    ...
    if (strpos($form_config, ','."fields15".',') !== FALSE) {
        $html_weekly .= '<tr nobr="true">';
        $html_weekly .= '<td data-title="Email">Atmosphere condition</td>';
        $html_weekly .= '<td data-title="Email">';
    ...
    if (strpos($form_config, ','."fields20".',') !== FALSE) {
        $html_weekly .= '<tr nobr="true">';
        $html_weekly .= '<td data-title="Email">Maintenance</td>';
        $html_weekly .= '<td data-title="Email">';
    ...
    if (strpos($form_config, ','."fields22".',') !== FALSE) {
        $html_weekly .= '<tr nobr="true">';
        $html_weekly .= '<td data-title="Email">Storage Facilities/Areas</td>';
        $html_weekly .= '<td data-title="Email">';
    ...
    while($row_sa = mysqli_fetch_array( $sa )) {
        ...
        $html_weekly .= '<td data-title="Email"><img src="monthly_site_safety_inspection/download/safety_'.$assign_staff_id.'.png" width="150" height="70" border="0" alt=""></td>';
        $html_weekly .= '</tr>';
    }
    $html_weekly .= '</table>';
    ...
    $pdf->Output('monthly_site_safety_inspection/download/hazard_'.$fieldlevelriskid.'.pdf', 'F');
    ...
    while($row_sa = mysqli_fetch_array( $sa )) {
        ...
        unlink("monthly_site_safety_inspection/download/safety_".$assign_staff_id.".png");
    }
    echo '';
}
?>