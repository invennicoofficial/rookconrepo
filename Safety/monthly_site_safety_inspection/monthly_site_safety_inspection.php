...
if(!empty($_GET['formid'])) {
	...
	$get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM safety_monthly_site_safety_inspection WHERE fieldlevelriskid='$formid'"));
...
<div class="panel-group" id="accordion2">
	...
	<div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_info1" >
                    Item To Watch for<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
        ...
        <div id="collapse_info1" class="panel-collapse collapse">
			...
			<?php if (strpos($form_config, ','."fields4".',') !== FALSE) { ?>
               <div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">Equipment Insection</label>
                <div class="col-sm-8">
                    <input type="radio" <?php if (strpos(','.$fields.',', ',field4_acceptable,') !== FALSE) { echo " checked"; } ?>  name="fields_option_4" value="field4_acceptable">Acceptable
                    <input type="radio" <?php if (strpos(','.$fields.',', ',field4_unacceptable,') !== FALSE) { echo " checked"; } ?>  name="fields_option_4" value="field4_unacceptable">Unacceptable
            ...
            <div class="col-sm-8">
			<input type="radio" <?php if (strpos(','.$fields.',', ',field5_acceptable,') !== FALSE) { echo " checked"; } ?>  name="fields_option_5" value="field5_acceptable">Acceptable
			<input type="radio" <?php if (strpos(','.$fields.',', ',field5_unacceptable,') !== FALSE) { echo " checked"; } ?>  name="fields_option_5" value="field5_unacceptable">Unacceptable
			...
			<?php if (strpos($form_config, ','."fields11".',') !== FALSE) { ?>
               <div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">
            Fire Protection Eqiupment</label>
            <div class="col-sm-8">
			...
			<?php if (strpos($form_config, ','."fields21".',') !== FALSE) { ?>
               <div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">
            Flammable Liquid, Gas, Lables  </label>
            <div class="col-sm-8">
			...
			<?php if (strpos($form_config, ','."fields22".',') !== FALSE) { ?>
               <div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">
            Storage Facilities/Areas</label>
            <div class="col-sm-8">
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse_sa<?php echo $sa_inc;?>" class="panel-collapse collapse">
            ...
            <?php } else {
                echo '<img src="monthly_site_safety_inspection/download/safety_'.$assign_staff_id.'.png">';
            } ?>
