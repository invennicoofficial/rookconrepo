...
if(!empty($_GET['formid'])) {
	...
	$get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM safety_equipment_inspection_checklist WHERE fieldlevelriskid='$formid'"));
...
<div class="panel-group" id="accordion2">
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse_info1" class="panel-collapse collapse">
            ...
            <div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">Hydraulic Cylinders</label>
                <div class="col-sm-8">
...
<div class="panel panel-default">
    ...
    <div id="collapse_sa<?php echo $sa_inc;?>" class="panel-collapse collapse">
        <div class="panel-body">
            ...
            <?php } else {
                echo '<img src="equipment_inspection_checklist/download/safety_'.$assign_staff_id.'.png">';
            } ?>
