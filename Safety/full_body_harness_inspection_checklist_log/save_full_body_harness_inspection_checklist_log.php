 <?php
    ...
    if(empty($_POST['fieldlevelriskid'])) {
        ...
        if($tab == 'Form') {
            ...
            include ('full_body_harness_inspection_checklist_log_pdf.php');
            echo full_body_harness_inspection_checklist_log_pdf($dbc,$safetyid, $fieldlevelriskid);
        ...
        $query_update_employee = "UPDATE `safety_full_body_harness_inspection_checklist_log` SET `contactid` = '$contactid', `fields` = '$fields', `desc` = '$desc', `desc1` = '$desc1', `desc2` = '$desc2', `desc3` = '$desc3', `desc4` = '$desc4', `desc5` = '$desc5', `desc6` = '$desc6', `desc7` = '$desc7' WHERE fieldlevelriskid='$fieldlevelriskid'";
        ...
        while($row_sa = mysqli_fetch_array( $sa )) {
            ...
            if($_POST['sign_'.$assign_staff_id] != '') {
                ...
                imagepng($img, 'full_body_harness_inspection_checklist_log/download/safety_'.$assign_staff_id.'.png');
