...
if(!empty($_GET['formid'])) {
	...
	$get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM safety_general_site_safety_inspection WHERE fieldlevelriskid='$formid'"));
...
<div class="panel panel-default">
    ...
    <div id="collapse_sa<?php echo $sa_inc;?>" class="panel-collapse collapse">
        <div class="panel-body">
            ...
            <?php } else {
                echo '<img src="general_site_safety_inspection/download/safety_'.$assign_staff_id.'.png">';
            } ?>
