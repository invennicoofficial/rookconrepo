...
$follow_up = '';
    ...
    if(!empty($_GET['formid'])) {
        ...
        $get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM safety_weekly_safety_meeting WHERE fieldlevelriskid='$formid'"));

        $today_date = $get_field_level['today_date'];
        $location = $get_field_level['location'];
        $contactid = $get_field_level['contactid'];
        $issue_discussion = $get_field_level['issue_discussion'];
        $follow_up = $get_field_level['follow_up'];
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_info1" >
                    Issues discussed and employee's suggestions<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
        ...
        <div id="collapse_info1" class="panel-collapse collapse">
            <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label for="first_name[]" class="col-sm-4 control-label">Issues discussed and employee's suggestions:</label>
                    <div class="col-sm-8">
                      <textarea name="issue_discussion" rows="5" cols="50" class="form-control"><?php echo $issue_discussion; ?></textarea>
                    </div>
                  </div>
            </div>
        </div>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_info2" >
                    Items to be followed up on<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
        ...
        <div id="collapse_info2" class="panel-collapse collapse">
            <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label for="first_name[]" class="col-sm-4 control-label">Items to be followed up on:</label>
                    <div class="col-sm-8">
                      <textarea name="follow_up" rows="5" cols="50" class="form-control"><?php echo $follow_up; ?></textarea>
                    </div>
                  </div>
            </div>
        </div>
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse_sa<?php echo $sa_inc;?>" class="panel-collapse collapse">
            <div class="panel-body">
               ...
               <div class="form-group">
                <label for="business_street" class="col-sm-4 control-label">P.P.E:</label>
                <div class="col-sm-8">
            ...
            <?php } else {
                echo '<img src="weekly_safety_meeting/download/safety_'.$assign_staff_id.'.png">';
            } ?>
