...
$action = '';
    ...
    if(!empty($_GET['formid'])) {
        ...
        $get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM safety_follow_up_incident_report WHERE fieldlevelriskid='$formid'"));
...
<div class="panel-group" id="accordion2">
    ...
    <div class="panel panel-default">
        ...
        <div id="collapse_sa<?php echo $sa_inc;?>" class="panel-collapse collapse">
            ...
            <?php } else {
                echo '<img src="follow_up_incident_report/download/safety_'.$assign_staff_id.'.png">';
            } ?>
