...
if (isset($_POST['submit'])) {
    ...
    $first_logo = $_FILES["first_logo"]["name"];
    ...
    $first_header = filter_var(htmlentities($_POST['first_header']),FILTER_SANITIZE_STRING);

    $get_field_config = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT COUNT(fieldconfigestimateid) AS fieldconfigestimateid FROM field_config_cost_estimate"));
    if($get_field_config['fieldconfigestimateid'] > 0) {
		...
		if($first_logo == '') {
			$first_logo = $_POST['first_logo_file'];
		} else {
			move_uploaded_file($_FILES["first_logo"]["tmp_name"],"download/" . $first_logo);
		}
        ...
        $query_update_employee = "UPDATE `field_config_cost_estimate` SET logo = '$logo_update', quote_pdf_header = '$quote_pdf_header', quote_pdf_footer = '$quote_pdf_footer', quote_pdf_footer_logo = '$quote_pdf_footer_logo_update', `first_logo`='$first_logo', `first_header`='$first_header' WHERE `fieldconfigestimateid` = 1";
        ...
        $query_insert_config = "INSERT INTO `field_config_cost_estimate` (`logo`, `quote_pdf_header`, `quote_pdf_footer`, `quote_pdf_footer_logo`, `first_logo`, `first_header`) VALUES ('$logo', '$quote_pdf_header', '$quote_pdf_footer', '$quote_pdf_footer_logo', '$first_logo', '$first_header')";
        $result_insert_config = mysqli_query($dbc, $query_insert_config);
    }
    //Logo

    //PDF Header Colours
    $cost_estimate_pdf_colours = filter_var(implode('#*#',array_filter($_POST['cost_estimate_pdf_colours'])),FILTER_SANITIZE_STRING);

    $get_config = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT COUNT(configid) AS configid FROM general_configuration WHERE name='cost_estimate_pdf_colours'"));
    if($get_config['configid'] > 0) {
        $query_update_employee = "UPDATE `general_configuration` SET value = '$cost_estimate_pdf_colours' WHERE name='cost_estimate_pdf_colours'";
        $result_update_employee = mysqli_query($dbc, $query_update_employee);
    } else {
        $query_insert_config = "INSERT INTO `general_configuration` (`name`, `value`) VALUES ('cost_estimate_pdf_colours', '$cost_estimate_pdf_colours')";
        $result_insert_config = mysqli_query($dbc, $query_insert_config);
    }
    //PDF Header Colours
    ...
    $cost_estimate_sign_notes = filter_var(htmlentities($_POST['cost_estimate_sign_notes']),FILTER_SANITIZE_STRING);
    $get_config = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT COUNT(configid) AS configid FROM general_configuration WHERE name='cost_estimate_sign_notes'"));
    if($get_config['configid'] > 0) {
        $query_update_employee = "UPDATE `general_configuration` SET value = '$cost_estimate_sign_notes' WHERE name='cost_estimate_sign_notes'";
        $result_update_employee = mysqli_query($dbc, $query_update_employee);
    } else {
        $query_insert_config = "INSERT INTO `general_configuration` (`name`, `value`) VALUES ('cost_estimate_sign_notes', '$cost_estimate_sign_notes')";
        $result_insert_config = mysqli_query($dbc, $query_insert_config);
    }
    //Quote Signature Notes

    //Mandatory Accordion Details
    $mandatory_details_quote_config = filter_var(implode(',',$_POST['mandatory_details_quote_config']),FILTER_SANITIZE_STRING);
    $get_config = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT COUNT(configid) AS configid FROM general_configuration WHERE name='mandatory_details_quote_config'"));
    if($get_config['configid'] > 0) {
        $query = "UPDATE `general_configuration` SET value = '$mandatory_details_quote_config' WHERE name='mandatory_details_quote_config'";
        $result_mandatory = mysqli_query($dbc, $query);
    } else {
        $query = "INSERT INTO `general_configuration` (`name`, `value`) VALUES ('mandatory_details_quote_config', '$mandatory_details_quote_config')";
        $result_mandatory = mysqli_query($dbc, $query);
    }
    //Mandatory Accordion Details
    ...
    $query_update_employee = "UPDATE `field_config_cost_estimate` SET config_fields_quote = '$config_fields_quote', config_fields_quote_dashboard = '$config_fields_quote_dashboard' WHERE `fieldconfigestimateid` = 1";
    $result_update_employee = mysqli_query($dbc, $query_update_employee);
...
<a href="quotes.php" class="btn brand-btn">Back to Dashboard</a>
<!--<a href="#" class="btn brand-btn" onclick="history.go(-1);return false;">Back</a>-->
<br><br>
<a href='field_config_estimate.php'><button type="button" class="btn brand-btn mobile-block" >Internal Cost Estimate Settings</button></a>
<a href='field_config_quote.php'><button type="button" class="btn brand-btn mobile-block active_tab" >Customer Cost Estimate Settings</button></a>
<a href='field_config_estimate.php?tab=add'><button type="button" class="btn brand-btn mobile-block <?php echo $tab_active_tab; ?>" >Cost Estimate Tab Settings</button></a>
<br><br>
...
<form id="form1" name="form1" method="post"	action="" enctype="multipart/form-data" class="form-horizontal" role="form">
    ...
    $first_logo = $get_field_config['first_logo'];
    ...
    ?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_dash" >
                        Customer Cost Estimate Dashboard Settings<span class="glyphicon glyphicon-plus"></span>
                    </a>
                </h4>
            </div>
            ...
            <div id="collapse_dash" class="panel-collapse collapse">
                <div class="panel-body">
                     <input type="checkbox" <?php if (strpos($config_fields_quote_dashboard, ','."Quote#".',') !== FALSE) { echo " checked"; } ?> value="Quote#" style="height: 20px; width: 20px;" name="config_fields_quote_dashboard[]">&nbsp;&nbsp;Estimate#&nbsp;&nbsp;
                    ...
                    <input type="checkbox" <?php if (strpos($config_fields_quote_dashboard, ','."Quote Name".',') !== FALSE) { echo " checked"; } ?> value="Quote Name" style="height: 20px; width: 20px;" name="config_fields_quote_dashboard[]">&nbsp;&nbsp;Estimate Name&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_field" >
                        Customer Cost Estimate PDF Options<span class="glyphicon glyphicon-plus"></span>
                    </a>
                </h4>
            </div>
            ...
            <div id="collapse_field" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                    <label for="first_logo[]" class="col-sm-4 control-label">First Page Header Logo<span class="popover-examples list-inline">&nbsp;
                    <a  data-toggle="tooltip" data-placement="top" title="File name cannot contain apostrophes, quotations or commas."><img src="<?php echo WEBSITE_URL; ?>/img/info.png" width="20"></a>
                    </span>:</label>
                    <div class="col-sm-8">
                    <?php if($first_logo != '' && file_exists('download/'.$first_logo)) {
                        echo '<a href="download/'.$first_logo.'" target="_blank">View</a>';
                        ?>
                        <input type="hidden" name="first_logo_file" value="<?php echo $first_logo; ?>" />
                        <input name="first_logo" type="file" data-filename-placement="inside" class="form-control" />
                      <?php } else { ?>
                      <input name="first_logo" type="file" data-filename-placement="inside" class="form-control" />
                      <?php } ?>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="office_country" class="col-sm-4 control-label">First Page Header Info:<br><em>(e.g. - company address, phone, email, etc.)<br />This header and logo will be displayed only on the first page of the estimate, after the main header.</em></label>
                        <div class="col-sm-8">
                            <textarea name="first_header" rows="3" cols="50" class="form-control"><?php echo $first_header; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea name="cost_estimate_sign_notes" rows="3" cols="50" class="form-control"><?php echo $quote_sign_notes; ?></textarea>
                        </div>
                    </div>
					
                    <div class="form-group">
                        <label for="office_country" class="col-sm-4 control-label">PDF Colours:<br><em>(These will be used on the PDF in the headings)</em></label>
                        <div class="col-sm-8">
							<?php $cost_estimate_pdf_colours = explode('#*#',get_config($dbc, 'cost_estimate_pdf_colours'));
                            ...
                            Estimate Accordion Title Background Colour: <input class="form-control" type="color" name="cost_estimate_pdf_colours[]" value="<?= $cost_estimate_pdf_colours[0] ?>"><br />
                            <!--Gradient Colour 2: <input class="form-control" type="color" name="cost_estimate_pdf_colours[]" value="<?= $cost_estimate_pdf_colours[1] ?>"><br />-->
                        </div>
                    </div>
					
					<label class="form-checkbox"><input type="checkbox" <?php if (strpos($value_config, ','."Quote Signatures".',') !== FALSE) { echo " checked"; } ?> value="Quote Signatures" style="height: 20px; width: 20px;" name="config_fields[]">Include Signature Lines</label>
					
					<h4>Mandatory Accordions</h4>
					<em>The Details of these accordions will always be shown on the PDF.</em><br />
					<?php foreach(explode('#*#',mysqli_fetch_array(mysqli_query($dbc,"SELECT `custom_accordions` FROM `field_config_cost_estimate`"))['custom_accordions']) as $accordion) {
						$acc_name = explode(',',$accordion)[0]; ?>
						<label class="form-checkbox"><input type="checkbox" <?= (in_array(preg_replace('/[^a-z]/','',strtolower($acc_name)),$mandatory_details_quote_config) ? 'checked' : '') ?> value="<?= preg_replace('/[^a-z]/','',strtolower($acc_name)) ?>" style="height: 20px; width: 20px;" name="mandatory_details_quote_config[]"><?= $acc_name ?></label>
					<?php } ?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_survey" >
                        Email Estimate To Customer<span class="glyphicon glyphicon-plus"></span>
                    </a>
                </h4>
            </div>
            ...
            <div id="collapse_survey" class="panel-collapse collapse">
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label for="fax_number"	class="col-sm-4	control-label">Email Body:<br>Use tag for Customer Name: [Client Name]</label>
                    <div class="col-sm-8">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Package" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Package Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Package Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Promotion" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Promotion Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Promotion Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Custom" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Custom Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Custom Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Material" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Material Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Material Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Services" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Services Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Services Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Products" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Products Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Products Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_sred" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."SRED Quote Description".',') !== FALSE) { echo " checked"; } ?> value="SRED Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Staff" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Staff Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Staff Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description &nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Contractor" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Contractor Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Contractor Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description &nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Clients" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Clients Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Clients Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description &nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_pl" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Vendor Pricelist Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Vendor Pricelist Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Customer" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Customer Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Customer Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description &nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Inventory" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Inventory Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Inventory Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description &nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Equipment" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Equipment Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Equipment Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description &nbsp;&nbsp;
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse_Labour" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <input type="checkbox" <?php if (strpos($value_config, ','."Labour Quote Description".',') !== FALSE) { echo " checked"; } ?> value="Labour Quote Description" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Estimate Description&nbsp;&nbsp;
        ...
        <div class="form-group">
            <div class="col-sm-6">
                <a href="quotes.php" class="btn brand-btn btn-lg">Back</a>
				<!--<a href="#" class="btn brand-btn pull-right" onclick="history.go(-1);return false;">Back</a>-->
            </div>
            <div class="col-sm-6">
                <button	type="submit" name="submit"	value="Submit" class="btn brand-btn btn-lg	pull-right">Submit</button>
