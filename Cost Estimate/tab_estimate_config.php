...
if (isset($_POST['submit'])) {
	...
	$query = "UPDATE `cost_estimate_tab` SET estimate_tab_config = ',$config_fields,' WHERE `estimate_tab_id` = '$tab_id'";
...
$get_field_config = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM cost_estimate_tab WHERE `estimate_tab_id`='{$_GET['tab']}'"));
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Material" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Material' AND `deleted` = 0 AND `rate_card_types` != ''");
			...
			<div id="collapse_Services" class="panel-collapse collapse">
				<div class="panel-body">
				  ...
				  <div class="form-group">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Services' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Products" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Products' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Staff" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Staff' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Contractor" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Contractor' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
			...
			<div id="collapse_Inventory" class="panel-collapse collapse">
				<div class="panel-body">
				   ...
				   <?php /* <input disabled type="checkbox" <?php if (strpos($estimate_config, ','."Inventory Product Name".',') !== FALSE) { echo " checked"; } ?> value="Inventory Product Name" style="height: 20px; width: 20px;" name="config_fields[]">&nbsp;&nbsp;Product Name&nbsp;&nbsp; */ ?>
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Inventory' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Equipment" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Equipment' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Labour" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Labour' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Setup" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Setup' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Teardown" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Teardown' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_Rental" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='Rental' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
		...
		<div class="panel panel-default">
			...
			<div id="collapse_<?php echo $id; ?>" class="panel-collapse collapse">
				<div class="panel-body">
					...
					<?php $type_result = mysqli_query($dbc, "SELECT DISTINCT(`rate_card_types`) type FROM `company_rate_card` WHERE `tile_name`='$id' AND `deleted` = 0 AND `rate_card_types` != ''");
					if(mysqli_num_rows($type_result) > 0) { ?>
						<br><br>
						Rate Card Types:
						<br>
