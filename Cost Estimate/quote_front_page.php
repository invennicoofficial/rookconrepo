...
if (isset($_POST['submit'])) {
    ...
    $front_company_logo = $_FILES["front_company_logo"]["name"];
    $front_client_logo = $_FILES["front_client_logo"]["name"];
    ...
    $query_update_employee = "UPDATE `cost_estimate` SET front_company_logo = '$front_company_logo_update', front_client_info = '$front_client_info', front_other_info = '$front_other_info', front_client_logo = '$front_client_logo_update', front_content_pages = '$front_content_pages', last_content_pages = '$last_content_pages' WHERE `estimateid` = '$estimateid'";
...
<form id="form1" name="form1" method="post"	action="" enctype="multipart/form-data" class="form-horizontal" role="form">
    ...
    $get_field_config = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM cost_estimate WHERE estimateid='$estimateid'"));
    ...
    <div class="form-group">
        <div class="col-sm-4 clearfix">
			...
			<a href="estimate.php" class="btn brand-btn btn-lg pull-right">Back</a>
        </div>
        <div class="col-sm-8">
