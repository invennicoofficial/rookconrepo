...
if (isset($_POST['submit'])) {
	...
	$query_update_report = "UPDATE `cost_estimate` SET `estimate_data` = '$estimate_data' WHERE `estimateid` = '$estimateid'";
	$result_update_report = mysqli_query($dbc, $query_update_report);

	$get_field_config = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT logo FROM field_config_cost_estimate"));
...
<div class="container">
	<div class="row">
		...
		<br /><br />
			...
			<?php
			$estimate_all = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT *  FROM cost_estimate WHERE estimateid='$estimateid'"));
			?>
