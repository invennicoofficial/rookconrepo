       ...
       <?php
        ...
        <?php if(!empty($get_contractor)) {
            ...
            <div class="form-group clearfix" id="<?php echo 'contractor_'.$id_loop; ?>" >
				...
				<?php if(in_array_starts('Total Multiple', $field_order)) { ?>
                <div class="col-sm-1" >
                    <input name="cntestimatetotalmulti[]" value="<?php echo $totalmulti; ?>" id="<?php echo 'cntestimatetotalmulti_'.$id_loop; ?>" type="text" class="form-control" />
                </div>
				<?php } ?>
                <div class="col-sm-1" >
        ...
        <div class="additional_cnt clearfix">
            ...
            <div class="form-group clearfix" id="contractor_0">
				...
				<?php if(in_array_starts('Total Multiple', $field_order)) { ?>
                <div class="col-sm-1" >
                    <input name="cntestimatetotalmulti[]" id='cntestimatetotalmulti_0' type="text" class="form-control" />
                </div>
				<?php } ?>
                <div class="col-sm-1" >
...
<?php
if(!empty($_GET['estimateid'])) {
    $query_rc = mysqli_query($dbc,"SELECT * FROM company_rate_card WHERE ((rate_card_name='$company_rate_card_name' AND IFNULL(`rate_categories`,'')='$company_rate_categories') OR $universal_rc_search) AND tile_name='Contractor' AND `deleted`=0");
			...
			<?php foreach($field_order as $field_data) {
				...
				switch($data[0]) {
					...
					case 'Total Multiple': ?><div class="col-sm-1">
							<input name="crc_contractor_total_multiple[]" value= "<?php echo $estimate_company_rate_card['total_multiple']; ?>"  id="crc_contractor_total_multiple_<?php echo $rc;?>" type="text" class="form-control" />
						</div><?php
						break;
				}
			} ?>
