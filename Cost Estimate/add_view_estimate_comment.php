<div class="col-md-12">
   <?php
    if(!empty($_GET['estimateid'])) {
        $query_check_credentials = "SELECT * FROM cost_estimate_comment WHERE estimateid='$estimateid' AND type='note' ORDER BY estimatecommid DESC";
    ...
    ?>
      ...
      <div class="form-group">
		...
		$subject = 'Note Added on Internal Cost Estimate for you to review.';
		$body = 'Note : [NOTE]<br><br>
            Please click below Estimate link to view all information.<br>
            Internal Cost Estimate : <a target="_blank" href="'.$_SERVER['SERVER_NAME'].'/Cost Estimate/add_estimate.php?estimateid=[ESTIMATEID]&note=add_view">Click Here</a><br>'
		?>
