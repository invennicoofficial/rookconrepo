...
function countPromotion() {
    ...
    $('[name="promotion_summary"]').val('$'+round2Fixed(sum_fee)).change();
...
<div class="form-group">
    <div class="col-sm-12">
        ...
        <?php if((!empty($_GET['promoid'])) || (!empty($_GET['estimateid']))) {
            ...
            $each_promovalmulti = explode(',',trim($promovalmulti,","));
            ...
            for($promoid_loop=0; $promoid_loop<$total_count; $promoid_loop++) {
                ...
                if(isset($each_promovalmulti[$promoid_loop])) {
                    $promoestvalmulti = $each_promovalmulti[$promoid_loop];
                }
            ...
            ?>
				...
				<?php if(in_array_starts('Total Multiple', $field_order)) { ?>
                <div class="col-sm-1" >
                    <input name="promotionestimatepricemulti[]" value="<?php echo $promoestvalmulti; ?>" id="<?php echo 'promotionestmulti_'.$id_loop; ?>" type="text" class="form-control" />
                </div>
				<?php } ?>
                <div class="col-sm-1" >
        ...
        <div class="additional_promotion clearfix">
            ...
            <div class="form-group clearfix" id="promotion_0">
                ...
                <div class="col-sm-1" >
                    <input name="promotionestimatepricemulti[]" id="promotionestmulti_0" type="text" class="form-control" />
                </div>
                <div class="col-sm-1" >
