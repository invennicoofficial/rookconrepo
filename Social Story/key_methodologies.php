...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <h1 class="">Social Stories: Key Methodologies Dashboard
        <?php
        ...
        <?php echo get_tabs_social('Key Methodologies'); ?>
            
			<?php $from_url = 'key_methodologies.php';
			include('../Social Story/key_methodologies_list.php'); ?>
        </form>
