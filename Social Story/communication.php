...
$value = $config['settings']['Choose Fields for Communication Dashboard'];
...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <h1 class="">Social Stories: Communication Dashboard
        <?php
        ...
        <?php echo get_tabs_social('Communication'); ?>
        <br><br>
        <?php
            $search_staff = '';
            $search_client = '';
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-8 col-xs-8">
                      ...
                      <option value=""></option>
                      <?php
                        $query = mysqli_query($dbc,"SELECT distinct(support_contact) FROM social_story_communication WHERE support_contact_category = 'Staff' order by support_contact");
                ...
                <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
                  ...
                  <div class="col-lg-4 col-md-3 col-sm-8 col-xs-8">
                      ...
                      <option value=""></option>
                      <?php
                        $query = mysqli_query($dbc,"SELECT distinct(support_contact) FROM social_story_communication WHERE support_contact_category = 'Clients' order by support_contact");
                        while($row1 = mysqli_fetch_array($query)) {
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <button type="button" onclick="window.location='Communication.php'" name="display_all_inventory" value="Display All" class="btn brand-btn mobile-block">Display All</button>
                  </div>
                </div>

			<?php $from_url = 'communication.php';
			include('../Social Story/communication_list.php'); ?>
