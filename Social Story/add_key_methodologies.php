...
if (isset($_POST['submit'])) {
    ...
    if(empty($_POST['keymethodologiesid'])) {
        $query_insert_vendor = prepare_insert_social($inputs, 'key_methodologies');
        $result_insert_vendor = mysqli_query($dbc, $query_insert_vendor);
        $keymethodologiesid = mysqli_insert_id($dbc);
        $url = 'Added';
    } else {
        $keymethodologiesid = $_POST['keymethodologiesid'];
        $query_update_vendor = prepare_update_social($inputs, 'key_methodologies', 'keymethodologiesid', $keymethodologiesid);
  ...
  <div class="row">
    ...
    <?php
        ...
        if(!empty($_GET['keymethodologiesid'])) {
            ...
            $get_contact = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM key_methodologies WHERE keymethodologiesid='$keymethodologiesid'"));
