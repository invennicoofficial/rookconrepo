...
$value = $config['settings']['Choose Fields for Activities Dashboard'];
...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <h1 class="">Social Stories: Activities Dashboard
        <?php
        ...
        <?php echo get_tabs_social('Activities'); ?>
        <br><br>
        <?php
            $search_staff = '';
            $search_client = '';
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    ...
                    <button type="button" onclick="window.location='activities.php'" name="display_all_inventory" value="Display All" class="btn brand-btn mobile-block">Display All</button>
                  </div>
                </div>

			<?php $from_url = 'activities.php';
			include('../Social Story/activities_list.php'); ?>
