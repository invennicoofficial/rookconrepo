<?php if (strpos($value_config, ','."Application".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$application.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>'; ?>
    <input type="hidden" name="application_hidden" value="<?php echo $application; ?>" />
    <input <?php echo (strpos($edit_config, ','."Application".',') === false ? 'readonly ' : ''); ?>name="application" type="file" data-filename-placement="inside" class="form-control" />
    <?php } else { ?>
    <input <?php echo (strpos($edit_config, ','."Application".',') === false ? 'readonly ' : ''); ?>name="application" type="file" data-filename-placement="inside" class="form-control" />
          <?php } ?>
      </div>
  ...
  <?php if (strpos($value_config, ','."Contact Image".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$contactimage.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload License Plate".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_license_plate.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Property Information".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_property_information.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Inspection".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_inspection.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Letter of Intent".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_letter_of_intent.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Vendor Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_vendor_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Marketing Material".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_marketing_material.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Purchase Contract".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_purchase_contract.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Support Contract".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_support_contract.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Support Terms".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_support_terms.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Rental Contract".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_rental_contract.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Management Contract".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_management_contract.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Articles of Incorporation".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_articles_of_incorporation.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Commercial Insurance".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_commercial_insurance.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload Residential Insurance".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_residential_insurance.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Upload WCB".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$upload_wcb.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Transportation Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$transportation_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Transportation Upload License".',') !== FALSE) { ?>
    ...
    <div class="col-sm-8">
    <?php if((!empty($_GET['id'])) && ($upload_drivers_license != '') ) {
    echo '<a href="download/'.$upload_drivers_license.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Void Cheque".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$cheque_upload.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Insurance Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$insurance_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Guardians Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$guardians_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Trustee Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$trustee_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Family Doctor Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$family_doctor_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Dentist Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$dentist_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Specialists Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$specialists_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Diagnosis Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$diagnosis_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Allergies Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$allergies_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Equipment Support Documents".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$equipment_support_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
  ...
  <?php if (strpos($value_config, ','."Medical Details First Aid/CPR".',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$medical_details_first_aid_cpr_documents.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
...
<?php if (strpos($value_config, ','.$title.',') !== FALSE) { ?>
    ...
    echo '<a href="download/'.$field.'" target="_blank">View</a> - <a href="add_contact.php?contactuploadid='.$contactuploadid.'&contactid='.$contactid.'"> Delete</a>' ?>
