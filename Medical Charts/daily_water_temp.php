...
include 'config.php';
$return_url = 'daily_water_temp.php';
?>
...
<div class="container triple-pad-bottom">
    <div class="row">
        ...
        <h1 class="">Daily Water Temp (Client) Dashboard
        <?php
        ...
        <?php echo get_tabs('Daily Water Temp (Client)'); ?>

        <?php include('daily_water_temp_list.php'); ?>
