...
<div class="container">
	<div class="row">
        ...
        <h2> Policy & Procedures Checklist - <?php echo decryptIt($_SESSION['first_name']); ?> <?php echo decryptIt($_SESSION['last_name']); ?>
        <?php
        ...
        <a href='manual_follow_up.php?type=policy_procedures'><button type="button" class="btn brand-btn mobile-block" >Follow Up</button></a>

        <?php
            echo '<a href="add_manual.php?type=policy_procedures" class="btn brand-btn mobile-block pull-right">Add Policy & Procedures</a>';
        ?>
        </h2>
        ...
        <div class="form-group triple-pad-top triple-pad-bottom clearfix location">
            ...
            <div class="col-sm-12">
                <?php
                    ...
                    echo manual_checklist($dbc, $contactid, '35', '20', '20', 'policy_procedures');
                ?>
            </div>
        </div>
