...
<table border='2' cellpadding='10' class='table'>
    <tr>
        <td>
            <input type="checkbox" <?php if (strpos($value_config, ','."Policy & Procedures".',') !== FALSE) { echo " checked"; } ?> value="Policy & Procedures" style="height: 20px; width: 20px;" name="manual[]">&nbsp;&nbsp;Policy & Procedures
        </td>
        <td>
