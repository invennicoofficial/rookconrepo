...
<div class="container">
	<div class="row">
        ...
        <span class="pull-right">
            ...
            <a href="manual_follow_up.php?action=red&type=<?php echo $type; ?>"><img src="<?php echo WEBSITE_URL;?>/img/block/red.png" width="32" height="32" border="0" alt=""> Deadline Gone</a>
            <a href="manual_follow_up.php?action=green&type=<?php echo $type; ?>"><img src="<?php echo WEBSITE_URL;?>/img/block/green.png" width="32" height="32" border="0" alt=""> Deadline Today</a>
        </span><br><br>
        <?php
