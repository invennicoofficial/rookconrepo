<div class="col-md-12">
   <?php
    if(!empty($_GET['projectid'])) {
        $query_check_credentials = "SELECT * FROM jobs_comment WHERE projectid='$projectid' AND type='note' ORDER BY projectcommid DESC";
    ...
    ?>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <textarea name="jobs_comment" rows="4" cols="50" class="form-control" ></textarea>
        </div>
      </div>
