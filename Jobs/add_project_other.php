...
<div class="form-group">
    <div class="col-sm-12">
        <div class="form-group clearfix hide-titles-mob">
            ...
            <label class="col-sm-2 text-center"><?php if (JOBS_TILE=='Projects') { echo "Project"; } else { echo JOBS_TILE; } ?> Price</label>
        </div>
        ...
        <div class="additional_other_detail clearfix">
            ...
            <div class="form-group clearfix">
                ...
                <div class="col-sm-2" ><label for="company_name" class="col-sm-4 show-on-mob control-label"><?php if (JOBS_TILE=='Projects') { echo "Project"; } else { echo JOBS_TILE; } ?> Price:</label>
