	...
	<div class="row">
        ...
        <a href='edit_project.php?projectid=<?php echo $projectid;?>&type=budget'><button type="button" class="btn brand-btn mobile-block <?php echo $budget; ?>" >By Service</button></a>&nbsp;&nbsp;
            ...
            <div class="form-group">
                <label for="additional_note" class="col-sm-4 control-label"><?php if (JOBS_TILE=='Projects') { echo "Project"; } else { echo JOBS_TILE; } ?>:</label>
                <div class="col-sm-8">
            ...
            <?php if($type == 'profit_loss') {
               ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                    <td data-title='Type'>Total <?php if (JOBS_TILE=='Projects') { echo "Project"; } else { echo JOBS_TILE; } ?> Price</td>
              ...
              <?php
               ...
               ?><div id='no-more-tables'>
                <table class="table table-bordered">
                    ...
                    <th>Type</th>
                    <th>Budget Price</th>
                    <th><?php if (JOBS_TILE=='Projects') { echo "Project"; } else { echo JOBS_TILE; } ?> Price</th>
                    </tr>
                    <?php echo $project_all['review_budget']; ?>
                    <tr>
                    <td data-title='Type'>Total</td>
                    <td data-title='Budget Price'>$<?php echo $budget_price[16]; ?></td>
                    <td data-title='<?php if (JOBS_TILE=='Projects') { echo "Project"; } else { echo JOBS_TILE; } ?> Price'>$<?php echo $project_all['total_price']; ?></td>
                    </tr>
                </table></div>
                <a href="project.php?type=Client" class="btn brand-btn pull-right">Back</a>
				<!--<a href="#" class="btn brand-btn" onclick="history.go(-1);return false;">Back</a>-->
