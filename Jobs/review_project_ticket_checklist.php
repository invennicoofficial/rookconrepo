...
$(document).ready(function() {
    ...
    <form name="form_sites" method="post" action="" class="form-inline" role="form">
        ...
        <?php
            ...
            $result = mysqli_query($dbc, "SELECT t.*, c.name FROM tickets t, contacts c WHERE t.businessid = c.contactid AND projectid='$projectid' ORDER BY status DESC,ticketid DESC");
