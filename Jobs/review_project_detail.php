...
if (isset($_POST['printtherapistpdf'])) {
    ...
    //$starttime = $starttimepdf;
		...
		echo '<a id="'.$projectid.'" href="add_project.php?projectid='.$projectid.'&detail=add_view&from='.urlencode(WEBSITE_URL.$_SERVER['REQUEST_URI']).'" class="btn brand-btn mobile-block pull-right">Add Detail</a>';
