 <?php
    ...
    if(empty($_POST['fieldlevelriskid'])) {
        $query_insert_site = "INSERT INTO `info_lesson_plan` (`infogatheringid`, `today_date`, `business`, `business_1`, `business_2`, `business_3`, `business_4`, `business_5`, `business_6`, `business_7`) VALUES	('$infogatheringid','$today_date', '$business', '$business_1','$business_2','$business_3','$business_4','$business_5','$business_6','$business_7')";
        ...
        $query_update_employee = "UPDATE `info_lesson_plan` SET `business` = '$business', `business_1` = '$business_1', `business_2` = '$business_2',`business_3` = '$business_3',`business_4` = '$business_4',`business_5` = '$business_5',`business_6` = '$business_6',`business_7` = '$business_7' WHERE fieldlevelriskid='$fieldlevelriskid'";
    ...
    include ('lesson_plan_pdf.php');
    echo lesson_plan_pdf($dbc,$infogatheringid, $fieldlevelriskid);
