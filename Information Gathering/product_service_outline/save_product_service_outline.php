 <?php
    ...
    if(empty($_POST['fieldlevelriskid'])) {
        $query_insert_site = "INSERT INTO `info_product_service_outline` (`infogatheringid`, `today_date`, `business_1`, `business_2`, `business_3`, `business_4`, `business_5`, `business_6`) VALUES	('$infogatheringid','$today_date', '$business_1','$business_2','$business_3','$business_4','$business_5','$business_6')";
        ...
        $query_update_employee = "UPDATE `info_product_service_outline` SET `business_1` = '$business_1', `business_2` = '$business_2',`business_3` = '$business_3',`business_4` = '$business_4',`business_5` = '$business_5',`business_6` = '$business_6' WHERE fieldlevelriskid='$fieldlevelriskid'";
    ...
    include ('product_service_outline_pdf.php');
    echo product_service_outline_pdf($dbc,$infogatheringid, $fieldlevelriskid);
