 <?php
    ...
    if(empty($_POST['fieldlevelriskid'])) {
        $query_insert_site = "INSERT INTO `info_swot` (`infogatheringid`, `today_date`, `business_1`, `business_2`, `business_3`, `business_4`, `business_5`) VALUES	('$infogatheringid','$today_date', '$business_1','$business_2','$business_3','$business_4','$business_5')";
        ...
        $query_update_employee = "UPDATE `info_swot` SET `business_1` = '$business_1', `business_2` = '$business_2',`business_3` = '$business_3',`business_4` = '$business_4',`business_5` = '$business_5' WHERE fieldlevelriskid='$fieldlevelriskid'";
    ...
    include ('swot_pdf.php');
    echo swot_pdf($dbc,$infogatheringid, $fieldlevelriskid);
