...
<div style="margin:10px;padding:25px;height:auto" class="sidebar">
	...
	<a href="?type=pdfstyling&style_settings=design_styleA"><canvas id="myCanvas" width="130" height="120"></canvas></a>
	<a href="?type=pdfstyling&style_settings=design_styleB"><canvas id="myCanvas1" width="130" height="120"></canvas></a>
	<a href="?type=pdfstyling&style_settings=design_styleC"><canvas id="myCanvas2" width="130" height="120"></canvas></a>
	<hr>
	<div style="padding:50px;">
		...
		<div class="clearfix"></div>
		<br>
		<h3 style="color:<?= $main_heading_color ?>; font-family: <?= $font_main_heading; ?>;">Title</h3>
		<table style="padding:3px; border:1px solid black;" width="100%">
			<tr nobr="true" style="background-color: black; color:<?= $main_heading_color ?>;  width:22%;">
			<th style="background-color: black; color: <?= $main_heading_color ?>">Date</th>
			<th style="background-color: black; color: <?= $main_heading_color ?>"">Business</th></tr>
    	<tr nobr="true"><td style="color: <?= $main_heading_color ?>">2017-09-18</td><td style="color: <?= $main_heading_color ?>">Business Name</td></tr>
		</table><br>
		<?php for($i = 0; $i < 5; $i++) { ?>
		<h4 style="color:<?= $main_heading_color ?>; font-family: <?= $font_main_heading; ?>;">Heading</h4>
		<p style="font-size:<?php echo $font_main_heading_size; ?>px;font-style:<?php echo $font_main_heading_type; ?>;font-family:<?php echo $font_main_heading; ?>;color:<?php echo $main_heading_color; ?>">
			This is a question?
		</p>
		<p style="font-size:<?php echo $font_main_body_size; ?>px;font-style:<?php echo $font_main_body_type; ?>;font-family:<?php echo $font_main_body; ?>;color:<?php echo $main_body_color; ?>">
			Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam vel molestie nunc. Nullam ligula lacus, consequat quis sodales eget, molestie vitae augue. Proin ac ligula ut augue ultrices suscipit. Sed nec nisl iaculis, consequat dui vitae, iaculis lectus. Praesent vel augue tempor, pretium leo et, dapibus ipsum. Fusce laoreet ut magna sed eleifend. Aenean efficitur odio ut odio vehicula vestibulum. Curabitur vitae auctor libero.
		</p>
		<?php } ?>
		<br>
