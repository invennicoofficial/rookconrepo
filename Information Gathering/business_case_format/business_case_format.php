...
if(!empty($_GET['formid'])) {
	...
	$get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM info_business_case_format WHERE fieldlevelriskid='$formid'"));
...
<div class="panel-group" id="accordion">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info2" >
					The Problem<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info2" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">The Problem</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info3" >
					The Opportunity<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info3" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">The Opportunity</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info4" >
					The Solution<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info4" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">The Solution</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info5" >
					The Approach<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info5" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">The Approach</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info6" >
					Risk Assessment<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info6" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Risk Assessment</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info7" >
					Value Analysis<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info7" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Value Analysis</label>
            <div class="col-sm-8">
