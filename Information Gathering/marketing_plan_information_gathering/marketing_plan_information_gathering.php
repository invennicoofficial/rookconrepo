...
if(!empty($_GET['formid'])) {
	...
	$get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM info_marketing_plan_information_gathering WHERE fieldlevelriskid='$formid'"));
...
<div class="panel-group" id="accordion">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info3" >
					Targets<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info3" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Targets</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
        ...
        <div id="collapse_info4" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Audience</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info5" >
					Current Plan<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info5" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Current Plan</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info6" >
					Strategy<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info6" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Strategy</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info7" >
					Desired Outcome<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info7" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Desired Outcome</label>
            <div class="col-sm-8">
