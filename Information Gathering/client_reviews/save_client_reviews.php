 <?php
    ...
    if(empty($_POST['fieldlevelriskid'])) {
        $query_insert_site = "INSERT INTO `info_client_reviews` (`infogatheringid`, `today_date`, `business`, `business_1`, `business_2`, `business_3`, `business_4`, `business_5`, `business_6`) VALUES	('$infogatheringid','$today_date', '$business', '$business_1','$business_2','$business_3','$business_4','$business_5','$business_6')";
        ...
        $query_update_employee = "UPDATE `info_client_reviews` SET `business` = '$business', `business_1` = '$business_1', `business_2` = '$business_2',`business_3` = '$business_3',`business_4` = '$business_4',`business_5` = '$business_5',`business_6` = '$business_6' WHERE fieldlevelriskid='$fieldlevelriskid'";
    ...
    include ('client_reviews_pdf.php');
    echo client_reviews_pdf($dbc,$infogatheringid, $fieldlevelriskid);
