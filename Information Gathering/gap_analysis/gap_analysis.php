...
if(!empty($_GET['formid'])) {
	...
	$get_field_level = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM info_gap_analysis WHERE fieldlevelriskid='$formid'"));
...
<div class="panel-group" id="accordion">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info2" >
					Objective/Requirement<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info2" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Objective/Requirement</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info3" >
					Current Standing<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info3" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Current Standing</label>
            <div class="col-sm-8">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapse_info4" >
					Deficiency<span class="glyphicon glyphicon-plus"></span>
				</a>
			</h4>
		</div>
        ...
        <div id="collapse_info4" class="panel-collapse collapse">
			...
			<div class="form-group">
            <label for="first_name[]" class="col-sm-4 control-label">Deficiency</label>
            <div class="col-sm-8">
