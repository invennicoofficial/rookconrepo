	   ...
	   <div class="panel-heading">
        ...
        <div id="collapse_info2" class="panel-collapse collapse">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select data-placeholder="Choose a Business..." name="business_name" class="chosen-select-deselect form-control" width="380">
                  <option value=""></option>
					...
					foreach($businesses as $businessid) {
						...
						echo '<option'.($business_name == $row_name ? ' selected' : '').' value="'.$row_name.'">'.$row_name."</option>\n";
					} ?>
                </select>
              </div>
            </div>
	   ...
	   <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_info12" >
                    Business Culture<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
        ...
        <div id="collapse_info12" class="panel-collapse collapse">
            <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label for="first_name[]" class="col-sm-4 control-label">Business Culture:</label>
                    <div class="col-sm-8">
                      <textarea name="business_culture" rows="5" cols="50" class="form-control"><?php echo $business_culture; ?></textarea>
                    </div>
                  </div>
	   ...
	   <div class="panel-heading">
            <h4 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion2" href="#collapse_info13" >
                    Business Tone<span class="glyphicon glyphicon-plus"></span>
                </a>
            </h4>
        </div>
        ...
        <div id="collapse_info13" class="panel-collapse collapse">
            <div class="panel-body">
                  ...
                  <div class="form-group">
                    <label for="first_name[]" class="col-sm-4 control-label">Business Goals:</label>
                    <div class="col-sm-8">
                      <textarea name="business_tone" rows="5" cols="50" class="form-control"><?php echo $business_tone; ?></textarea>
                    </div>
                  </div>
