  ...
  <div class="row">
    ...
    <?php
        ...
        if(!empty($_GET['promotionid'])) {
            ...
            $get_contact = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM promotion WHERE promotionid='$promotionid'"));
        ...
        ?>
        <input type="hidden" id="promotionid" name="promotionid" value="<?php echo $promotionid ?>" />
        <?php   }      ?>
        ...
        <div class="panel-group" id="accordion2">
                ...
                <div id="collapse_info" class="panel-collapse collapse">
                    <div class="panel-body">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select id="service_type" name="service_type" class="chosen-select-deselect form-control" width="380">
                                <option value=''></option>
                                <?php
                                $query = mysqli_query($dbc,"SELECT distinct(service_type) FROM promotion");
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <select id="category" name="category" class="chosen-select-deselect form-control" width="380">
                                <option value=''></option>
                                <?php
                                $query = mysqli_query($dbc,"SELECT distinct(category) FROM promotion");
                                while($row = mysqli_fetch_array($query)) {
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input name="expiry_date" value="<?php echo $expiry_date; ?>" type="text" class="datepicker">
                        </div>
                      </div>
                      <?php } ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_services" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        include ('add_promotion_services.php');
                        ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_client" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_promotion_clients.php');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_customer" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_promotion_customer.php');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_vendor" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_promotion_vendor.php');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_inv" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_promotion_inventory.php');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_equipment" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        include ('add_promotion_equipment.php');
                        ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_eq_cat" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        include ('add_promotion_equipment_category.php');
                        ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_staff" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_promotion_staff.php');
                        ?>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_staff_pos" class="panel-collapse collapse">
                    <div class="panel-body">
                        ...
                        <?php
                        include ('add_promotion_staff_position.php');
                        ?>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse_cont" class="panel-collapse collapse">
                    <div class="panel-body">
                        <?php
                        include ('add_promotion_contractor.php');
                        ?>
                    </div>
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="col-sm-6">
                <a href="promotion.php" class="btn brand-btn btn-lg">Back</a>
				<!--<a href="#" class="btn brand-btn btn-lg pull-right" onclick="history.go(-1);return false;">Back</a>-->
			</div>
			<div class="col-sm-6">
				<button type="submit" name="add_promotion" value="Submit" class="btn brand-btn btn-lg pull-right">Submit</button>
			</div>
