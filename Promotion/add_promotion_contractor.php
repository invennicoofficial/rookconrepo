...
$(document).ready(function() {
    ...
    $('#add_row_cnt').on( 'click', function () {
        ...
        clone.find('#promotioncontractor_0').attr('id', 'promotioncontractor_'+add_new_cnt);
        $('#cntdelete_0').hide();
...
function selectContractor(sel) {
	...
	$.ajax({
		type: "GET",
		url: "promotion_ajax_all.php?fill=cnt_config&value="+stage,
...
function deleteContractor(sel) {
    ...
    $("#promotioncontractor_"+arr[1]).hide();
...
<div class="form-group">
    <div class="col-sm-12">
        ...
        <?php if(!empty($_GET['promotionid'])) {
            ...
            ?>
                <div class="form-group clearfix" id="<?php echo 'promotioncontractor_'.$id_loop; ?>">
        ...
        <div class="additional_cnt clearfix">
            ...
            <div class="form-group clearfix" id="promotioncontractor_0">
                <div class="col-sm-2"><label for="company_name" class="col-sm-4 show-on-mob control-label">Contractor:</label>
