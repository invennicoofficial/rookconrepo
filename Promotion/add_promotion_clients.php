...
$(document).ready(function() {
    ...
    $('#add_row_cl').on( 'click', function () {
        ...
        clone.find('#promotionclient_0').attr('id', 'promotionclient_'+add_new_cl);
        $('#cldelete_0').hide();
...
function selectClientName(sel) {
	...
	$.ajax({
		type: "GET",
		url: "promotion_ajax_all.php?fill=cl_config&value="+stage,
...
<div class="form-group">
    <div class="col-sm-12">
        ...
        <?php if(!empty($_GET['promotionid'])) {
            ...
            ?>
                <div class="form-group clearfix" id="<?php echo 'promotionclient_'.$id_loop; ?>">
        ...
        <div class="additional_cl clearfix">
            ...
            <div class="form-group clearfix" id="promotionclient_0">
                <div class="col-sm-2"><label for="company_name" class="col-sm-4 show-on-mob control-label">Client:</label>
