...
$(document).ready(function() {
    ...
    $('#add_row_st').on( 'click', function () {
        ...
        clone.find('#promotionstaff_0').attr('id', 'promotionstaff_'+add_new_st);
        $('#stdelete_0').hide();
...
function selectStaff(sel) {
	...
	$.ajax({
		type: "GET",
		url: "promotion_ajax_all.php?fill=st_config&value="+stage,
    ...
    <div class="col-sm-12">
        ...
        <?php if(!empty($_GET['promotionid'])) {
            ...
            for($staff_loop=0; $staff_loop<$total_count; $staff_loop++) {
                ...
                if($staffid != '') {
            ?>
                <div class="form-group clearfix" id="<?php echo 'promotionstaff_'.$id_loop; ?>">
        ...
        <div class="additional_st clearfix">
            ...
            <div class="form-group clearfix" id="promotionstaff_0">
                <div class="col-sm-2"><label for="company_name" class="col-sm-4 show-on-mob control-label">Contact Person:</label>
