<div id="sidebar" class="col-sm-4 triple-gap-top pad-right">
	...
	<div class="double-gap-top"><?php
		if ( strpos($value_config, ',Hold Orders,') !== false ) { ?><div class="col-sm-6"><button id="hold_order" class="btn brand-btn mobile-block touch-button" onclick="holdOrder(this);">HOLD ORDER</button></div><?php } ?>
	...
	<div class="triple-gap-top">
		<div class="col-sm-9"><?php
			if ( strpos ( $value_config, ',Add Item,') !== FALSE ) { ?>
				<div class="col-sm-2 touch-icons pull-left"><a href="pos_touch.php<?php echo $query_vars; ?>"><img src="<?php echo WEBSITE_URL; ?>/img/icons/pos-plus.png" width="40" /></a><br />ADD ITEM</div><?php
			}
			if ( strpos ( $value_config, ',Touch Discount,') !== FALSE ) { ?>
				<div class="col-sm-2 touch-icons pull-left"><a href="?discount=yes"><img src="<?php echo WEBSITE_URL; ?>/img/icons/pos-percentage.png" width="40" /></a><br />DISCOUNT</div><?php
			}
			if ( strpos ( $value_config, ',Coupon,') !== FALSE ) { ?>
				<div class="col-sm-2 touch-icons pull-left"><a href="javascript:void(0);" onclick="checkValidCouponClick();"><img src="<?php echo WEBSITE_URL; ?>/img/icons/pos-togo.png" width="40" /></a><br /><div class="indent-5">COUPON</div></div><?php
			}
			if ( strpos ( $value_config, ',Coupon,') !== FALSE ) { ?>
				<div class="col-sm-2 touch-icons pull-left"><a href="?gf=yes"><img src="<?php echo WEBSITE_URL; ?>/img/icons/pos-gf.png" width="40" /></a><br /><div class="indent-5">GIFT CARD</div></div><?php
			}
			if ( strpos ( $value_config, ',Email Receipt,') !== FALSE ) { ?>
				<div class="col-sm-2 touch-icons pull-left"><a href="javascript:void(0);" onclick="checkValidEmailReceiptClick();"><img src="<?php echo WEBSITE_URL; ?>/img/icons/pos-email.png" width="40" /></a><br /><div class="indent-5">EMAIL</div></div><?php
			} ?>
			<!--
