...
if (isset($_POST['submit'])) {
    ...
    if (strpos(','.$labour.',',','.'Labour Type'.',') === false) {
        $labour = 'Labour Type,Heading,'.$labour;
    }
    ...
    if($get_field_config['fieldconfigid'] > 0) {
        $query_update_employee = "UPDATE `field_config` SET labour = '$labour' WHERE `fieldconfigid` = 1";
        $result_update_employee = mysqli_query($dbc, $query_update_employee);
    } else {
        $query_insert_config = "INSERT INTO `field_config` (`labour`) VALUES ('$labour')";
...
<form id="form1" name="form1" method="post" action="" enctype="multipart/form-data" class="form-horizontal" role="form">
    <div class="form-group gap-top">
        <table cellpadding='10' class='table table-bordered'>
            <tr>
                <td>
                    <input type="checkbox" disabled checked value="Labour Type" style="height: 20px; width: 20px;" name="labour[]">&nbsp;&nbsp;Labour Type
                </td>
                <td>
                ...
                <td>
                    <input type="checkbox" disabled checked value="Heading" style="height: 20px; width: 20px;" name="labour[]">&nbsp;&nbsp;Heading
                </td>
                <!-- <td>
            ...
            <tr>
                ...
                <td>
                    ...
                    echo " checked"; } ?> value="Rate Card" style="height: 20px; width: 20px;" name="labour[]">&nbsp;&nbsp;<span class="popover-examples"><a data-toggle="tooltip" data-placement="bottom" title="" data-original-title="The user will need View Access to the Rate Card tile to view the Rate Card section, and Edit Access to the Rate Card tile to edit the Rate Card section."><img src="<?= WEBSITE_URL ?>/img/info.png" width="20"></a></span> Rate Card
                </td>
                <!-- <td>
