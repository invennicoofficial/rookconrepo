...
if (isset($_POST['add_labour'])) {
    ...
    echo '<script type="text/javascript"> window.location.replace("labour.php?category='.$labour_type.'"); </script>';
        ...
        <div class="main-screen">
            ...
            <div class="tile-container" style="height: 100%;">
                ...
                <div class="collapsible tile-sidebar set-section-height">
					<ul class="sidebar">
						<a href='labour.php?'><li>Back to Dashboard</li></a>
                ...
                <form id="form1" name="form1" method="post" action="" enctype="multipart/form-data" class="form-horizontal" role="form">
                    <div class="scale-to-fill">
			            <div class="main-screen-white" style="height:calc(100vh - 20em); overflow-y: auto;">
							<div class="preview-block">
							  <div class="preview-block-header"><h4><?= !empty($_GET['labourid']) ? 'Edit' : 'Add' ?> Labour</h4></div>
							</div>
	                ...
	                <div class="pull-right gap-top gap-right gap-bottom">
	                    <a href="labour.php" class="btn brand-btn">Cancel</a>
